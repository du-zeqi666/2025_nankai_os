...
static void init_pmm_manager(void) {
    ...
    pmm_manager = &buddy_pmm_manager; // 将 pmm_manager 指向新的 buddy_pmm_manager
...
static void page_init(void) {
    ...
    size_t aligned_ppn = (start_ppn + MAX_ORDER_PAGES - 1) & ~(MAX_ORDER_PAGES - 1);
...
void pmm_init(void) {
    ...
    cprintf("[DEBUG] Starting PMM check...\n"); //
    check_alloc_page();
