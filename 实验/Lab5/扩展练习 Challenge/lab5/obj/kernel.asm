...
ffffffffc020004e:	2be50513          	addi	a0,a0,702 # ffffffffc02a6308 <buf>
ffffffffc0200052:	000aa617          	auipc	a2,0xaa
ffffffffc0200056:	75a60613          	addi	a2,a2,1882 # ffffffffc02aa7ac <end>
{
...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	652050ef          	jal	ra,ffffffffc02056b4 <memset>
    dtb_init();
...
ffffffffc0200072:	67258593          	addi	a1,a1,1650 # ffffffffc02056e0 <etext+0x2>
ffffffffc0200076:	00005517          	auipc	a0,0x5
ffffffffc020007a:	68a50513          	addi	a0,a0,1674 # ffffffffc0205700 <etext+0x22>
...
ffffffffc0200096:	571040ef          	jal	ra,ffffffffc0204e06 <proc_init>
...
ffffffffc02000a2:	6fd040ef          	jal	ra,ffffffffc0204f9e <cpu_idle>
...
ffffffffc02000c0:	64c50513          	addi	a0,a0,1612 # ffffffffc0205708 <etext+0x2a>
...
ffffffffc02000d6:	236b8b93          	addi	s7,s7,566 # ffffffffc02a6308 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
...
ffffffffc0200132:	1da50513          	addi	a0,a0,474 # ffffffffc02a6308 <buf>
...
ffffffffc0200186:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc0200188:	108050ef          	jal	ra,ffffffffc0205290 <vprintfmt>
    return cnt;
}
...
ffffffffc02001bc:	c202                	sw	zero,4(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001be:	0d2050ef          	jal	ra,ffffffffc0205290 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200222:	4f250513          	addi	a0,a0,1266 # ffffffffc0205710 <etext+0x32>
{
...
ffffffffc0200238:	4fc50513          	addi	a0,a0,1276 # ffffffffc0205730 <etext+0x52>
ffffffffc020023c:	f59ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200240:	00005597          	auipc	a1,0x5
ffffffffc0200244:	49e58593          	addi	a1,a1,1182 # ffffffffc02056de <etext>
ffffffffc0200248:	00005517          	auipc	a0,0x5
ffffffffc020024c:	50850513          	addi	a0,a0,1288 # ffffffffc0205750 <etext+0x72>
ffffffffc0200250:	f45ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  edata  0x%08x (virtual)\n", edata);
ffffffffc0200254:	000a6597          	auipc	a1,0xa6
ffffffffc0200258:	0b458593          	addi	a1,a1,180 # ffffffffc02a6308 <buf>
ffffffffc020025c:	00005517          	auipc	a0,0x5
ffffffffc0200260:	51450513          	addi	a0,a0,1300 # ffffffffc0205770 <etext+0x92>
ffffffffc0200264:	f31ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  end    0x%08x (virtual)\n", end);
ffffffffc0200268:	000aa597          	auipc	a1,0xaa
ffffffffc020026c:	54458593          	addi	a1,a1,1348 # ffffffffc02aa7ac <end>
ffffffffc0200270:	00005517          	auipc	a0,0x5
ffffffffc0200274:	52050513          	addi	a0,a0,1312 # ffffffffc0205790 <etext+0xb2>
ffffffffc0200278:	f1dff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("Kernel executable memory footprint: %dKB\n",
            (end - kern_init + 1023) / 1024);
ffffffffc020027c:	000ab597          	auipc	a1,0xab
ffffffffc0200280:	92f58593          	addi	a1,a1,-1745 # ffffffffc02aabab <end+0x3ff>
...
ffffffffc02002a2:	51250513          	addi	a0,a0,1298 # ffffffffc02057b0 <etext+0xd2>
}
...
ffffffffc02002b0:	53460613          	addi	a2,a2,1332 # ffffffffc02057e0 <etext+0x102>
ffffffffc02002b4:	04f00593          	li	a1,79
ffffffffc02002b8:	00005517          	auipc	a0,0x5
ffffffffc02002bc:	54050513          	addi	a0,a0,1344 # ffffffffc02057f8 <etext+0x11a>
{
...
ffffffffc02002cc:	54860613          	addi	a2,a2,1352 # ffffffffc0205810 <etext+0x132>
ffffffffc02002d0:	00005597          	auipc	a1,0x5
ffffffffc02002d4:	56058593          	addi	a1,a1,1376 # ffffffffc0205830 <etext+0x152>
ffffffffc02002d8:	00005517          	auipc	a0,0x5
ffffffffc02002dc:	56050513          	addi	a0,a0,1376 # ffffffffc0205838 <etext+0x15a>
{
ffffffffc02002e0:	e406                	sd	ra,8(sp)
        cprintf("%s - %s\n", commands[i].name, commands[i].desc);
ffffffffc02002e2:	eb3ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc02002e6:	00005617          	auipc	a2,0x5
ffffffffc02002ea:	56260613          	addi	a2,a2,1378 # ffffffffc0205848 <etext+0x16a>
ffffffffc02002ee:	00005597          	auipc	a1,0x5
ffffffffc02002f2:	58258593          	addi	a1,a1,1410 # ffffffffc0205870 <etext+0x192>
ffffffffc02002f6:	00005517          	auipc	a0,0x5
ffffffffc02002fa:	54250513          	addi	a0,a0,1346 # ffffffffc0205838 <etext+0x15a>
ffffffffc02002fe:	e97ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc0200302:	00005617          	auipc	a2,0x5
ffffffffc0200306:	57e60613          	addi	a2,a2,1406 # ffffffffc0205880 <etext+0x1a2>
ffffffffc020030a:	00005597          	auipc	a1,0x5
ffffffffc020030e:	59658593          	addi	a1,a1,1430 # ffffffffc02058a0 <etext+0x1c2>
ffffffffc0200312:	00005517          	auipc	a0,0x5
ffffffffc0200316:	52650513          	addi	a0,a0,1318 # ffffffffc0205838 <etext+0x15a>
...
ffffffffc0200350:	56450513          	addi	a0,a0,1380 # ffffffffc02058b0 <etext+0x1d2>
{
...
ffffffffc0200372:	56a50513          	addi	a0,a0,1386 # ffffffffc02058d8 <etext+0x1fa>
...
ffffffffc0200390:	57490913          	addi	s2,s2,1396 # ffffffffc0205900 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL)
ffffffffc0200394:	00005497          	auipc	s1,0x5
ffffffffc0200398:	57448493          	addi	s1,s1,1396 # ffffffffc0205908 <etext+0x22a>
        if (argc == MAXARGS - 1)
ffffffffc020039c:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020039e:	00005b17          	auipc	s6,0x5
ffffffffc02003a2:	572b0b13          	addi	s6,s6,1394 # ffffffffc0205910 <etext+0x232>
        argv[argc++] = buf;
ffffffffc02003a6:	00005a17          	auipc	s4,0x5
ffffffffc02003aa:	48aa0a13          	addi	s4,s4,1162 # ffffffffc0205830 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i++)
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0)
ffffffffc02003d6:	284050ef          	jal	ra,ffffffffc020565a <strcmp>
...
ffffffffc02003e8:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0)
ffffffffc02003ea:	270050ef          	jal	ra,ffffffffc020565a <strcmp>
...
ffffffffc0200428:	276050ef          	jal	ra,ffffffffc020569e <strchr>
...
ffffffffc0200466:	238050ef          	jal	ra,ffffffffc020569e <strchr>
...
ffffffffc0200484:	4b050513          	addi	a0,a0,1200 # ffffffffc0205930 <etext+0x252>
...
ffffffffc0200492:	2a230313          	addi	t1,t1,674 # ffffffffc02aa730 <is_panic>
...
ffffffffc0200544:	20f73023          	sd	a5,512(a4) # ffffffffc02aa740 <timebase>
...
ffffffffc020056c:	1c07b823          	sd	zero,464(a5) # ffffffffc02aa738 <ticks>
    cprintf("++ setup timer interrupts\n");
...
ffffffffc020057a:	1ca7b783          	ld	a5,458(a5) # ffffffffc02aa740 <timebase>
...
ffffffffc020069a:	2581                	sext.w	a1,a1
    if (magic != 0xd00dfeed) {
ffffffffc020069c:	eed78793          	addi	a5,a5,-275 # ffffffffd00dfeed <end+0xfe35741>
...
ffffffffc02007ca:	649040ef          	jal	ra,ffffffffc0205612 <strlen>
...
ffffffffc02007d6:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc02007d8:	6a1040ef          	jal	ra,ffffffffc0205678 <strncmp>
...
ffffffffc020086e:	5ed040ef          	jal	ra,ffffffffc020565a <strcmp>
...
ffffffffc020098c:	dc87b023          	sd	s0,-576(a5) # ffffffffc02aa748 <memory_base>
        memory_size = mem_size;
ffffffffc0200990:	000aa797          	auipc	a5,0xaa
ffffffffc0200994:	dd67b023          	sd	s6,-576(a5) # ffffffffc02aa750 <memory_size>
    cprintf("DTB init completed\n");
...
ffffffffc020099e:	dae53503          	ld	a0,-594(a0) # ffffffffc02aa748 <memory_base>
...
ffffffffc02009a8:	dac53503          	ld	a0,-596(a0) # ffffffffc02aa750 <memory_size>
...
ffffffffc0200c18:	33c70713          	addi	a4,a4,828 # ffffffffc0205f50 <commands+0x608>
...
ffffffffc0200c62:	ada78793          	addi	a5,a5,-1318 # ffffffffc02aa738 <ticks>
...
ffffffffc0200c7c:	b187b783          	ld	a5,-1256(a5) # ffffffffc02aa790 <current>
...
ffffffffc0200c90:	2a450513          	addi	a0,a0,676 # ffffffffc0205f30 <commands+0x5e8>
...
ffffffffc0200cb0:	46470713          	addi	a4,a4,1124 # ffffffffc0206110 <commands+0x7c8>
...
ffffffffc0200cc2:	3aa50513          	addi	a0,a0,938 # ffffffffc0206068 <commands+0x720>
...
ffffffffc0200cd8:	0141                	addi	sp,sp,16
        syscall();
ffffffffc0200cda:	4b40406f          	j	ffffffffc020518e <syscall>
        cprintf("Environment call from H-mode\n");
ffffffffc0200cde:	00005517          	auipc	a0,0x5
ffffffffc0200ce2:	3aa50513          	addi	a0,a0,938 # ffffffffc0206088 <commands+0x740>
}
...
ffffffffc0200d56:	29650513          	addi	a0,a0,662 # ffffffffc0205fe8 <commands+0x6a0>
ffffffffc0200d5a:	b771                	j	ffffffffc0200ce6 <exception_handler+0x4c>
        cprintf("Load access fault\n");
ffffffffc0200d5c:	00005517          	auipc	a0,0x5
ffffffffc0200d60:	2ac50513          	addi	a0,a0,684 # ffffffffc0206008 <commands+0x6c0>
ffffffffc0200d64:	b749                	j	ffffffffc0200ce6 <exception_handler+0x4c>
        cprintf("Store/AMO access fault\n");
ffffffffc0200d66:	00005517          	auipc	a0,0x5
ffffffffc0200d6a:	2ea50513          	addi	a0,a0,746 # ffffffffc0206050 <commands+0x708>
...
ffffffffc0200d7e:	2a660613          	addi	a2,a2,678 # ffffffffc0206020 <commands+0x6d8>
ffffffffc0200d82:	0ca00593          	li	a1,202
ffffffffc0200d86:	00005517          	auipc	a0,0x5
ffffffffc0200d8a:	2b250513          	addi	a0,a0,690 # ffffffffc0206038 <commands+0x6f0>
...
ffffffffc0200d98:	10f43423          	sd	a5,264(s0)
            syscall();
ffffffffc0200d9c:	3f2040ef          	jal	ra,ffffffffc020518e <syscall>
            kernel_execve_ret(tf, current->kstack + KSTACKSIZE);
ffffffffc0200da0:	000aa797          	auipc	a5,0xaa
ffffffffc0200da4:	9f07b783          	ld	a5,-1552(a5) # ffffffffc02aa790 <current>
...
ffffffffc0200dc0:	9d440413          	addi	s0,s0,-1580 # ffffffffc02aa790 <current>
...
ffffffffc0200e32:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200e34:	26e0406f          	j	ffffffffc02050a2 <schedule>
                do_exit(-E_KILLED);
ffffffffc0200e38:	555d                	li	a0,-9
ffffffffc0200e3a:	5ae030ef          	jal	ra,ffffffffc02043e8 <do_exit>
            if (current->need_resched)
...
ffffffffc0200fbe:	74e78793          	addi	a5,a5,1870 # ffffffffc02a6708 <free_area>
...
ffffffffc0200fd0:	74c56503          	lwu	a0,1868(a0) # ffffffffc02a6718 <free_area+0x10>
...
ffffffffc0200fde:	72e40413          	addi	s0,s0,1838 # ffffffffc02a6708 <free_area>
...
ffffffffc02010c0:	6407ae23          	sw	zero,1628(a5) # ffffffffc02a6718 <free_area+0x10>
    assert(alloc_page() == NULL);
...
ffffffffc02011a2:	5607ad23          	sw	zero,1402(a5) # ffffffffc02a6718 <free_area+0x10>
    free_pages(p0 + 2, 3);
...
ffffffffc02012bc:	e9868693          	addi	a3,a3,-360 # ffffffffc0206150 <commands+0x808>
ffffffffc02012c0:	00005617          	auipc	a2,0x5
ffffffffc02012c4:	ea060613          	addi	a2,a2,-352 # ffffffffc0206160 <commands+0x818>
ffffffffc02012c8:	11000593          	li	a1,272
ffffffffc02012cc:	00005517          	auipc	a0,0x5
ffffffffc02012d0:	eac50513          	addi	a0,a0,-340 # ffffffffc0206178 <commands+0x830>
ffffffffc02012d4:	9baff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc02012d8:	00005697          	auipc	a3,0x5
ffffffffc02012dc:	f3868693          	addi	a3,a3,-200 # ffffffffc0206210 <commands+0x8c8>
ffffffffc02012e0:	00005617          	auipc	a2,0x5
ffffffffc02012e4:	e8060613          	addi	a2,a2,-384 # ffffffffc0206160 <commands+0x818>
ffffffffc02012e8:	0db00593          	li	a1,219
ffffffffc02012ec:	00005517          	auipc	a0,0x5
ffffffffc02012f0:	e8c50513          	addi	a0,a0,-372 # ffffffffc0206178 <commands+0x830>
ffffffffc02012f4:	99aff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc02012f8:	00005697          	auipc	a3,0x5
ffffffffc02012fc:	f4068693          	addi	a3,a3,-192 # ffffffffc0206238 <commands+0x8f0>
ffffffffc0201300:	00005617          	auipc	a2,0x5
ffffffffc0201304:	e6060613          	addi	a2,a2,-416 # ffffffffc0206160 <commands+0x818>
ffffffffc0201308:	0dc00593          	li	a1,220
ffffffffc020130c:	00005517          	auipc	a0,0x5
ffffffffc0201310:	e6c50513          	addi	a0,a0,-404 # ffffffffc0206178 <commands+0x830>
ffffffffc0201314:	97aff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201318:	00005697          	auipc	a3,0x5
ffffffffc020131c:	f6068693          	addi	a3,a3,-160 # ffffffffc0206278 <commands+0x930>
ffffffffc0201320:	00005617          	auipc	a2,0x5
ffffffffc0201324:	e4060613          	addi	a2,a2,-448 # ffffffffc0206160 <commands+0x818>
ffffffffc0201328:	0de00593          	li	a1,222
ffffffffc020132c:	00005517          	auipc	a0,0x5
ffffffffc0201330:	e4c50513          	addi	a0,a0,-436 # ffffffffc0206178 <commands+0x830>
ffffffffc0201334:	95aff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(!list_empty(&free_list));
ffffffffc0201338:	00005697          	auipc	a3,0x5
ffffffffc020133c:	fc868693          	addi	a3,a3,-56 # ffffffffc0206300 <commands+0x9b8>
ffffffffc0201340:	00005617          	auipc	a2,0x5
ffffffffc0201344:	e2060613          	addi	a2,a2,-480 # ffffffffc0206160 <commands+0x818>
ffffffffc0201348:	0f700593          	li	a1,247
ffffffffc020134c:	00005517          	auipc	a0,0x5
ffffffffc0201350:	e2c50513          	addi	a0,a0,-468 # ffffffffc0206178 <commands+0x830>
ffffffffc0201354:	93aff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201358:	00005697          	auipc	a3,0x5
ffffffffc020135c:	e5868693          	addi	a3,a3,-424 # ffffffffc02061b0 <commands+0x868>
ffffffffc0201360:	00005617          	auipc	a2,0x5
ffffffffc0201364:	e0060613          	addi	a2,a2,-512 # ffffffffc0206160 <commands+0x818>
ffffffffc0201368:	0f000593          	li	a1,240
ffffffffc020136c:	00005517          	auipc	a0,0x5
ffffffffc0201370:	e0c50513          	addi	a0,a0,-500 # ffffffffc0206178 <commands+0x830>
ffffffffc0201374:	91aff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_free == 3);
ffffffffc0201378:	00005697          	auipc	a3,0x5
ffffffffc020137c:	f7868693          	addi	a3,a3,-136 # ffffffffc02062f0 <commands+0x9a8>
ffffffffc0201380:	00005617          	auipc	a2,0x5
ffffffffc0201384:	de060613          	addi	a2,a2,-544 # ffffffffc0206160 <commands+0x818>
ffffffffc0201388:	0ee00593          	li	a1,238
ffffffffc020138c:	00005517          	auipc	a0,0x5
ffffffffc0201390:	dec50513          	addi	a0,a0,-532 # ffffffffc0206178 <commands+0x830>
ffffffffc0201394:	8faff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201398:	00005697          	auipc	a3,0x5
ffffffffc020139c:	f4068693          	addi	a3,a3,-192 # ffffffffc02062d8 <commands+0x990>
ffffffffc02013a0:	00005617          	auipc	a2,0x5
ffffffffc02013a4:	dc060613          	addi	a2,a2,-576 # ffffffffc0206160 <commands+0x818>
ffffffffc02013a8:	0e900593          	li	a1,233
ffffffffc02013ac:	00005517          	auipc	a0,0x5
ffffffffc02013b0:	dcc50513          	addi	a0,a0,-564 # ffffffffc0206178 <commands+0x830>
ffffffffc02013b4:	8daff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc02013b8:	00005697          	auipc	a3,0x5
ffffffffc02013bc:	f0068693          	addi	a3,a3,-256 # ffffffffc02062b8 <commands+0x970>
ffffffffc02013c0:	00005617          	auipc	a2,0x5
ffffffffc02013c4:	da060613          	addi	a2,a2,-608 # ffffffffc0206160 <commands+0x818>
ffffffffc02013c8:	0e000593          	li	a1,224
ffffffffc02013cc:	00005517          	auipc	a0,0x5
ffffffffc02013d0:	dac50513          	addi	a0,a0,-596 # ffffffffc0206178 <commands+0x830>
ffffffffc02013d4:	8baff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(p0 != NULL);
ffffffffc02013d8:	00005697          	auipc	a3,0x5
ffffffffc02013dc:	f7068693          	addi	a3,a3,-144 # ffffffffc0206348 <commands+0xa00>
ffffffffc02013e0:	00005617          	auipc	a2,0x5
ffffffffc02013e4:	d8060613          	addi	a2,a2,-640 # ffffffffc0206160 <commands+0x818>
ffffffffc02013e8:	11800593          	li	a1,280
ffffffffc02013ec:	00005517          	auipc	a0,0x5
ffffffffc02013f0:	d8c50513          	addi	a0,a0,-628 # ffffffffc0206178 <commands+0x830>
ffffffffc02013f4:	89aff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_free == 0);
ffffffffc02013f8:	00005697          	auipc	a3,0x5
ffffffffc02013fc:	f4068693          	addi	a3,a3,-192 # ffffffffc0206338 <commands+0x9f0>
ffffffffc0201400:	00005617          	auipc	a2,0x5
ffffffffc0201404:	d6060613          	addi	a2,a2,-672 # ffffffffc0206160 <commands+0x818>
ffffffffc0201408:	0fd00593          	li	a1,253
ffffffffc020140c:	00005517          	auipc	a0,0x5
ffffffffc0201410:	d6c50513          	addi	a0,a0,-660 # ffffffffc0206178 <commands+0x830>
ffffffffc0201414:	87aff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201418:	00005697          	auipc	a3,0x5
ffffffffc020141c:	ec068693          	addi	a3,a3,-320 # ffffffffc02062d8 <commands+0x990>
ffffffffc0201420:	00005617          	auipc	a2,0x5
ffffffffc0201424:	d4060613          	addi	a2,a2,-704 # ffffffffc0206160 <commands+0x818>
ffffffffc0201428:	0fb00593          	li	a1,251
ffffffffc020142c:	00005517          	auipc	a0,0x5
ffffffffc0201430:	d4c50513          	addi	a0,a0,-692 # ffffffffc0206178 <commands+0x830>
ffffffffc0201434:	85aff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0201438:	00005697          	auipc	a3,0x5
ffffffffc020143c:	ee068693          	addi	a3,a3,-288 # ffffffffc0206318 <commands+0x9d0>
ffffffffc0201440:	00005617          	auipc	a2,0x5
ffffffffc0201444:	d2060613          	addi	a2,a2,-736 # ffffffffc0206160 <commands+0x818>
ffffffffc0201448:	0fa00593          	li	a1,250
ffffffffc020144c:	00005517          	auipc	a0,0x5
ffffffffc0201450:	d2c50513          	addi	a0,a0,-724 # ffffffffc0206178 <commands+0x830>
ffffffffc0201454:	83aff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201458:	00005697          	auipc	a3,0x5
ffffffffc020145c:	d5868693          	addi	a3,a3,-680 # ffffffffc02061b0 <commands+0x868>
ffffffffc0201460:	00005617          	auipc	a2,0x5
ffffffffc0201464:	d0060613          	addi	a2,a2,-768 # ffffffffc0206160 <commands+0x818>
ffffffffc0201468:	0d700593          	li	a1,215
ffffffffc020146c:	00005517          	auipc	a0,0x5
ffffffffc0201470:	d0c50513          	addi	a0,a0,-756 # ffffffffc0206178 <commands+0x830>
ffffffffc0201474:	81aff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201478:	00005697          	auipc	a3,0x5
ffffffffc020147c:	e6068693          	addi	a3,a3,-416 # ffffffffc02062d8 <commands+0x990>
ffffffffc0201480:	00005617          	auipc	a2,0x5
ffffffffc0201484:	ce060613          	addi	a2,a2,-800 # ffffffffc0206160 <commands+0x818>
ffffffffc0201488:	0f400593          	li	a1,244
ffffffffc020148c:	00005517          	auipc	a0,0x5
ffffffffc0201490:	cec50513          	addi	a0,a0,-788 # ffffffffc0206178 <commands+0x830>
ffffffffc0201494:	ffbfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201498:	00005697          	auipc	a3,0x5
ffffffffc020149c:	d5868693          	addi	a3,a3,-680 # ffffffffc02061f0 <commands+0x8a8>
ffffffffc02014a0:	00005617          	auipc	a2,0x5
ffffffffc02014a4:	cc060613          	addi	a2,a2,-832 # ffffffffc0206160 <commands+0x818>
ffffffffc02014a8:	0f200593          	li	a1,242
ffffffffc02014ac:	00005517          	auipc	a0,0x5
ffffffffc02014b0:	ccc50513          	addi	a0,a0,-820 # ffffffffc0206178 <commands+0x830>
ffffffffc02014b4:	fdbfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02014b8:	00005697          	auipc	a3,0x5
ffffffffc02014bc:	d1868693          	addi	a3,a3,-744 # ffffffffc02061d0 <commands+0x888>
ffffffffc02014c0:	00005617          	auipc	a2,0x5
ffffffffc02014c4:	ca060613          	addi	a2,a2,-864 # ffffffffc0206160 <commands+0x818>
ffffffffc02014c8:	0f100593          	li	a1,241
ffffffffc02014cc:	00005517          	auipc	a0,0x5
ffffffffc02014d0:	cac50513          	addi	a0,a0,-852 # ffffffffc0206178 <commands+0x830>
ffffffffc02014d4:	fbbfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02014d8:	00005697          	auipc	a3,0x5
ffffffffc02014dc:	d1868693          	addi	a3,a3,-744 # ffffffffc02061f0 <commands+0x8a8>
ffffffffc02014e0:	00005617          	auipc	a2,0x5
ffffffffc02014e4:	c8060613          	addi	a2,a2,-896 # ffffffffc0206160 <commands+0x818>
ffffffffc02014e8:	0d900593          	li	a1,217
ffffffffc02014ec:	00005517          	auipc	a0,0x5
ffffffffc02014f0:	c8c50513          	addi	a0,a0,-884 # ffffffffc0206178 <commands+0x830>
ffffffffc02014f4:	f9bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(count == 0);
ffffffffc02014f8:	00005697          	auipc	a3,0x5
ffffffffc02014fc:	fa068693          	addi	a3,a3,-96 # ffffffffc0206498 <commands+0xb50>
ffffffffc0201500:	00005617          	auipc	a2,0x5
ffffffffc0201504:	c6060613          	addi	a2,a2,-928 # ffffffffc0206160 <commands+0x818>
ffffffffc0201508:	14600593          	li	a1,326
ffffffffc020150c:	00005517          	auipc	a0,0x5
ffffffffc0201510:	c6c50513          	addi	a0,a0,-916 # ffffffffc0206178 <commands+0x830>
ffffffffc0201514:	f7bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_free == 0);
ffffffffc0201518:	00005697          	auipc	a3,0x5
ffffffffc020151c:	e2068693          	addi	a3,a3,-480 # ffffffffc0206338 <commands+0x9f0>
ffffffffc0201520:	00005617          	auipc	a2,0x5
ffffffffc0201524:	c4060613          	addi	a2,a2,-960 # ffffffffc0206160 <commands+0x818>
ffffffffc0201528:	13a00593          	li	a1,314
ffffffffc020152c:	00005517          	auipc	a0,0x5
ffffffffc0201530:	c4c50513          	addi	a0,a0,-948 # ffffffffc0206178 <commands+0x830>
ffffffffc0201534:	f5bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201538:	00005697          	auipc	a3,0x5
ffffffffc020153c:	da068693          	addi	a3,a3,-608 # ffffffffc02062d8 <commands+0x990>
ffffffffc0201540:	00005617          	auipc	a2,0x5
ffffffffc0201544:	c2060613          	addi	a2,a2,-992 # ffffffffc0206160 <commands+0x818>
ffffffffc0201548:	13800593          	li	a1,312
ffffffffc020154c:	00005517          	auipc	a0,0x5
ffffffffc0201550:	c2c50513          	addi	a0,a0,-980 # ffffffffc0206178 <commands+0x830>
ffffffffc0201554:	f3bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201558:	00005697          	auipc	a3,0x5
ffffffffc020155c:	d4068693          	addi	a3,a3,-704 # ffffffffc0206298 <commands+0x950>
ffffffffc0201560:	00005617          	auipc	a2,0x5
ffffffffc0201564:	c0060613          	addi	a2,a2,-1024 # ffffffffc0206160 <commands+0x818>
ffffffffc0201568:	0df00593          	li	a1,223
ffffffffc020156c:	00005517          	auipc	a0,0x5
ffffffffc0201570:	c0c50513          	addi	a0,a0,-1012 # ffffffffc0206178 <commands+0x830>
ffffffffc0201574:	f1bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201578:	00005697          	auipc	a3,0x5
ffffffffc020157c:	ee068693          	addi	a3,a3,-288 # ffffffffc0206458 <commands+0xb10>
ffffffffc0201580:	00005617          	auipc	a2,0x5
ffffffffc0201584:	be060613          	addi	a2,a2,-1056 # ffffffffc0206160 <commands+0x818>
ffffffffc0201588:	13200593          	li	a1,306
ffffffffc020158c:	00005517          	auipc	a0,0x5
ffffffffc0201590:	bec50513          	addi	a0,a0,-1044 # ffffffffc0206178 <commands+0x830>
ffffffffc0201594:	efbfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201598:	00005697          	auipc	a3,0x5
ffffffffc020159c:	ea068693          	addi	a3,a3,-352 # ffffffffc0206438 <commands+0xaf0>
ffffffffc02015a0:	00005617          	auipc	a2,0x5
ffffffffc02015a4:	bc060613          	addi	a2,a2,-1088 # ffffffffc0206160 <commands+0x818>
ffffffffc02015a8:	13000593          	li	a1,304
ffffffffc02015ac:	00005517          	auipc	a0,0x5
ffffffffc02015b0:	bcc50513          	addi	a0,a0,-1076 # ffffffffc0206178 <commands+0x830>
ffffffffc02015b4:	edbfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02015b8:	00005697          	auipc	a3,0x5
ffffffffc02015bc:	e5868693          	addi	a3,a3,-424 # ffffffffc0206410 <commands+0xac8>
ffffffffc02015c0:	00005617          	auipc	a2,0x5
ffffffffc02015c4:	ba060613          	addi	a2,a2,-1120 # ffffffffc0206160 <commands+0x818>
ffffffffc02015c8:	12e00593          	li	a1,302
ffffffffc02015cc:	00005517          	auipc	a0,0x5
ffffffffc02015d0:	bac50513          	addi	a0,a0,-1108 # ffffffffc0206178 <commands+0x830>
ffffffffc02015d4:	ebbfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02015d8:	00005697          	auipc	a3,0x5
ffffffffc02015dc:	e1068693          	addi	a3,a3,-496 # ffffffffc02063e8 <commands+0xaa0>
ffffffffc02015e0:	00005617          	auipc	a2,0x5
ffffffffc02015e4:	b8060613          	addi	a2,a2,-1152 # ffffffffc0206160 <commands+0x818>
ffffffffc02015e8:	12d00593          	li	a1,301
ffffffffc02015ec:	00005517          	auipc	a0,0x5
ffffffffc02015f0:	b8c50513          	addi	a0,a0,-1140 # ffffffffc0206178 <commands+0x830>
ffffffffc02015f4:	e9bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(p0 + 2 == p1);
ffffffffc02015f8:	00005697          	auipc	a3,0x5
ffffffffc02015fc:	de068693          	addi	a3,a3,-544 # ffffffffc02063d8 <commands+0xa90>
ffffffffc0201600:	00005617          	auipc	a2,0x5
ffffffffc0201604:	b6060613          	addi	a2,a2,-1184 # ffffffffc0206160 <commands+0x818>
ffffffffc0201608:	12800593          	li	a1,296
ffffffffc020160c:	00005517          	auipc	a0,0x5
ffffffffc0201610:	b6c50513          	addi	a0,a0,-1172 # ffffffffc0206178 <commands+0x830>
ffffffffc0201614:	e7bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201618:	00005697          	auipc	a3,0x5
ffffffffc020161c:	cc068693          	addi	a3,a3,-832 # ffffffffc02062d8 <commands+0x990>
ffffffffc0201620:	00005617          	auipc	a2,0x5
ffffffffc0201624:	b4060613          	addi	a2,a2,-1216 # ffffffffc0206160 <commands+0x818>
ffffffffc0201628:	12700593          	li	a1,295
ffffffffc020162c:	00005517          	auipc	a0,0x5
ffffffffc0201630:	b4c50513          	addi	a0,a0,-1204 # ffffffffc0206178 <commands+0x830>
ffffffffc0201634:	e5bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201638:	00005697          	auipc	a3,0x5
ffffffffc020163c:	d8068693          	addi	a3,a3,-640 # ffffffffc02063b8 <commands+0xa70>
ffffffffc0201640:	00005617          	auipc	a2,0x5
ffffffffc0201644:	b2060613          	addi	a2,a2,-1248 # ffffffffc0206160 <commands+0x818>
ffffffffc0201648:	12600593          	li	a1,294
ffffffffc020164c:	00005517          	auipc	a0,0x5
ffffffffc0201650:	b2c50513          	addi	a0,a0,-1236 # ffffffffc0206178 <commands+0x830>
ffffffffc0201654:	e3bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201658:	00005697          	auipc	a3,0x5
ffffffffc020165c:	d3068693          	addi	a3,a3,-720 # ffffffffc0206388 <commands+0xa40>
ffffffffc0201660:	00005617          	auipc	a2,0x5
ffffffffc0201664:	b0060613          	addi	a2,a2,-1280 # ffffffffc0206160 <commands+0x818>
ffffffffc0201668:	12500593          	li	a1,293
ffffffffc020166c:	00005517          	auipc	a0,0x5
ffffffffc0201670:	b0c50513          	addi	a0,a0,-1268 # ffffffffc0206178 <commands+0x830>
ffffffffc0201674:	e1bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201678:	00005697          	auipc	a3,0x5
ffffffffc020167c:	cf868693          	addi	a3,a3,-776 # ffffffffc0206370 <commands+0xa28>
ffffffffc0201680:	00005617          	auipc	a2,0x5
ffffffffc0201684:	ae060613          	addi	a2,a2,-1312 # ffffffffc0206160 <commands+0x818>
ffffffffc0201688:	12400593          	li	a1,292
ffffffffc020168c:	00005517          	auipc	a0,0x5
ffffffffc0201690:	aec50513          	addi	a0,a0,-1300 # ffffffffc0206178 <commands+0x830>
ffffffffc0201694:	dfbfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201698:	00005697          	auipc	a3,0x5
ffffffffc020169c:	c4068693          	addi	a3,a3,-960 # ffffffffc02062d8 <commands+0x990>
ffffffffc02016a0:	00005617          	auipc	a2,0x5
ffffffffc02016a4:	ac060613          	addi	a2,a2,-1344 # ffffffffc0206160 <commands+0x818>
ffffffffc02016a8:	11e00593          	li	a1,286
ffffffffc02016ac:	00005517          	auipc	a0,0x5
ffffffffc02016b0:	acc50513          	addi	a0,a0,-1332 # ffffffffc0206178 <commands+0x830>
ffffffffc02016b4:	ddbfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(!PageProperty(p0));
ffffffffc02016b8:	00005697          	auipc	a3,0x5
ffffffffc02016bc:	ca068693          	addi	a3,a3,-864 # ffffffffc0206358 <commands+0xa10>
ffffffffc02016c0:	00005617          	auipc	a2,0x5
ffffffffc02016c4:	aa060613          	addi	a2,a2,-1376 # ffffffffc0206160 <commands+0x818>
ffffffffc02016c8:	11900593          	li	a1,281
ffffffffc02016cc:	00005517          	auipc	a0,0x5
ffffffffc02016d0:	aac50513          	addi	a0,a0,-1364 # ffffffffc0206178 <commands+0x830>
ffffffffc02016d4:	dbbfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02016d8:	00005697          	auipc	a3,0x5
ffffffffc02016dc:	da068693          	addi	a3,a3,-608 # ffffffffc0206478 <commands+0xb30>
ffffffffc02016e0:	00005617          	auipc	a2,0x5
ffffffffc02016e4:	a8060613          	addi	a2,a2,-1408 # ffffffffc0206160 <commands+0x818>
ffffffffc02016e8:	13700593          	li	a1,311
ffffffffc02016ec:	00005517          	auipc	a0,0x5
ffffffffc02016f0:	a8c50513          	addi	a0,a0,-1396 # ffffffffc0206178 <commands+0x830>
ffffffffc02016f4:	d9bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(total == 0);
ffffffffc02016f8:	00005697          	auipc	a3,0x5
ffffffffc02016fc:	db068693          	addi	a3,a3,-592 # ffffffffc02064a8 <commands+0xb60>
ffffffffc0201700:	00005617          	auipc	a2,0x5
ffffffffc0201704:	a6060613          	addi	a2,a2,-1440 # ffffffffc0206160 <commands+0x818>
ffffffffc0201708:	14700593          	li	a1,327
ffffffffc020170c:	00005517          	auipc	a0,0x5
ffffffffc0201710:	a6c50513          	addi	a0,a0,-1428 # ffffffffc0206178 <commands+0x830>
ffffffffc0201714:	d7bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(total == nr_free_pages());
ffffffffc0201718:	00005697          	auipc	a3,0x5
ffffffffc020171c:	a7868693          	addi	a3,a3,-1416 # ffffffffc0206190 <commands+0x848>
ffffffffc0201720:	00005617          	auipc	a2,0x5
ffffffffc0201724:	a4060613          	addi	a2,a2,-1472 # ffffffffc0206160 <commands+0x818>
ffffffffc0201728:	11300593          	li	a1,275
ffffffffc020172c:	00005517          	auipc	a0,0x5
ffffffffc0201730:	a4c50513          	addi	a0,a0,-1460 # ffffffffc0206178 <commands+0x830>
ffffffffc0201734:	d5bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201738:	00005697          	auipc	a3,0x5
ffffffffc020173c:	a9868693          	addi	a3,a3,-1384 # ffffffffc02061d0 <commands+0x888>
ffffffffc0201740:	00005617          	auipc	a2,0x5
ffffffffc0201744:	a2060613          	addi	a2,a2,-1504 # ffffffffc0206160 <commands+0x818>
ffffffffc0201748:	0d800593          	li	a1,216
ffffffffc020174c:	00005517          	auipc	a0,0x5
ffffffffc0201750:	a2c50513          	addi	a0,a0,-1492 # ffffffffc0206178 <commands+0x830>
...
ffffffffc020179e:	f6e68693          	addi	a3,a3,-146 # ffffffffc02a6708 <free_area>
...
ffffffffc0201888:	c3c68693          	addi	a3,a3,-964 # ffffffffc02064c0 <commands+0xb78>
ffffffffc020188c:	00005617          	auipc	a2,0x5
ffffffffc0201890:	8d460613          	addi	a2,a2,-1836 # ffffffffc0206160 <commands+0x818>
ffffffffc0201894:	09400593          	li	a1,148
ffffffffc0201898:	00005517          	auipc	a0,0x5
ffffffffc020189c:	8e050513          	addi	a0,a0,-1824 # ffffffffc0206178 <commands+0x830>
ffffffffc02018a0:	beffe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(n > 0);
ffffffffc02018a4:	00005697          	auipc	a3,0x5
ffffffffc02018a8:	c1468693          	addi	a3,a3,-1004 # ffffffffc02064b8 <commands+0xb70>
ffffffffc02018ac:	00005617          	auipc	a2,0x5
ffffffffc02018b0:	8b460613          	addi	a2,a2,-1868 # ffffffffc0206160 <commands+0x818>
ffffffffc02018b4:	09000593          	li	a1,144
ffffffffc02018b8:	00005517          	auipc	a0,0x5
ffffffffc02018bc:	8c050513          	addi	a0,a0,-1856 # ffffffffc0206178 <commands+0x830>
...
ffffffffc02018ca:	e4258593          	addi	a1,a1,-446 # ffffffffc02a6708 <free_area>
...
ffffffffc020195a:	b6268693          	addi	a3,a3,-1182 # ffffffffc02064b8 <commands+0xb70>
ffffffffc020195e:	00005617          	auipc	a2,0x5
ffffffffc0201962:	80260613          	addi	a2,a2,-2046 # ffffffffc0206160 <commands+0x818>
ffffffffc0201966:	06c00593          	li	a1,108
ffffffffc020196a:	00005517          	auipc	a0,0x5
ffffffffc020196e:	80e50513          	addi	a0,a0,-2034 # ffffffffc0206178 <commands+0x830>
{
...
ffffffffc02019b6:	d5668693          	addi	a3,a3,-682 # ffffffffc02a6708 <free_area>
...
ffffffffc0201a2c:	ac068693          	addi	a3,a3,-1344 # ffffffffc02064e8 <commands+0xba0>
ffffffffc0201a30:	00004617          	auipc	a2,0x4
ffffffffc0201a34:	73060613          	addi	a2,a2,1840 # ffffffffc0206160 <commands+0x818>
ffffffffc0201a38:	04b00593          	li	a1,75
ffffffffc0201a3c:	00004517          	auipc	a0,0x4
ffffffffc0201a40:	73c50513          	addi	a0,a0,1852 # ffffffffc0206178 <commands+0x830>
ffffffffc0201a44:	a4bfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(n > 0);
ffffffffc0201a48:	00005697          	auipc	a3,0x5
ffffffffc0201a4c:	a7068693          	addi	a3,a3,-1424 # ffffffffc02064b8 <commands+0xb70>
ffffffffc0201a50:	00004617          	auipc	a2,0x4
ffffffffc0201a54:	71060613          	addi	a2,a2,1808 # ffffffffc0206160 <commands+0x818>
ffffffffc0201a58:	04700593          	li	a1,71
ffffffffc0201a5c:	00004517          	auipc	a0,0x4
ffffffffc0201a60:	71c50513          	addi	a0,a0,1820 # ffffffffc0206178 <commands+0x830>
...
ffffffffc0201a82:	87a60613          	addi	a2,a2,-1926 # ffffffffc02a62f8 <slobfree>
...
ffffffffc0201b30:	c4c6b683          	ld	a3,-948(a3) # ffffffffc02aa778 <pages>
ffffffffc0201b34:	8d15                	sub	a0,a0,a3
ffffffffc0201b36:	8519                	srai	a0,a0,0x6
ffffffffc0201b38:	00006697          	auipc	a3,0x6
ffffffffc0201b3c:	d006b683          	ld	a3,-768(a3) # ffffffffc0207838 <nbase>
...
ffffffffc0201b4c:	c2873703          	ld	a4,-984(a4) # ffffffffc02aa770 <npage>
    return page2ppn(page) << PGSHIFT;
...
ffffffffc0201b5a:	c326b683          	ld	a3,-974(a3) # ffffffffc02aa788 <va_pa_offset>
...
ffffffffc0201b6c:	9e060613          	addi	a2,a2,-1568 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc0201b70:	07100593          	li	a1,113
ffffffffc0201b74:	00005517          	auipc	a0,0x5
ffffffffc0201b78:	9fc50513          	addi	a0,a0,-1540 # ffffffffc0206570 <default_pmm_manager+0x60>
...
ffffffffc0201ba8:	75490913          	addi	s2,s2,1876 # ffffffffc02a62f8 <slobfree>
...
ffffffffc0201c5a:	92a68693          	addi	a3,a3,-1750 # ffffffffc0206580 <default_pmm_manager+0x70>
ffffffffc0201c5e:	00004617          	auipc	a2,0x4
ffffffffc0201c62:	50260613          	addi	a2,a2,1282 # ffffffffc0206160 <commands+0x818>
ffffffffc0201c66:	06900593          	li	a1,105
ffffffffc0201c6a:	00005517          	auipc	a0,0x5
ffffffffc0201c6e:	93650513          	addi	a0,a0,-1738 # ffffffffc02065a0 <default_pmm_manager+0x90>
...
ffffffffc0201c7c:	94050513          	addi	a0,a0,-1728 # ffffffffc02065b8 <default_pmm_manager+0xa8>
{
...
ffffffffc0201c8c:	94850513          	addi	a0,a0,-1720 # ffffffffc02065d0 <default_pmm_manager+0xc0>
}
...
ffffffffc0201ce6:	a7678793          	addi	a5,a5,-1418 # ffffffffc02aa758 <bigblocks>
...
ffffffffc0201d22:	a3a78793          	addi	a5,a5,-1478 # ffffffffc02aa758 <bigblocks>
...
ffffffffc0201d68:	9f47b783          	ld	a5,-1548(a5) # ffffffffc02aa758 <bigblocks>
    return 0;
...
ffffffffc0201d74:	9e868693          	addi	a3,a3,-1560 # ffffffffc02aa758 <bigblocks>
...
ffffffffc0201df8:	9647b783          	ld	a5,-1692(a5) # ffffffffc02aa758 <bigblocks>
        return 1;
...
ffffffffc0201e12:	80a60613          	addi	a2,a2,-2038 # ffffffffc0206618 <default_pmm_manager+0x108>
ffffffffc0201e16:	06900593          	li	a1,105
ffffffffc0201e1a:	00004517          	auipc	a0,0x4
ffffffffc0201e1e:	75650513          	addi	a0,a0,1878 # ffffffffc0206570 <default_pmm_manager+0x60>
...
ffffffffc0201e2c:	7c860613          	addi	a2,a2,1992 # ffffffffc02065f0 <default_pmm_manager+0xe0>
ffffffffc0201e30:	07700593          	li	a1,119
ffffffffc0201e34:	00004517          	auipc	a0,0x4
ffffffffc0201e38:	73c50513          	addi	a0,a0,1852 # ffffffffc0206570 <default_pmm_manager+0x60>
...
ffffffffc0201e46:	7d660613          	addi	a2,a2,2006 # ffffffffc0206618 <default_pmm_manager+0x108>
ffffffffc0201e4a:	06900593          	li	a1,105
ffffffffc0201e4e:	00004517          	auipc	a0,0x4
ffffffffc0201e52:	72250513          	addi	a0,a0,1826 # ffffffffc0206570 <default_pmm_manager+0x60>
pa2page(uintptr_t pa)
...
ffffffffc0201e62:	7da60613          	addi	a2,a2,2010 # ffffffffc0206638 <default_pmm_manager+0x128>
ffffffffc0201e66:	07f00593          	li	a1,127
ffffffffc0201e6a:	00004517          	auipc	a0,0x4
ffffffffc0201e6e:	70650513          	addi	a0,a0,1798 # ffffffffc0206570 <default_pmm_manager+0x60>
pte2page(pte_t pte)
...
ffffffffc0201e84:	9007b783          	ld	a5,-1792(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc0201e9c:	8e87b783          	ld	a5,-1816(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc0201ec2:	8c27b783          	ld	a5,-1854(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc0201ede:	8a67b783          	ld	a5,-1882(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc0201f02:	8827b783          	ld	a5,-1918(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc0201f18:	86c7b783          	ld	a5,-1940(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc0201f5a:	000a9997          	auipc	s3,0xa9
ffffffffc0201f5e:	81698993          	addi	s3,s3,-2026 # ffffffffc02aa770 <npage>
    if (!(*pdep1 & PTE_V))
...
ffffffffc0201f6e:	14079963          	bnez	a5,ffffffffc02020c0 <get_pte+0x190>
        page = pmm_manager->alloc_pages(n);
ffffffffc0201f72:	000a9797          	auipc	a5,0xa9
ffffffffc0201f76:	80e7b783          	ld	a5,-2034(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc0201f8a:	7f2b0b13          	addi	s6,s6,2034 # ffffffffc02aa778 <pages>
...
ffffffffc0201f9a:	7da98993          	addi	s3,s3,2010 # ffffffffc02aa770 <npage>
...
ffffffffc0201fbe:	7ce7b783          	ld	a5,1998(a5) # ffffffffc02aa788 <va_pa_offset>
ffffffffc0201fc2:	6605                	lui	a2,0x1
ffffffffc0201fc4:	4581                	li	a1,0
ffffffffc0201fc6:	953e                	add	a0,a0,a5
ffffffffc0201fc8:	6ec030ef          	jal	ra,ffffffffc02056b4 <memset>
    return page - pages + nbase;
...
ffffffffc0201ff6:	796a8a93          	addi	s5,s5,1942 # ffffffffc02aa788 <va_pa_offset>
...
ffffffffc0202026:	75e7b783          	ld	a5,1886(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc0202038:	744b0b13          	addi	s6,s6,1860 # ffffffffc02aa778 <pages>
...
ffffffffc020206a:	64a030ef          	jal	ra,ffffffffc02056b4 <memset>
    return page - pages + nbase;
...
ffffffffc02020c8:	6bc7b783          	ld	a5,1724(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc02020e2:	6a27b783          	ld	a5,1698(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc02020f8:	45460613          	addi	a2,a2,1108 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc02020fc:	0fa00593          	li	a1,250
ffffffffc0202100:	00004517          	auipc	a0,0x4
ffffffffc0202104:	56050513          	addi	a0,a0,1376 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202108:	b86fe0ef          	jal	ra,ffffffffc020048e <__panic>
    pde_t *pdep0 = &((pde_t *)KADDR(PDE_ADDR(*pdep1)))[PDX0(la)];
ffffffffc020210c:	00004617          	auipc	a2,0x4
ffffffffc0202110:	43c60613          	addi	a2,a2,1084 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc0202114:	0ed00593          	li	a1,237
ffffffffc0202118:	00004517          	auipc	a0,0x4
ffffffffc020211c:	54850513          	addi	a0,a0,1352 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc020212a:	42260613          	addi	a2,a2,1058 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc020212e:	0e900593          	li	a1,233
ffffffffc0202132:	00004517          	auipc	a0,0x4
ffffffffc0202136:	52e50513          	addi	a0,a0,1326 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc0202144:	40860613          	addi	a2,a2,1032 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc0202148:	0f700593          	li	a1,247
ffffffffc020214c:	00004517          	auipc	a0,0x4
ffffffffc0202150:	51450513          	addi	a0,a0,1300 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc0202186:	5ee73703          	ld	a4,1518(a4) # ffffffffc02aa770 <npage>
...
ffffffffc020219e:	5de53503          	ld	a0,1502(a0) # ffffffffc02aa778 <pages>
...
ffffffffc02021ee:	586c8c93          	addi	s9,s9,1414 # ffffffffc02aa770 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02021f2:	000a8c17          	auipc	s8,0xa8
ffffffffc02021f6:	586c0c13          	addi	s8,s8,1414 # ffffffffc02aa778 <pages>
ffffffffc02021fa:	fff80bb7          	lui	s7,0xfff80
        pmm_manager->free_pages(base, n);
ffffffffc02021fe:	000a8d17          	auipc	s10,0xa8
ffffffffc0202202:	582d0d13          	addi	s10,s10,1410 # ffffffffc02aa780 <pmm_manager>
...
ffffffffc02022b2:	3c268693          	addi	a3,a3,962 # ffffffffc0206670 <default_pmm_manager+0x160>
ffffffffc02022b6:	00004617          	auipc	a2,0x4
ffffffffc02022ba:	eaa60613          	addi	a2,a2,-342 # ffffffffc0206160 <commands+0x818>
ffffffffc02022be:	12000593          	li	a1,288
ffffffffc02022c2:	00004517          	auipc	a0,0x4
ffffffffc02022c6:	39e50513          	addi	a0,a0,926 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc02022ca:	9c4fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc02022ce:	00004697          	auipc	a3,0x4
ffffffffc02022d2:	3d268693          	addi	a3,a3,978 # ffffffffc02066a0 <default_pmm_manager+0x190>
ffffffffc02022d6:	00004617          	auipc	a2,0x4
ffffffffc02022da:	e8a60613          	addi	a2,a2,-374 # ffffffffc0206160 <commands+0x818>
ffffffffc02022de:	12100593          	li	a1,289
ffffffffc02022e2:	00004517          	auipc	a0,0x4
ffffffffc02022e6:	37e50513          	addi	a0,a0,894 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc020234c:	428d0d13          	addi	s10,s10,1064 # ffffffffc02aa770 <npage>
    return KADDR(page2pa(page));
ffffffffc0202350:	00ccdc93          	srli	s9,s9,0xc
    return &pages[PPN(pa) - nbase];
ffffffffc0202354:	000a8717          	auipc	a4,0xa8
ffffffffc0202358:	42470713          	addi	a4,a4,1060 # ffffffffc02aa778 <pages>
        pmm_manager->free_pages(base, n);
ffffffffc020235c:	000a8d97          	auipc	s11,0xa8
ffffffffc0202360:	424d8d93          	addi	s11,s11,1060 # ffffffffc02aa780 <pmm_manager>
...
ffffffffc0202374:	00043a03          	ld	s4,0(s0) # ffffffffc0000000 <_binary_obj___user_exit_out_size+0xffffffffbfff4ed8>
        if (pde1 & PTE_V)
...
ffffffffc02023bc:	3d080813          	addi	a6,a6,976 # ffffffffc02aa788 <va_pa_offset>
...
ffffffffc0202450:	33c80813          	addi	a6,a6,828 # ffffffffc02aa788 <va_pa_offset>
...
ffffffffc0202462:	31a70713          	addi	a4,a4,794 # ffffffffc02aa778 <pages>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc020249a:	2e270713          	addi	a4,a4,738 # ffffffffc02aa778 <pages>
...
ffffffffc02024e8:	29470713          	addi	a4,a4,660 # ffffffffc02aa778 <pages>
...
ffffffffc02024fa:	29280813          	addi	a6,a6,658 # ffffffffc02aa788 <va_pa_offset>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc020251e:	25e70713          	addi	a4,a4,606 # ffffffffc02aa778 <pages>
                pgdir[PDX1(d1start)] = 0;
...
ffffffffc020252c:	14868693          	addi	a3,a3,328 # ffffffffc0206670 <default_pmm_manager+0x160>
ffffffffc0202530:	00004617          	auipc	a2,0x4
ffffffffc0202534:	c3060613          	addi	a2,a2,-976 # ffffffffc0206160 <commands+0x818>
ffffffffc0202538:	13500593          	li	a1,309
ffffffffc020253c:	00004517          	auipc	a0,0x4
ffffffffc0202540:	12450513          	addi	a0,a0,292 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202544:	f4bfd0ef          	jal	ra,ffffffffc020048e <__panic>
    return KADDR(page2pa(page));
ffffffffc0202548:	00004617          	auipc	a2,0x4
ffffffffc020254c:	00060613          	mv	a2,a2
ffffffffc0202550:	07100593          	li	a1,113
ffffffffc0202554:	00004517          	auipc	a0,0x4
ffffffffc0202558:	01c50513          	addi	a0,a0,28 # ffffffffc0206570 <default_pmm_manager+0x60>
...
ffffffffc0202568:	13c68693          	addi	a3,a3,316 # ffffffffc02066a0 <default_pmm_manager+0x190>
ffffffffc020256c:	00004617          	auipc	a2,0x4
ffffffffc0202570:	bf460613          	addi	a2,a2,-1036 # ffffffffc0206160 <commands+0x818>
ffffffffc0202574:	13600593          	li	a1,310
ffffffffc0202578:	00004517          	auipc	a0,0x4
ffffffffc020257c:	0e850513          	addi	a0,a0,232 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc02025b2:	1c273703          	ld	a4,450(a4) # ffffffffc02aa770 <npage>
...
ffffffffc02025c6:	1b653503          	ld	a0,438(a0) # ffffffffc02aa778 <pages>
...
ffffffffc02025f4:	1907b783          	ld	a5,400(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc020260a:	17a7b783          	ld	a5,378(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc0202656:	12673703          	ld	a4,294(a4) # ffffffffc02aa778 <pages>
...
ffffffffc020266c:	0099b023          	sd	s1,0(s3) # ffffffffc0000000 <_binary_obj___user_exit_out_size+0xffffffffbfff4ed8>
    asm volatile("sfence.vma %0" : : "r"(la));
...
ffffffffc0202690:	0e473703          	ld	a4,228(a4) # ffffffffc02aa770 <npage>
ffffffffc0202694:	06e7ff63          	bgeu	a5,a4,ffffffffc0202712 <page_insert+0xf2>
    return &pages[PPN(pa) - nbase];
ffffffffc0202698:	000a8a97          	auipc	s5,0xa8
ffffffffc020269c:	0e0a8a93          	addi	s5,s5,224 # ffffffffc02aa778 <pages>
...
ffffffffc02026ae:	01240c63          	beq	s0,s2,ffffffffc02026c6 <page_insert+0xa6>
    page->ref -= 1;
ffffffffc02026b2:	00092783          	lw	a5,0(s2) # fffffffffff80000 <end+0x3fcd5854>
...
ffffffffc02026d6:	0ae7b783          	ld	a5,174(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc02026f4:	0907b783          	ld	a5,144(a5) # ffffffffc02aa780 <pmm_manager>
...
ffffffffc020271a:	dfa78793          	addi	a5,a5,-518 # ffffffffc0206510 <default_pmm_manager>
...
ffffffffc0202728:	f9450513          	addi	a0,a0,-108 # ffffffffc02066b8 <default_pmm_manager+0x1a8>
    pmm_manager = &default_pmm_manager;
ffffffffc020272c:	000a8b17          	auipc	s6,0xa8
ffffffffc0202730:	054b0b13          	addi	s6,s6,84 # ffffffffc02aa780 <pmm_manager>
{
...
ffffffffc0202758:	03498993          	addi	s3,s3,52 # ffffffffc02aa788 <va_pa_offset>
    pmm_manager->init();
...
ffffffffc020277c:	f7850513          	addi	a0,a0,-136 # ffffffffc02066f0 <default_pmm_manager+0x1e0>
...
ffffffffc0202794:	f7850513          	addi	a0,a0,-136 # ffffffffc0206708 <default_pmm_manager+0x1f8>
...
ffffffffc02027ac:	00360613          	addi	a2,a2,3 # ffffffffc02ab7ab <end+0xfff>
ffffffffc02027b0:	8e69                	and	a2,a2,a0
ffffffffc02027b2:	000a8497          	auipc	s1,0xa8
ffffffffc02027b6:	fbe48493          	addi	s1,s1,-66 # ffffffffc02aa770 <npage>
ffffffffc02027ba:	00c7d513          	srli	a0,a5,0xc
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc02027be:	000a8b97          	auipc	s7,0xa8
ffffffffc02027c2:	fbab8b93          	addi	s7,s7,-70 # ffffffffc02aa778 <pages>
    npage = maxpa / PGSIZE;
...
ffffffffc02027e4:	00850713          	addi	a4,a0,8 # fffffffffffff008 <end+0x3fd5485c>
...
ffffffffc020281c:	f1850513          	addi	a0,a0,-232 # ffffffffc0206730 <default_pmm_manager+0x220>
...
ffffffffc020282c:	f4090913          	addi	s2,s2,-192 # ffffffffc02aa768 <boot_pgdir_va>
    pmm_manager->check();
ffffffffc0202830:	7b9c                	ld	a5,48(a5)
ffffffffc0202832:	9782                	jalr	a5
    cprintf("check_alloc_page() succeeded!\n");
ffffffffc0202834:	00004517          	auipc	a0,0x4
ffffffffc0202838:	f1450513          	addi	a0,a0,-236 # ffffffffc0206748 <default_pmm_manager+0x238>
...
ffffffffc020285e:	f0d7b323          	sd	a3,-250(a5) # ffffffffc02aa760 <boot_pgdir_pa>
    if (read_csr(sstatus) & SSTATUS_SIE)
...
ffffffffc0202aca:	0007b023          	sd	zero,0(a5) # fffffffffffff000 <end+0x3fd54854>
...
ffffffffc0202aee:	f8650513          	addi	a0,a0,-122 # ffffffffc0206a70 <default_pmm_manager+0x560>
...
ffffffffc0202bb2:	00a58593          	addi	a1,a1,10 # ffffffffc0206bb8 <default_pmm_manager+0x6a8>
ffffffffc0202bb6:	10000513          	li	a0,256
ffffffffc0202bba:	28f020ef          	jal	ra,ffffffffc0205648 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202bbe:	10040593          	addi	a1,s0,256
ffffffffc0202bc2:	10000513          	li	a0,256
ffffffffc0202bc6:	295020ef          	jal	ra,ffffffffc020565a <strcmp>
...
ffffffffc0202bf8:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202bfc:	217020ef          	jal	ra,ffffffffc0205612 <strlen>
...
ffffffffc0202c08:	609c                	ld	a5,0(s1)
    return pa2page(PDE_ADDR(pde));
ffffffffc0202c0a:	000ab683          	ld	a3,0(s5) # fffffffffffff000 <end+0x3fd54854>
...
ffffffffc0202cc0:	f7450513          	addi	a0,a0,-140 # ffffffffc0206c30 <default_pmm_manager+0x720>
...
ffffffffc0202e28:	72460613          	addi	a2,a2,1828 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc0202e2c:	25200593          	li	a1,594
ffffffffc0202e30:	00004517          	auipc	a0,0x4
ffffffffc0202e34:	83050513          	addi	a0,a0,-2000 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202e38:	e56fd0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202e3c:	00004697          	auipc	a3,0x4
ffffffffc0202e40:	c9468693          	addi	a3,a3,-876 # ffffffffc0206ad0 <default_pmm_manager+0x5c0>
ffffffffc0202e44:	00003617          	auipc	a2,0x3
ffffffffc0202e48:	31c60613          	addi	a2,a2,796 # ffffffffc0206160 <commands+0x818>
ffffffffc0202e4c:	25300593          	li	a1,595
ffffffffc0202e50:	00004517          	auipc	a0,0x4
ffffffffc0202e54:	81050513          	addi	a0,a0,-2032 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202e58:	e36fd0ef          	jal	ra,ffffffffc020048e <__panic>
        assert((ptep = get_pte(boot_pgdir_va, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc0202e5c:	00004697          	auipc	a3,0x4
ffffffffc0202e60:	c3468693          	addi	a3,a3,-972 # ffffffffc0206a90 <default_pmm_manager+0x580>
ffffffffc0202e64:	00003617          	auipc	a2,0x3
ffffffffc0202e68:	2fc60613          	addi	a2,a2,764 # ffffffffc0206160 <commands+0x818>
ffffffffc0202e6c:	25200593          	li	a1,594
ffffffffc0202e70:	00003517          	auipc	a0,0x3
ffffffffc0202e74:	7f050513          	addi	a0,a0,2032 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc0202e88:	a0468693          	addi	a3,a3,-1532 # ffffffffc0206888 <default_pmm_manager+0x378>
ffffffffc0202e8c:	00003617          	auipc	a2,0x3
ffffffffc0202e90:	2d460613          	addi	a2,a2,724 # ffffffffc0206160 <commands+0x818>
ffffffffc0202e94:	22200593          	li	a1,546
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	7c850513          	addi	a0,a0,1992 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202ea0:	deefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(get_page(boot_pgdir_va, 0x0, NULL) == NULL);
ffffffffc0202ea4:	00004697          	auipc	a3,0x4
ffffffffc0202ea8:	92468693          	addi	a3,a3,-1756 # ffffffffc02067c8 <default_pmm_manager+0x2b8>
ffffffffc0202eac:	00003617          	auipc	a2,0x3
ffffffffc0202eb0:	2b460613          	addi	a2,a2,692 # ffffffffc0206160 <commands+0x818>
ffffffffc0202eb4:	21500593          	li	a1,533
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	7a850513          	addi	a0,a0,1960 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202ec0:	dcefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(boot_pgdir_va != NULL && (uint32_t)PGOFF(boot_pgdir_va) == 0);
ffffffffc0202ec4:	00004697          	auipc	a3,0x4
ffffffffc0202ec8:	8c468693          	addi	a3,a3,-1852 # ffffffffc0206788 <default_pmm_manager+0x278>
ffffffffc0202ecc:	00003617          	auipc	a2,0x3
ffffffffc0202ed0:	29460613          	addi	a2,a2,660 # ffffffffc0206160 <commands+0x818>
ffffffffc0202ed4:	21400593          	li	a1,532
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	78850513          	addi	a0,a0,1928 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202ee0:	daefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202ee4:	00004697          	auipc	a3,0x4
ffffffffc0202ee8:	88468693          	addi	a3,a3,-1916 # ffffffffc0206768 <default_pmm_manager+0x258>
ffffffffc0202eec:	00003617          	auipc	a2,0x3
ffffffffc0202ef0:	27460613          	addi	a2,a2,628 # ffffffffc0206160 <commands+0x818>
ffffffffc0202ef4:	21300593          	li	a1,531
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	76850513          	addi	a0,a0,1896 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202f00:	d8efd0ef          	jal	ra,ffffffffc020048e <__panic>
    return KADDR(page2pa(page));
ffffffffc0202f04:	00003617          	auipc	a2,0x3
ffffffffc0202f08:	64460613          	addi	a2,a2,1604 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc0202f0c:	07100593          	li	a1,113
ffffffffc0202f10:	00003517          	auipc	a0,0x3
ffffffffc0202f14:	66050513          	addi	a0,a0,1632 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc0202f18:	d76fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(pde2page(boot_pgdir_va[0])) == 1);
ffffffffc0202f1c:	00004697          	auipc	a3,0x4
ffffffffc0202f20:	afc68693          	addi	a3,a3,-1284 # ffffffffc0206a18 <default_pmm_manager+0x508>
ffffffffc0202f24:	00003617          	auipc	a2,0x3
ffffffffc0202f28:	23c60613          	addi	a2,a2,572 # ffffffffc0206160 <commands+0x818>
ffffffffc0202f2c:	23b00593          	li	a1,571
...
ffffffffc0202f40:	a9468693          	addi	a3,a3,-1388 # ffffffffc02069d0 <default_pmm_manager+0x4c0>
ffffffffc0202f44:	00003617          	auipc	a2,0x3
ffffffffc0202f48:	21c60613          	addi	a2,a2,540 # ffffffffc0206160 <commands+0x818>
ffffffffc0202f4c:	23900593          	li	a1,569
ffffffffc0202f50:	00003517          	auipc	a0,0x3
ffffffffc0202f54:	71050513          	addi	a0,a0,1808 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202f58:	d36fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202f5c:	00004697          	auipc	a3,0x4
ffffffffc0202f60:	aa468693          	addi	a3,a3,-1372 # ffffffffc0206a00 <default_pmm_manager+0x4f0>
ffffffffc0202f64:	00003617          	auipc	a2,0x3
ffffffffc0202f68:	1fc60613          	addi	a2,a2,508 # ffffffffc0206160 <commands+0x818>
ffffffffc0202f6c:	23800593          	li	a1,568
ffffffffc0202f70:	00003517          	auipc	a0,0x3
ffffffffc0202f74:	6f050513          	addi	a0,a0,1776 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202f78:	d16fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(boot_pgdir_va[0] == 0);
ffffffffc0202f7c:	00004697          	auipc	a3,0x4
ffffffffc0202f80:	b6c68693          	addi	a3,a3,-1172 # ffffffffc0206ae8 <default_pmm_manager+0x5d8>
ffffffffc0202f84:	00003617          	auipc	a2,0x3
ffffffffc0202f88:	1dc60613          	addi	a2,a2,476 # ffffffffc0206160 <commands+0x818>
ffffffffc0202f8c:	25600593          	li	a1,598
ffffffffc0202f90:	00003517          	auipc	a0,0x3
ffffffffc0202f94:	6d050513          	addi	a0,a0,1744 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202f98:	cf6fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc0202f9c:	00004697          	auipc	a3,0x4
ffffffffc0202fa0:	aac68693          	addi	a3,a3,-1364 # ffffffffc0206a48 <default_pmm_manager+0x538>
ffffffffc0202fa4:	00003617          	auipc	a2,0x3
ffffffffc0202fa8:	1bc60613          	addi	a2,a2,444 # ffffffffc0206160 <commands+0x818>
ffffffffc0202fac:	24300593          	li	a1,579
ffffffffc0202fb0:	00003517          	auipc	a0,0x3
ffffffffc0202fb4:	6b050513          	addi	a0,a0,1712 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202fb8:	cd6fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202fbc:	00004697          	auipc	a3,0x4
ffffffffc0202fc0:	b8468693          	addi	a3,a3,-1148 # ffffffffc0206b40 <default_pmm_manager+0x630>
ffffffffc0202fc4:	00003617          	auipc	a2,0x3
ffffffffc0202fc8:	19c60613          	addi	a2,a2,412 # ffffffffc0206160 <commands+0x818>
ffffffffc0202fcc:	25b00593          	li	a1,603
ffffffffc0202fd0:	00003517          	auipc	a0,0x3
ffffffffc0202fd4:	69050513          	addi	a0,a0,1680 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202fd8:	cb6fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202fdc:	00004697          	auipc	a3,0x4
ffffffffc0202fe0:	b2468693          	addi	a3,a3,-1244 # ffffffffc0206b00 <default_pmm_manager+0x5f0>
ffffffffc0202fe4:	00003617          	auipc	a2,0x3
ffffffffc0202fe8:	17c60613          	addi	a2,a2,380 # ffffffffc0206160 <commands+0x818>
ffffffffc0202fec:	25a00593          	li	a1,602
ffffffffc0202ff0:	00003517          	auipc	a0,0x3
ffffffffc0202ff4:	67050513          	addi	a0,a0,1648 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0202ff8:	c96fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202ffc:	00004697          	auipc	a3,0x4
ffffffffc0203000:	9d468693          	addi	a3,a3,-1580 # ffffffffc02069d0 <default_pmm_manager+0x4c0>
ffffffffc0203004:	00003617          	auipc	a2,0x3
ffffffffc0203008:	15c60613          	addi	a2,a2,348 # ffffffffc0206160 <commands+0x818>
ffffffffc020300c:	23500593          	li	a1,565
ffffffffc0203010:	00003517          	auipc	a0,0x3
ffffffffc0203014:	65050513          	addi	a0,a0,1616 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203018:	c76fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020301c:	00004697          	auipc	a3,0x4
ffffffffc0203020:	85468693          	addi	a3,a3,-1964 # ffffffffc0206870 <default_pmm_manager+0x360>
ffffffffc0203024:	00003617          	auipc	a2,0x3
ffffffffc0203028:	13c60613          	addi	a2,a2,316 # ffffffffc0206160 <commands+0x818>
ffffffffc020302c:	23400593          	li	a1,564
ffffffffc0203030:	00003517          	auipc	a0,0x3
ffffffffc0203034:	63050513          	addi	a0,a0,1584 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203038:	c56fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020303c:	00004697          	auipc	a3,0x4
ffffffffc0203040:	9ac68693          	addi	a3,a3,-1620 # ffffffffc02069e8 <default_pmm_manager+0x4d8>
ffffffffc0203044:	00003617          	auipc	a2,0x3
ffffffffc0203048:	11c60613          	addi	a2,a2,284 # ffffffffc0206160 <commands+0x818>
ffffffffc020304c:	23100593          	li	a1,561
ffffffffc0203050:	00003517          	auipc	a0,0x3
ffffffffc0203054:	61050513          	addi	a0,a0,1552 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203058:	c36fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020305c:	00003697          	auipc	a3,0x3
ffffffffc0203060:	7fc68693          	addi	a3,a3,2044 # ffffffffc0206858 <default_pmm_manager+0x348>
ffffffffc0203064:	00003617          	auipc	a2,0x3
ffffffffc0203068:	0fc60613          	addi	a2,a2,252 # ffffffffc0206160 <commands+0x818>
ffffffffc020306c:	23000593          	li	a1,560
ffffffffc0203070:	00003517          	auipc	a0,0x3
ffffffffc0203074:	5f050513          	addi	a0,a0,1520 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203078:	c16fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc020307c:	00004697          	auipc	a3,0x4
ffffffffc0203080:	87c68693          	addi	a3,a3,-1924 # ffffffffc02068f8 <default_pmm_manager+0x3e8>
ffffffffc0203084:	00003617          	auipc	a2,0x3
ffffffffc0203088:	0dc60613          	addi	a2,a2,220 # ffffffffc0206160 <commands+0x818>
ffffffffc020308c:	22f00593          	li	a1,559
ffffffffc0203090:	00003517          	auipc	a0,0x3
ffffffffc0203094:	5d050513          	addi	a0,a0,1488 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203098:	bf6fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020309c:	00004697          	auipc	a3,0x4
ffffffffc02030a0:	93468693          	addi	a3,a3,-1740 # ffffffffc02069d0 <default_pmm_manager+0x4c0>
ffffffffc02030a4:	00003617          	auipc	a2,0x3
ffffffffc02030a8:	0bc60613          	addi	a2,a2,188 # ffffffffc0206160 <commands+0x818>
ffffffffc02030ac:	22e00593          	li	a1,558
ffffffffc02030b0:	00003517          	auipc	a0,0x3
ffffffffc02030b4:	5b050513          	addi	a0,a0,1456 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc02030b8:	bd6fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p1) == 2);
ffffffffc02030bc:	00004697          	auipc	a3,0x4
ffffffffc02030c0:	8fc68693          	addi	a3,a3,-1796 # ffffffffc02069b8 <default_pmm_manager+0x4a8>
ffffffffc02030c4:	00003617          	auipc	a2,0x3
ffffffffc02030c8:	09c60613          	addi	a2,a2,156 # ffffffffc0206160 <commands+0x818>
ffffffffc02030cc:	22d00593          	li	a1,557
ffffffffc02030d0:	00003517          	auipc	a0,0x3
ffffffffc02030d4:	59050513          	addi	a0,a0,1424 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc02030d8:	bb6fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_insert(boot_pgdir_va, p1, PGSIZE, 0) == 0);
ffffffffc02030dc:	00004697          	auipc	a3,0x4
ffffffffc02030e0:	8ac68693          	addi	a3,a3,-1876 # ffffffffc0206988 <default_pmm_manager+0x478>
ffffffffc02030e4:	00003617          	auipc	a2,0x3
ffffffffc02030e8:	07c60613          	addi	a2,a2,124 # ffffffffc0206160 <commands+0x818>
ffffffffc02030ec:	22c00593          	li	a1,556
ffffffffc02030f0:	00003517          	auipc	a0,0x3
ffffffffc02030f4:	57050513          	addi	a0,a0,1392 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc02030f8:	b96fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02030fc:	00004697          	auipc	a3,0x4
ffffffffc0203100:	87468693          	addi	a3,a3,-1932 # ffffffffc0206970 <default_pmm_manager+0x460>
ffffffffc0203104:	00003617          	auipc	a2,0x3
ffffffffc0203108:	05c60613          	addi	a2,a2,92 # ffffffffc0206160 <commands+0x818>
ffffffffc020310c:	22a00593          	li	a1,554
ffffffffc0203110:	00003517          	auipc	a0,0x3
ffffffffc0203114:	55050513          	addi	a0,a0,1360 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203118:	b76fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(boot_pgdir_va[0] & PTE_U);
ffffffffc020311c:	00004697          	auipc	a3,0x4
ffffffffc0203120:	83468693          	addi	a3,a3,-1996 # ffffffffc0206950 <default_pmm_manager+0x440>
ffffffffc0203124:	00003617          	auipc	a2,0x3
ffffffffc0203128:	03c60613          	addi	a2,a2,60 # ffffffffc0206160 <commands+0x818>
ffffffffc020312c:	22900593          	li	a1,553
ffffffffc0203130:	00003517          	auipc	a0,0x3
ffffffffc0203134:	53050513          	addi	a0,a0,1328 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203138:	b56fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(*ptep & PTE_W);
ffffffffc020313c:	00004697          	auipc	a3,0x4
ffffffffc0203140:	80468693          	addi	a3,a3,-2044 # ffffffffc0206940 <default_pmm_manager+0x430>
ffffffffc0203144:	00003617          	auipc	a2,0x3
ffffffffc0203148:	01c60613          	addi	a2,a2,28 # ffffffffc0206160 <commands+0x818>
ffffffffc020314c:	22800593          	li	a1,552
ffffffffc0203150:	00003517          	auipc	a0,0x3
ffffffffc0203154:	51050513          	addi	a0,a0,1296 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203158:	b36fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(*ptep & PTE_U);
ffffffffc020315c:	00003697          	auipc	a3,0x3
ffffffffc0203160:	7d468693          	addi	a3,a3,2004 # ffffffffc0206930 <default_pmm_manager+0x420>
ffffffffc0203164:	00003617          	auipc	a2,0x3
ffffffffc0203168:	ffc60613          	addi	a2,a2,-4 # ffffffffc0206160 <commands+0x818>
ffffffffc020316c:	22700593          	li	a1,551
ffffffffc0203170:	00003517          	auipc	a0,0x3
ffffffffc0203174:	4f050513          	addi	a0,a0,1264 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203178:	b16fd0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("DTB memory info not available");
ffffffffc020317c:	00003617          	auipc	a2,0x3
ffffffffc0203180:	55460613          	addi	a2,a2,1364 # ffffffffc02066d0 <default_pmm_manager+0x1c0>
...
ffffffffc0203198:	8b468693          	addi	a3,a3,-1868 # ffffffffc0206a48 <default_pmm_manager+0x538>
ffffffffc020319c:	00003617          	auipc	a2,0x3
ffffffffc02031a0:	fc460613          	addi	a2,a2,-60 # ffffffffc0206160 <commands+0x818>
ffffffffc02031a4:	26d00593          	li	a1,621
...
ffffffffc02031b8:	74468693          	addi	a3,a3,1860 # ffffffffc02068f8 <default_pmm_manager+0x3e8>
ffffffffc02031bc:	00003617          	auipc	a2,0x3
ffffffffc02031c0:	fa460613          	addi	a2,a2,-92 # ffffffffc0206160 <commands+0x818>
ffffffffc02031c4:	22600593          	li	a1,550
ffffffffc02031c8:	00003517          	auipc	a0,0x3
ffffffffc02031cc:	49850513          	addi	a0,a0,1176 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc02031d0:	abefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_insert(boot_pgdir_va, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02031d4:	00003697          	auipc	a3,0x3
ffffffffc02031d8:	6e468693          	addi	a3,a3,1764 # ffffffffc02068b8 <default_pmm_manager+0x3a8>
ffffffffc02031dc:	00003617          	auipc	a2,0x3
ffffffffc02031e0:	f8460613          	addi	a2,a2,-124 # ffffffffc0206160 <commands+0x818>
ffffffffc02031e4:	22500593          	li	a1,549
ffffffffc02031e8:	00003517          	auipc	a0,0x3
ffffffffc02031ec:	47850513          	addi	a0,a0,1144 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc02031fa:	35260613          	addi	a2,a2,850 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc02031fe:	22100593          	li	a1,545
ffffffffc0203202:	00003517          	auipc	a0,0x3
ffffffffc0203206:	45e50513          	addi	a0,a0,1118 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc020320a:	a84fd0ef          	jal	ra,ffffffffc020048e <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir_va[0]));
ffffffffc020320e:	00003617          	auipc	a2,0x3
ffffffffc0203212:	33a60613          	addi	a2,a2,826 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc0203216:	22000593          	li	a1,544
ffffffffc020321a:	00003517          	auipc	a0,0x3
ffffffffc020321e:	44650513          	addi	a0,a0,1094 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203222:	a6cfd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0203226:	00003697          	auipc	a3,0x3
ffffffffc020322a:	64a68693          	addi	a3,a3,1610 # ffffffffc0206870 <default_pmm_manager+0x360>
ffffffffc020322e:	00003617          	auipc	a2,0x3
ffffffffc0203232:	f3260613          	addi	a2,a2,-206 # ffffffffc0206160 <commands+0x818>
...
ffffffffc020324a:	61268693          	addi	a3,a3,1554 # ffffffffc0206858 <default_pmm_manager+0x348>
ffffffffc020324e:	00003617          	auipc	a2,0x3
ffffffffc0203252:	f1260613          	addi	a2,a2,-238 # ffffffffc0206160 <commands+0x818>
ffffffffc0203256:	21d00593          	li	a1,541
ffffffffc020325a:	00003517          	auipc	a0,0x3
ffffffffc020325e:	40650513          	addi	a0,a0,1030 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203262:	a2cfd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0203266:	00004697          	auipc	a3,0x4
ffffffffc020326a:	9a268693          	addi	a3,a3,-1630 # ffffffffc0206c08 <default_pmm_manager+0x6f8>
ffffffffc020326e:	00003617          	auipc	a2,0x3
ffffffffc0203272:	ef260613          	addi	a2,a2,-270 # ffffffffc0206160 <commands+0x818>
ffffffffc0203276:	26400593          	li	a1,612
ffffffffc020327a:	00003517          	auipc	a0,0x3
ffffffffc020327e:	3e650513          	addi	a0,a0,998 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203282:	a0cfd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0203286:	00004697          	auipc	a3,0x4
ffffffffc020328a:	94a68693          	addi	a3,a3,-1718 # ffffffffc0206bd0 <default_pmm_manager+0x6c0>
ffffffffc020328e:	00003617          	auipc	a2,0x3
ffffffffc0203292:	ed260613          	addi	a2,a2,-302 # ffffffffc0206160 <commands+0x818>
ffffffffc0203296:	26100593          	li	a1,609
ffffffffc020329a:	00003517          	auipc	a0,0x3
ffffffffc020329e:	3c650513          	addi	a0,a0,966 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc02032a2:	9ecfd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p) == 2);
ffffffffc02032a6:	00004697          	auipc	a3,0x4
ffffffffc02032aa:	8fa68693          	addi	a3,a3,-1798 # ffffffffc0206ba0 <default_pmm_manager+0x690>
ffffffffc02032ae:	00003617          	auipc	a2,0x3
ffffffffc02032b2:	eb260613          	addi	a2,a2,-334 # ffffffffc0206160 <commands+0x818>
ffffffffc02032b6:	25d00593          	li	a1,605
ffffffffc02032ba:	00003517          	auipc	a0,0x3
ffffffffc02032be:	3a650513          	addi	a0,a0,934 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc02032c2:	9ccfd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02032c6:	00004697          	auipc	a3,0x4
ffffffffc02032ca:	89268693          	addi	a3,a3,-1902 # ffffffffc0206b58 <default_pmm_manager+0x648>
ffffffffc02032ce:	00003617          	auipc	a2,0x3
ffffffffc02032d2:	e9260613          	addi	a2,a2,-366 # ffffffffc0206160 <commands+0x818>
ffffffffc02032d6:	25c00593          	li	a1,604
ffffffffc02032da:	00003517          	auipc	a0,0x3
ffffffffc02032de:	38650513          	addi	a0,a0,902 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc02032e2:	9acfd0ef          	jal	ra,ffffffffc020048e <__panic>
    boot_pgdir_pa = PADDR(boot_pgdir_va);
ffffffffc02032e6:	00003617          	auipc	a2,0x3
ffffffffc02032ea:	30a60613          	addi	a2,a2,778 # ffffffffc02065f0 <default_pmm_manager+0xe0>
...
ffffffffc0203302:	2f260613          	addi	a2,a2,754 # ffffffffc02065f0 <default_pmm_manager+0xe0>
ffffffffc0203306:	08100593          	li	a1,129
ffffffffc020330a:	00003517          	auipc	a0,0x3
ffffffffc020330e:	35650513          	addi	a0,a0,854 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203312:	97cfd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((ptep = get_pte(boot_pgdir_va, 0x0, 0)) != NULL);
ffffffffc0203316:	00003697          	auipc	a3,0x3
ffffffffc020331a:	51268693          	addi	a3,a3,1298 # ffffffffc0206828 <default_pmm_manager+0x318>
ffffffffc020331e:	00003617          	auipc	a2,0x3
ffffffffc0203322:	e4260613          	addi	a2,a2,-446 # ffffffffc0206160 <commands+0x818>
ffffffffc0203326:	21c00593          	li	a1,540
...
ffffffffc020333a:	4c268693          	addi	a3,a3,1218 # ffffffffc02067f8 <default_pmm_manager+0x2e8>
ffffffffc020333e:	00003617          	auipc	a2,0x3
ffffffffc0203342:	e2260613          	addi	a2,a2,-478 # ffffffffc0206160 <commands+0x818>
ffffffffc0203346:	21900593          	li	a1,537
ffffffffc020334a:	00003517          	auipc	a0,0x3
ffffffffc020334e:	31650513          	addi	a0,a0,790 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc02033a0:	3d4c0c13          	addi	s8,s8,980 # ffffffffc02aa770 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02033a4:	000a7b97          	auipc	s7,0xa7
ffffffffc02033a8:	3d4b8b93          	addi	s7,s7,980 # ffffffffc02aa778 <pages>
    return KADDR(page2pa(page));
ffffffffc02033ac:	00cb5b13          	srli	s6,s6,0xc
        page = pmm_manager->alloc_pages(n);
ffffffffc02033b0:	000a7c97          	auipc	s9,0xa7
ffffffffc02033b4:	3d0c8c93          	addi	s9,s9,976 # ffffffffc02aa780 <pmm_manager>
...
ffffffffc020346e:	31e70713          	addi	a4,a4,798 # ffffffffc02aa788 <va_pa_offset>
...
ffffffffc020348a:	23c020ef          	jal	ra,ffffffffc02056c6 <memcpy>
...
ffffffffc02034a0:	7d468693          	addi	a3,a3,2004 # ffffffffc0206c70 <default_pmm_manager+0x760>
ffffffffc02034a4:	00003617          	auipc	a2,0x3
ffffffffc02034a8:	cbc60613          	addi	a2,a2,-836 # ffffffffc0206160 <commands+0x818>
ffffffffc02034ac:	1b100593          	li	a1,433
ffffffffc02034b0:	00003517          	auipc	a0,0x3
ffffffffc02034b4:	1b050513          	addi	a0,a0,432 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc02034f2:	05a60613          	addi	a2,a2,90 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc02034f6:	07100593          	li	a1,113
ffffffffc02034fa:	00003517          	auipc	a0,0x3
ffffffffc02034fe:	07650513          	addi	a0,a0,118 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc0203502:	f8dfc0ef          	jal	ra,ffffffffc020048e <__panic>
            assert(page != NULL);
ffffffffc0203506:	00003697          	auipc	a3,0x3
ffffffffc020350a:	74a68693          	addi	a3,a3,1866 # ffffffffc0206c50 <default_pmm_manager+0x740>
ffffffffc020350e:	00003617          	auipc	a2,0x3
ffffffffc0203512:	c5260613          	addi	a2,a2,-942 # ffffffffc0206160 <commands+0x818>
ffffffffc0203516:	19400593          	li	a1,404
ffffffffc020351a:	00003517          	auipc	a0,0x3
ffffffffc020351e:	14650513          	addi	a0,a0,326 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203522:	f6dfc0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc0203526:	00003697          	auipc	a3,0x3
ffffffffc020352a:	17a68693          	addi	a3,a3,378 # ffffffffc02066a0 <default_pmm_manager+0x190>
ffffffffc020352e:	00003617          	auipc	a2,0x3
ffffffffc0203532:	c3260613          	addi	a2,a2,-974 # ffffffffc0206160 <commands+0x818>
ffffffffc0203536:	17c00593          	li	a1,380
ffffffffc020353a:	00003517          	auipc	a0,0x3
ffffffffc020353e:	12650513          	addi	a0,a0,294 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203542:	f4dfc0ef          	jal	ra,ffffffffc020048e <__panic>
            assert(npage != NULL);
ffffffffc0203546:	00003697          	auipc	a3,0x3
ffffffffc020354a:	71a68693          	addi	a3,a3,1818 # ffffffffc0206c60 <default_pmm_manager+0x750>
ffffffffc020354e:	00003617          	auipc	a2,0x3
ffffffffc0203552:	c1260613          	addi	a2,a2,-1006 # ffffffffc0206160 <commands+0x818>
ffffffffc0203556:	19500593          	li	a1,405
ffffffffc020355a:	00003517          	auipc	a0,0x3
ffffffffc020355e:	10650513          	addi	a0,a0,262 # ffffffffc0206660 <default_pmm_manager+0x150>
ffffffffc0203562:	f2dfc0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203566:	00003617          	auipc	a2,0x3
ffffffffc020356a:	0b260613          	addi	a2,a2,178 # ffffffffc0206618 <default_pmm_manager+0x108>
ffffffffc020356e:	06900593          	li	a1,105
ffffffffc0203572:	00003517          	auipc	a0,0x3
ffffffffc0203576:	ffe50513          	addi	a0,a0,-2 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc020357a:	f15fc0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("pte2page called with invalid pte");
ffffffffc020357e:	00003617          	auipc	a2,0x3
ffffffffc0203582:	0ba60613          	addi	a2,a2,186 # ffffffffc0206638 <default_pmm_manager+0x128>
ffffffffc0203586:	07f00593          	li	a1,127
ffffffffc020358a:	00003517          	auipc	a0,0x3
ffffffffc020358e:	fe650513          	addi	a0,a0,-26 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc0203592:	efdfc0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc0203596:	00003697          	auipc	a3,0x3
ffffffffc020359a:	0da68693          	addi	a3,a3,218 # ffffffffc0206670 <default_pmm_manager+0x160>
ffffffffc020359e:	00003617          	auipc	a2,0x3
ffffffffc02035a2:	bc260613          	addi	a2,a2,-1086 # ffffffffc0206160 <commands+0x818>
ffffffffc02035a6:	17b00593          	li	a1,379
ffffffffc02035aa:	00003517          	auipc	a0,0x3
ffffffffc02035ae:	0b650513          	addi	a0,a0,182 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc02035d4:	1b098993          	addi	s3,s3,432 # ffffffffc02aa780 <pmm_manager>
...
ffffffffc020365c:	62868693          	addi	a3,a3,1576 # ffffffffc0206c80 <default_pmm_manager+0x770>
ffffffffc0203660:	00003617          	auipc	a2,0x3
ffffffffc0203664:	b0060613          	addi	a2,a2,-1280 # ffffffffc0206160 <commands+0x818>
ffffffffc0203668:	1fa00593          	li	a1,506
ffffffffc020366c:	00003517          	auipc	a0,0x3
ffffffffc0203670:	ff450513          	addi	a0,a0,-12 # ffffffffc0206660 <default_pmm_manager+0x150>
...
ffffffffc020367e:	61e68693          	addi	a3,a3,1566 # ffffffffc0206c98 <default_pmm_manager+0x788>
ffffffffc0203682:	00003617          	auipc	a2,0x3
ffffffffc0203686:	ade60613          	addi	a2,a2,-1314 # ffffffffc0206160 <commands+0x818>
ffffffffc020368a:	07400593          	li	a1,116
ffffffffc020368e:	00003517          	auipc	a0,0x3
ffffffffc0203692:	62a50513          	addi	a0,a0,1578 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next)
...
ffffffffc02036e0:	fe87b703          	ld	a4,-24(a5) # 1fffe8 <_binary_obj___user_exit_out_size+0x1f4ec0>
...
ffffffffc020370e:	0105b803          	ld	a6,16(a1) # 80010 <_binary_obj___user_exit_out_size+0x74ee8>
{
...
ffffffffc0203780:	54c68693          	addi	a3,a3,1356 # ffffffffc0206cc8 <default_pmm_manager+0x7b8>
ffffffffc0203784:	00003617          	auipc	a2,0x3
ffffffffc0203788:	9dc60613          	addi	a2,a2,-1572 # ffffffffc0206160 <commands+0x818>
ffffffffc020378c:	07a00593          	li	a1,122
ffffffffc0203790:	00003517          	auipc	a0,0x3
ffffffffc0203794:	52850513          	addi	a0,a0,1320 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc0203798:	cf7fc0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020379c:	00003697          	auipc	a3,0x3
ffffffffc02037a0:	56c68693          	addi	a3,a3,1388 # ffffffffc0206d08 <default_pmm_manager+0x7f8>
ffffffffc02037a4:	00003617          	auipc	a2,0x3
ffffffffc02037a8:	9bc60613          	addi	a2,a2,-1604 # ffffffffc0206160 <commands+0x818>
ffffffffc02037ac:	07300593          	li	a1,115
ffffffffc02037b0:	00003517          	auipc	a0,0x3
ffffffffc02037b4:	50850513          	addi	a0,a0,1288 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc02037b8:	cd7fc0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02037bc:	00003697          	auipc	a3,0x3
ffffffffc02037c0:	52c68693          	addi	a3,a3,1324 # ffffffffc0206ce8 <default_pmm_manager+0x7d8>
ffffffffc02037c4:	00003617          	auipc	a2,0x3
ffffffffc02037c8:	99c60613          	addi	a2,a2,-1636 # ffffffffc0206160 <commands+0x818>
ffffffffc02037cc:	07200593          	li	a1,114
ffffffffc02037d0:	00003517          	auipc	a0,0x3
ffffffffc02037d4:	4e850513          	addi	a0,a0,1256 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
...
ffffffffc0203812:	51a68693          	addi	a3,a3,1306 # ffffffffc0206d28 <default_pmm_manager+0x818>
ffffffffc0203816:	00003617          	auipc	a2,0x3
ffffffffc020381a:	94a60613          	addi	a2,a2,-1718 # ffffffffc0206160 <commands+0x818>
ffffffffc020381e:	09e00593          	li	a1,158
ffffffffc0203822:	00003517          	auipc	a0,0x3
ffffffffc0203826:	49650513          	addi	a0,a0,1174 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
...
ffffffffc02038a0:	000a0463          	beqz	s4,ffffffffc02038a8 <mm_map+0x7a>
        *vma_store = vma;
ffffffffc02038a4:	012a3023          	sd	s2,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8bb0>
...
ffffffffc02038c2:	48268693          	addi	a3,a3,1154 # ffffffffc0206d40 <default_pmm_manager+0x830>
ffffffffc02038c6:	00003617          	auipc	a2,0x3
ffffffffc02038ca:	89a60613          	addi	a2,a2,-1894 # ffffffffc0206160 <commands+0x818>
ffffffffc02038ce:	0b300593          	li	a1,179
ffffffffc02038d2:	00003517          	auipc	a0,0x3
ffffffffc02038d6:	3e650513          	addi	a0,a0,998 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
...
ffffffffc02038fa:	854a                	mv	a0,s2
        vma->vm_start = vm_start;
ffffffffc02038fc:	0155b423          	sd	s5,8(a1) # 200008 <_binary_obj___user_exit_out_size+0x1f4ee0>
        vma->vm_end = vm_end;
...
ffffffffc020390c:	ff043683          	ld	a3,-16(s0) # ff0 <_binary_obj___user_faultread_out_size-0x8bc0>
...
ffffffffc020395c:	3f868693          	addi	a3,a3,1016 # ffffffffc0206d50 <default_pmm_manager+0x840>
ffffffffc0203960:	00003617          	auipc	a2,0x3
ffffffffc0203964:	80060613          	addi	a2,a2,-2048 # ffffffffc0206160 <commands+0x818>
ffffffffc0203968:	0cf00593          	li	a1,207
ffffffffc020396c:	00003517          	auipc	a0,0x3
ffffffffc0203970:	34c50513          	addi	a0,a0,844 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
...
ffffffffc02039d2:	3a268693          	addi	a3,a3,930 # ffffffffc0206d70 <default_pmm_manager+0x860>
ffffffffc02039d6:	00002617          	auipc	a2,0x2
ffffffffc02039da:	78a60613          	addi	a2,a2,1930 # ffffffffc0206160 <commands+0x818>
ffffffffc02039de:	0e800593          	li	a1,232
ffffffffc02039e2:	00003517          	auipc	a0,0x3
ffffffffc02039e6:	2d650513          	addi	a0,a0,726 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
...
ffffffffc0203a54:	4b868693          	addi	a3,a3,1208 # ffffffffc0206f08 <default_pmm_manager+0x9f8>
ffffffffc0203a58:	00002617          	auipc	a2,0x2
ffffffffc0203a5c:	70860613          	addi	a2,a2,1800 # ffffffffc0206160 <commands+0x818>
ffffffffc0203a60:	12c00593          	li	a1,300
ffffffffc0203a64:	00003517          	auipc	a0,0x3
ffffffffc0203a68:	25450513          	addi	a0,a0,596 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
...
ffffffffc0203aa2:	46a68693          	addi	a3,a3,1130 # ffffffffc0206f08 <default_pmm_manager+0x9f8>
ffffffffc0203aa6:	00002617          	auipc	a2,0x2
ffffffffc0203aaa:	6ba60613          	addi	a2,a2,1722 # ffffffffc0206160 <commands+0x818>
ffffffffc0203aae:	13300593          	li	a1,307
ffffffffc0203ab2:	00003517          	auipc	a0,0x3
ffffffffc0203ab6:	20650513          	addi	a0,a0,518 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
...
ffffffffc0203aca:	fe87b603          	ld	a2,-24(a5) # ffffffffffffefe8 <end+0x3fd5483c>
...
ffffffffc0203b76:	31e50513          	addi	a0,a0,798 # ffffffffc0206e90 <default_pmm_manager+0x980>
ffffffffc0203b7a:	e1afc0ef          	jal	ra,ffffffffc0200194 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203b7e:	00003697          	auipc	a3,0x3
ffffffffc0203b82:	33a68693          	addi	a3,a3,826 # ffffffffc0206eb8 <default_pmm_manager+0x9a8>
ffffffffc0203b86:	00002617          	auipc	a2,0x2
ffffffffc0203b8a:	5da60613          	addi	a2,a2,1498 # ffffffffc0206160 <commands+0x818>
ffffffffc0203b8e:	15900593          	li	a1,345
ffffffffc0203b92:	00003517          	auipc	a0,0x3
ffffffffc0203b96:	12650513          	addi	a0,a0,294 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
...
ffffffffc0203bae:	32650513          	addi	a0,a0,806 # ffffffffc0206ed0 <default_pmm_manager+0x9c0>
...
ffffffffc0203bc8:	32c50513          	addi	a0,a0,812 # ffffffffc0206ef0 <default_pmm_manager+0x9e0>
}
...
ffffffffc0203bd6:	1d668693          	addi	a3,a3,470 # ffffffffc0206da8 <default_pmm_manager+0x898>
ffffffffc0203bda:	00002617          	auipc	a2,0x2
ffffffffc0203bde:	58660613          	addi	a2,a2,1414 # ffffffffc0206160 <commands+0x818>
ffffffffc0203be2:	13d00593          	li	a1,317
ffffffffc0203be6:	00003517          	auipc	a0,0x3
ffffffffc0203bea:	0d250513          	addi	a0,a0,210 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc0203bee:	8a1fc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc0203bf2:	00003697          	auipc	a3,0x3
ffffffffc0203bf6:	23e68693          	addi	a3,a3,574 # ffffffffc0206e30 <default_pmm_manager+0x920>
ffffffffc0203bfa:	00002617          	auipc	a2,0x2
ffffffffc0203bfe:	56660613          	addi	a2,a2,1382 # ffffffffc0206160 <commands+0x818>
ffffffffc0203c02:	14e00593          	li	a1,334
ffffffffc0203c06:	00003517          	auipc	a0,0x3
ffffffffc0203c0a:	0b250513          	addi	a0,a0,178 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc0203c0e:	881fc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc0203c12:	00003697          	auipc	a3,0x3
ffffffffc0203c16:	24e68693          	addi	a3,a3,590 # ffffffffc0206e60 <default_pmm_manager+0x950>
ffffffffc0203c1a:	00002617          	auipc	a2,0x2
ffffffffc0203c1e:	54660613          	addi	a2,a2,1350 # ffffffffc0206160 <commands+0x818>
ffffffffc0203c22:	14f00593          	li	a1,335
ffffffffc0203c26:	00003517          	auipc	a0,0x3
ffffffffc0203c2a:	09250513          	addi	a0,a0,146 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc0203c2e:	861fc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203c32:	00003697          	auipc	a3,0x3
ffffffffc0203c36:	15e68693          	addi	a3,a3,350 # ffffffffc0206d90 <default_pmm_manager+0x880>
ffffffffc0203c3a:	00002617          	auipc	a2,0x2
ffffffffc0203c3e:	52660613          	addi	a2,a2,1318 # ffffffffc0206160 <commands+0x818>
ffffffffc0203c42:	13b00593          	li	a1,315
ffffffffc0203c46:	00003517          	auipc	a0,0x3
ffffffffc0203c4a:	07250513          	addi	a0,a0,114 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc0203c4e:	841fc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma2 != NULL);
ffffffffc0203c52:	00003697          	auipc	a3,0x3
ffffffffc0203c56:	19e68693          	addi	a3,a3,414 # ffffffffc0206df0 <default_pmm_manager+0x8e0>
ffffffffc0203c5a:	00002617          	auipc	a2,0x2
ffffffffc0203c5e:	50660613          	addi	a2,a2,1286 # ffffffffc0206160 <commands+0x818>
ffffffffc0203c62:	14600593          	li	a1,326
ffffffffc0203c66:	00003517          	auipc	a0,0x3
ffffffffc0203c6a:	05250513          	addi	a0,a0,82 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc0203c6e:	821fc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma1 != NULL);
ffffffffc0203c72:	00003697          	auipc	a3,0x3
ffffffffc0203c76:	16e68693          	addi	a3,a3,366 # ffffffffc0206de0 <default_pmm_manager+0x8d0>
ffffffffc0203c7a:	00002617          	auipc	a2,0x2
ffffffffc0203c7e:	4e660613          	addi	a2,a2,1254 # ffffffffc0206160 <commands+0x818>
ffffffffc0203c82:	14400593          	li	a1,324
ffffffffc0203c86:	00003517          	auipc	a0,0x3
ffffffffc0203c8a:	03250513          	addi	a0,a0,50 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc0203c8e:	801fc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma3 == NULL);
ffffffffc0203c92:	00003697          	auipc	a3,0x3
ffffffffc0203c96:	16e68693          	addi	a3,a3,366 # ffffffffc0206e00 <default_pmm_manager+0x8f0>
ffffffffc0203c9a:	00002617          	auipc	a2,0x2
ffffffffc0203c9e:	4c660613          	addi	a2,a2,1222 # ffffffffc0206160 <commands+0x818>
ffffffffc0203ca2:	14800593          	li	a1,328
ffffffffc0203ca6:	00003517          	auipc	a0,0x3
ffffffffc0203caa:	01250513          	addi	a0,a0,18 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc0203cae:	fe0fc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma5 == NULL);
ffffffffc0203cb2:	00003697          	auipc	a3,0x3
ffffffffc0203cb6:	16e68693          	addi	a3,a3,366 # ffffffffc0206e20 <default_pmm_manager+0x910>
ffffffffc0203cba:	00002617          	auipc	a2,0x2
ffffffffc0203cbe:	4a660613          	addi	a2,a2,1190 # ffffffffc0206160 <commands+0x818>
ffffffffc0203cc2:	14c00593          	li	a1,332
ffffffffc0203cc6:	00003517          	auipc	a0,0x3
ffffffffc0203cca:	ff250513          	addi	a0,a0,-14 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc0203cce:	fc0fc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma4 == NULL);
ffffffffc0203cd2:	00003697          	auipc	a3,0x3
ffffffffc0203cd6:	13e68693          	addi	a3,a3,318 # ffffffffc0206e10 <default_pmm_manager+0x900>
ffffffffc0203cda:	00002617          	auipc	a2,0x2
ffffffffc0203cde:	48660613          	addi	a2,a2,1158 # ffffffffc0206160 <commands+0x818>
ffffffffc0203ce2:	14a00593          	li	a1,330
ffffffffc0203ce6:	00003517          	auipc	a0,0x3
ffffffffc0203cea:	fd250513          	addi	a0,a0,-46 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
ffffffffc0203cee:	fa0fc0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(mm != NULL);
ffffffffc0203cf2:	00003697          	auipc	a3,0x3
ffffffffc0203cf6:	04e68693          	addi	a3,a3,78 # ffffffffc0206d40 <default_pmm_manager+0x830>
ffffffffc0203cfa:	00002617          	auipc	a2,0x2
ffffffffc0203cfe:	46660613          	addi	a2,a2,1126 # ffffffffc0206160 <commands+0x818>
ffffffffc0203d02:	12400593          	li	a1,292
ffffffffc0203d06:	00003517          	auipc	a0,0x3
ffffffffc0203d0a:	fb250513          	addi	a0,a0,-78 # ffffffffc0206cb8 <default_pmm_manager+0x7a8>
...
ffffffffc0203da8:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0203daa:	63e000ef          	jal	ra,ffffffffc02043e8 <do_exit>
...
ffffffffc0203dbc:	842a                	mv	s0,a0
    if (proc != NULL)
ffffffffc0203dbe:	c929                	beqz	a0,ffffffffc0203e10 <alloc_proc+0x62>
...
ffffffffc0203dca:	4581                	li	a1,0
        proc->runs = 0;
ffffffffc0203dcc:	00052423          	sw	zero,8(a0) # ffffffffc8000008 <end+0x7d5585c>
        proc->kstack = 0;
...
ffffffffc0203de4:	0d1010ef          	jal	ra,ffffffffc02056b4 <memset>
        proc->tf = NULL;
...
ffffffffc0203de8:	4641                	li	a2,16
        proc->tf = NULL;
ffffffffc0203dea:	0a043023          	sd	zero,160(s0)
        proc->pgdir = 0;  // 实验5修改：改为NULL，后续为每个进程创建独立的页表
ffffffffc0203dee:	0a043423          	sd	zero,168(s0)
        proc->flags = 0;
ffffffffc0203df2:	0a042823          	sw	zero,176(s0)
        memset(proc->name, 0, PROC_NAME_LEN + 1);
ffffffffc0203df6:	4581                	li	a1,0
ffffffffc0203df8:	0b440513          	addi	a0,s0,180
ffffffffc0203dfc:	0b9010ef          	jal	ra,ffffffffc02056b4 <memset>
        /*
...
ffffffffc0203e00:	0e042623          	sw	zero,236(s0)
        proc->cptr = NULL;           // 子进程指针
ffffffffc0203e04:	0e043823          	sd	zero,240(s0)
        proc->yptr = NULL;           // 弟弟进程指针  
ffffffffc0203e08:	0e043c23          	sd	zero,248(s0)
        proc->optr = NULL;           // 哥哥进程指针
ffffffffc0203e0c:	10043023          	sd	zero,256(s0)
    }
    return proc;
}
ffffffffc0203e10:	60a2                	ld	ra,8(sp)
ffffffffc0203e12:	8522                	mv	a0,s0
ffffffffc0203e14:	6402                	ld	s0,0(sp)
ffffffffc0203e16:	0141                	addi	sp,sp,16
ffffffffc0203e18:	8082                	ret

ffffffffc0203e1a <forkret>:
...
{
    forkrets(current->tf);
ffffffffc0203e1a:	000a7797          	auipc	a5,0xa7
ffffffffc0203e1e:	9767b783          	ld	a5,-1674(a5) # ffffffffc02aa790 <current>
ffffffffc0203e22:	73c8                	ld	a0,160(a5)
ffffffffc0203e24:	8eafd06f          	j	ffffffffc0200f0e <forkrets>

ffffffffc0203e28 <user_main>:
...
ffffffffc0203e2c:	9687b783          	ld	a5,-1688(a5) # ffffffffc02aa790 <current>
ffffffffc0203e30:	43cc                	lw	a1,4(a5)
{
ffffffffc0203e32:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0203e34:	00003617          	auipc	a2,0x3
ffffffffc0203e38:	0e460613          	addi	a2,a2,228 # ffffffffc0206f18 <default_pmm_manager+0xa08>
ffffffffc0203e3c:	00003517          	auipc	a0,0x3
ffffffffc0203e40:	0ec50513          	addi	a0,a0,236 # ffffffffc0206f28 <default_pmm_manager+0xa18>
{
ffffffffc0203e44:	fc06                	sd	ra,56(sp)
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0203e46:	b4efc0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc0203e4a:	3fe07797          	auipc	a5,0x3fe07
ffffffffc0203e4e:	b1e78793          	addi	a5,a5,-1250 # a968 <_binary_obj___user_forktest_out_size>
ffffffffc0203e52:	e43e                	sd	a5,8(sp)
ffffffffc0203e54:	00003517          	auipc	a0,0x3
ffffffffc0203e58:	0c450513          	addi	a0,a0,196 # ffffffffc0206f18 <default_pmm_manager+0xa08>
ffffffffc0203e5c:	00046797          	auipc	a5,0x46
ffffffffc0203e60:	8c478793          	addi	a5,a5,-1852 # ffffffffc0249720 <_binary_obj___user_forktest_out_start>
ffffffffc0203e64:	f03e                	sd	a5,32(sp)
ffffffffc0203e66:	f42a                	sd	a0,40(sp)
    int64_t ret = 0, len = strlen(name);
ffffffffc0203e68:	e802                	sd	zero,16(sp)
ffffffffc0203e6a:	7a8010ef          	jal	ra,ffffffffc0205612 <strlen>
ffffffffc0203e6e:	ec2a                	sd	a0,24(sp)
    asm volatile(
ffffffffc0203e70:	4511                	li	a0,4
ffffffffc0203e72:	55a2                	lw	a1,40(sp)
ffffffffc0203e74:	4662                	lw	a2,24(sp)
ffffffffc0203e76:	5682                	lw	a3,32(sp)
ffffffffc0203e78:	4722                	lw	a4,8(sp)
ffffffffc0203e7a:	48a9                	li	a7,10
ffffffffc0203e7c:	9002                	ebreak
ffffffffc0203e7e:	c82a                	sw	a0,16(sp)
    cprintf("ret = %d\n", ret);
ffffffffc0203e80:	65c2                	ld	a1,16(sp)
ffffffffc0203e82:	00003517          	auipc	a0,0x3
ffffffffc0203e86:	0ce50513          	addi	a0,a0,206 # ffffffffc0206f50 <default_pmm_manager+0xa40>
ffffffffc0203e8a:	b0afc0ef          	jal	ra,ffffffffc0200194 <cprintf>
#else
    KERNEL_EXECVE(exit);
#endif
    panic("user_main execve failed.\n");
ffffffffc0203e8e:	00003617          	auipc	a2,0x3
ffffffffc0203e92:	0d260613          	addi	a2,a2,210 # ffffffffc0206f60 <default_pmm_manager+0xa50>
ffffffffc0203e96:	3d200593          	li	a1,978
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	0e650513          	addi	a0,a0,230 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0203ea2:	decfc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0203ea6 <put_pgdir>:
    return pa2page(PADDR(kva));
ffffffffc0203ea6:	6d14                	ld	a3,24(a0)
{
ffffffffc0203ea8:	1141                	addi	sp,sp,-16
ffffffffc0203eaa:	e406                	sd	ra,8(sp)
ffffffffc0203eac:	c02007b7          	lui	a5,0xc0200
ffffffffc0203eb0:	02f6ee63          	bltu	a3,a5,ffffffffc0203eec <put_pgdir+0x46>
ffffffffc0203eb4:	000a7517          	auipc	a0,0xa7
ffffffffc0203eb8:	8d453503          	ld	a0,-1836(a0) # ffffffffc02aa788 <va_pa_offset>
ffffffffc0203ebc:	8e89                	sub	a3,a3,a0
    if (PPN(pa) >= npage)
ffffffffc0203ebe:	82b1                	srli	a3,a3,0xc
ffffffffc0203ec0:	000a7797          	auipc	a5,0xa7
ffffffffc0203ec4:	8b07b783          	ld	a5,-1872(a5) # ffffffffc02aa770 <npage>
ffffffffc0203ec8:	02f6fe63          	bgeu	a3,a5,ffffffffc0203f04 <put_pgdir+0x5e>
    return &pages[PPN(pa) - nbase];
ffffffffc0203ecc:	00004517          	auipc	a0,0x4
ffffffffc0203ed0:	96c53503          	ld	a0,-1684(a0) # ffffffffc0207838 <nbase>
}
ffffffffc0203ed4:	60a2                	ld	ra,8(sp)
ffffffffc0203ed6:	8e89                	sub	a3,a3,a0
ffffffffc0203ed8:	069a                	slli	a3,a3,0x6
    free_page(kva2page(mm->pgdir));
ffffffffc0203eda:	000a7517          	auipc	a0,0xa7
ffffffffc0203ede:	89e53503          	ld	a0,-1890(a0) # ffffffffc02aa778 <pages>
ffffffffc0203ee2:	4585                	li	a1,1
ffffffffc0203ee4:	9536                	add	a0,a0,a3
}
ffffffffc0203ee6:	0141                	addi	sp,sp,16
    free_page(kva2page(mm->pgdir));
ffffffffc0203ee8:	fcffd06f          	j	ffffffffc0201eb6 <free_pages>
    return pa2page(PADDR(kva));
ffffffffc0203eec:	00002617          	auipc	a2,0x2
ffffffffc0203ef0:	70460613          	addi	a2,a2,1796 # ffffffffc02065f0 <default_pmm_manager+0xe0>
ffffffffc0203ef4:	07700593          	li	a1,119
ffffffffc0203ef8:	00002517          	auipc	a0,0x2
ffffffffc0203efc:	67850513          	addi	a0,a0,1656 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc0203f00:	d8efc0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f04:	00002617          	auipc	a2,0x2
ffffffffc0203f08:	71460613          	addi	a2,a2,1812 # ffffffffc0206618 <default_pmm_manager+0x108>
ffffffffc0203f0c:	06900593          	li	a1,105
ffffffffc0203f10:	00002517          	auipc	a0,0x2
ffffffffc0203f14:	66050513          	addi	a0,a0,1632 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc0203f18:	d76fc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0203f1c <proc_run>:
{
ffffffffc0203f1c:	7179                	addi	sp,sp,-48
ffffffffc0203f1e:	ec4a                	sd	s2,24(sp)
    if (proc != current)
ffffffffc0203f20:	000a7917          	auipc	s2,0xa7
ffffffffc0203f24:	87090913          	addi	s2,s2,-1936 # ffffffffc02aa790 <current>
{
ffffffffc0203f28:	f026                	sd	s1,32(sp)
    if (proc != current)
ffffffffc0203f2a:	00093483          	ld	s1,0(s2)
{
ffffffffc0203f2e:	f406                	sd	ra,40(sp)
ffffffffc0203f30:	e84e                	sd	s3,16(sp)
    if (proc != current)
ffffffffc0203f32:	02a48963          	beq	s1,a0,ffffffffc0203f64 <proc_run+0x48>
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0203f36:	100027f3          	csrr	a5,sstatus
ffffffffc0203f3a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0203f3c:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0203f3e:	e7a9                	bnez	a5,ffffffffc0203f88 <proc_run+0x6c>
            if (proc->pgdir != 0) {
ffffffffc0203f40:	755c                	ld	a5,168(a0)
            current = proc;
ffffffffc0203f42:	00a93023          	sd	a0,0(s2)
            if (proc->pgdir != 0) {
ffffffffc0203f46:	c78d                	beqz	a5,ffffffffc0203f70 <proc_run+0x54>
...
ffffffffc0203f4e:	8fd9                	or	a5,a5,a4
ffffffffc0203f50:	18079073          	csrw	satp,a5
            switch_to(&(prev->context), &(next->context));
ffffffffc0203f54:	03050593          	addi	a1,a0,48
ffffffffc0203f58:	03048513          	addi	a0,s1,48
ffffffffc0203f5c:	05c010ef          	jal	ra,ffffffffc0204fb8 <switch_to>
    if (flag)
ffffffffc0203f60:	00099d63          	bnez	s3,ffffffffc0203f7a <proc_run+0x5e>
}
ffffffffc0203f64:	70a2                	ld	ra,40(sp)
ffffffffc0203f66:	7482                	ld	s1,32(sp)
ffffffffc0203f68:	6962                	ld	s2,24(sp)
ffffffffc0203f6a:	69c2                	ld	s3,16(sp)
ffffffffc0203f6c:	6145                	addi	sp,sp,48
ffffffffc0203f6e:	8082                	ret
ffffffffc0203f70:	000a6797          	auipc	a5,0xa6
ffffffffc0203f74:	7f07b783          	ld	a5,2032(a5) # ffffffffc02aa760 <boot_pgdir_pa>
ffffffffc0203f78:	bfc1                	j	ffffffffc0203f48 <proc_run+0x2c>
ffffffffc0203f7a:	70a2                	ld	ra,40(sp)
ffffffffc0203f7c:	7482                	ld	s1,32(sp)
ffffffffc0203f7e:	6962                	ld	s2,24(sp)
ffffffffc0203f80:	69c2                	ld	s3,16(sp)
ffffffffc0203f82:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0203f84:	a2bfc06f          	j	ffffffffc02009ae <intr_enable>
ffffffffc0203f88:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0203f8a:	a2bfc0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        return 1;
ffffffffc0203f8e:	6522                	ld	a0,8(sp)
ffffffffc0203f90:	4985                	li	s3,1
ffffffffc0203f92:	b77d                	j	ffffffffc0203f40 <proc_run+0x24>

ffffffffc0203f94 <do_fork>:
{
ffffffffc0203f94:	7119                	addi	sp,sp,-128
ffffffffc0203f96:	f0ca                	sd	s2,96(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc0203f98:	000a7917          	auipc	s2,0xa7
ffffffffc0203f9c:	81090913          	addi	s2,s2,-2032 # ffffffffc02aa7a8 <nr_process>
ffffffffc0203fa0:	00092703          	lw	a4,0(s2)
{
ffffffffc0203fa4:	fc86                	sd	ra,120(sp)
ffffffffc0203fa6:	f8a2                	sd	s0,112(sp)
ffffffffc0203fa8:	f4a6                	sd	s1,104(sp)
ffffffffc0203faa:	ecce                	sd	s3,88(sp)
...
ffffffffc0203fb8:	f06a                	sd	s10,32(sp)
ffffffffc0203fba:	ec6e                	sd	s11,24(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc0203fbc:	6785                	lui	a5,0x1
ffffffffc0203fbe:	32f75b63          	bge	a4,a5,ffffffffc02042f4 <do_fork+0x360>
ffffffffc0203fc2:	8a2a                	mv	s4,a0
ffffffffc0203fc4:	89ae                	mv	s3,a1
ffffffffc0203fc6:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL) {
ffffffffc0203fc8:	de7ff0ef          	jal	ra,ffffffffc0203dae <alloc_proc>
ffffffffc0203fcc:	84aa                	mv	s1,a0
ffffffffc0203fce:	30050463          	beqz	a0,ffffffffc02042d6 <do_fork+0x342>
    proc->parent = current;
ffffffffc0203fd2:	000a6c17          	auipc	s8,0xa6
ffffffffc0203fd6:	7bec0c13          	addi	s8,s8,1982 # ffffffffc02aa790 <current>
ffffffffc0203fda:	000c3783          	ld	a5,0(s8)
    assert(current->wait_state == 0);
ffffffffc0203fde:	0ec7a703          	lw	a4,236(a5) # 10ec <_binary_obj___user_faultread_out_size-0x8ac4>
    proc->parent = current;
ffffffffc0203fe2:	f11c                	sd	a5,32(a0)
    assert(current->wait_state == 0);
ffffffffc0203fe4:	30071d63          	bnez	a4,ffffffffc02042fe <do_fork+0x36a>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0203fe8:	4509                	li	a0,2
ffffffffc0203fea:	e8ffd0ef          	jal	ra,ffffffffc0201e78 <alloc_pages>
    if (page != NULL)
ffffffffc0203fee:	2e050163          	beqz	a0,ffffffffc02042d0 <do_fork+0x33c>
    return page - pages + nbase;
ffffffffc0203ff2:	000a6a97          	auipc	s5,0xa6
ffffffffc0203ff6:	786a8a93          	addi	s5,s5,1926 # ffffffffc02aa778 <pages>
ffffffffc0203ffa:	000ab683          	ld	a3,0(s5)
ffffffffc0203ffe:	00004b17          	auipc	s6,0x4
ffffffffc0204002:	83ab0b13          	addi	s6,s6,-1990 # ffffffffc0207838 <nbase>
ffffffffc0204006:	000b3783          	ld	a5,0(s6)
ffffffffc020400a:	40d506b3          	sub	a3,a0,a3
    return KADDR(page2pa(page));
ffffffffc020400e:	000a6b97          	auipc	s7,0xa6
ffffffffc0204012:	762b8b93          	addi	s7,s7,1890 # ffffffffc02aa770 <npage>
    return page - pages + nbase;
ffffffffc0204016:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0204018:	5dfd                	li	s11,-1
ffffffffc020401a:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc020401e:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204020:	00cddd93          	srli	s11,s11,0xc
ffffffffc0204024:	01b6f633          	and	a2,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0204028:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc020402a:	2ee67a63          	bgeu	a2,a4,ffffffffc020431e <do_fork+0x38a>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc020402e:	000c3603          	ld	a2,0(s8)
ffffffffc0204032:	000a6c17          	auipc	s8,0xa6
ffffffffc0204036:	756c0c13          	addi	s8,s8,1878 # ffffffffc02aa788 <va_pa_offset>
ffffffffc020403a:	000c3703          	ld	a4,0(s8)
ffffffffc020403e:	02863d03          	ld	s10,40(a2)
ffffffffc0204042:	e43e                	sd	a5,8(sp)
ffffffffc0204044:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204046:	e894                	sd	a3,16(s1)
    if (oldmm == NULL)
ffffffffc0204048:	020d0863          	beqz	s10,ffffffffc0204078 <do_fork+0xe4>
    if (clone_flags & CLONE_VM)
ffffffffc020404c:	100a7a13          	andi	s4,s4,256
ffffffffc0204050:	1c0a0163          	beqz	s4,ffffffffc0204212 <do_fork+0x27e>
}
...
{
    mm->mm_count += 1;
ffffffffc0204054:	030d2703          	lw	a4,48(s10)
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc0204058:	018d3783          	ld	a5,24(s10)
ffffffffc020405c:	c02006b7          	lui	a3,0xc0200
ffffffffc0204060:	2705                	addiw	a4,a4,1
ffffffffc0204062:	02ed2823          	sw	a4,48(s10)
    proc->mm = mm;
ffffffffc0204066:	03a4b423          	sd	s10,40(s1)
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc020406a:	2ed7e263          	bltu	a5,a3,ffffffffc020434e <do_fork+0x3ba>
ffffffffc020406e:	000c3703          	ld	a4,0(s8)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204072:	6894                	ld	a3,16(s1)
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc0204074:	8f99                	sub	a5,a5,a4
ffffffffc0204076:	f4dc                	sd	a5,168(s1)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204078:	6789                	lui	a5,0x2
ffffffffc020407a:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7cd0>
ffffffffc020407e:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204080:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204082:	f0d4                	sd	a3,160(s1)
    *(proc->tf) = *tf;
ffffffffc0204084:	87b6                	mv	a5,a3
ffffffffc0204086:	12040893          	addi	a7,s0,288
ffffffffc020408a:	00063803          	ld	a6,0(a2)
ffffffffc020408e:	6608                	ld	a0,8(a2)
ffffffffc0204090:	6a0c                	ld	a1,16(a2)
ffffffffc0204092:	6e18                	ld	a4,24(a2)
ffffffffc0204094:	0107b023          	sd	a6,0(a5)
ffffffffc0204098:	e788                	sd	a0,8(a5)
ffffffffc020409a:	eb8c                	sd	a1,16(a5)
ffffffffc020409c:	ef98                	sd	a4,24(a5)
ffffffffc020409e:	02060613          	addi	a2,a2,32
ffffffffc02040a2:	02078793          	addi	a5,a5,32
ffffffffc02040a6:	ff1612e3          	bne	a2,a7,ffffffffc020408a <do_fork+0xf6>
    proc->tf->gpr.a0 = 0;
ffffffffc02040aa:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x6>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02040ae:	12098f63          	beqz	s3,ffffffffc02041ec <do_fork+0x258>
ffffffffc02040b2:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02040b6:	00000797          	auipc	a5,0x0
ffffffffc02040ba:	d6478793          	addi	a5,a5,-668 # ffffffffc0203e1a <forkret>
ffffffffc02040be:	f89c                	sd	a5,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc02040c0:	fc94                	sd	a3,56(s1)
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02040c2:	100027f3          	csrr	a5,sstatus
ffffffffc02040c6:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02040c8:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02040ca:	14079063          	bnez	a5,ffffffffc020420a <do_fork+0x276>
    if (++last_pid >= MAX_PID)
ffffffffc02040ce:	000a2817          	auipc	a6,0xa2
ffffffffc02040d2:	23280813          	addi	a6,a6,562 # ffffffffc02a6300 <last_pid.1>
ffffffffc02040d6:	00082783          	lw	a5,0(a6)
ffffffffc02040da:	6709                	lui	a4,0x2
ffffffffc02040dc:	0017851b          	addiw	a0,a5,1
ffffffffc02040e0:	00a82023          	sw	a0,0(a6)
ffffffffc02040e4:	08e55d63          	bge	a0,a4,ffffffffc020417e <do_fork+0x1ea>
    if (last_pid >= next_safe)
ffffffffc02040e8:	000a2317          	auipc	t1,0xa2
ffffffffc02040ec:	21c30313          	addi	t1,t1,540 # ffffffffc02a6304 <next_safe.0>
ffffffffc02040f0:	00032783          	lw	a5,0(t1)
ffffffffc02040f4:	000a6417          	auipc	s0,0xa6
ffffffffc02040f8:	62c40413          	addi	s0,s0,1580 # ffffffffc02aa720 <proc_list>
ffffffffc02040fc:	08f55963          	bge	a0,a5,ffffffffc020418e <do_fork+0x1fa>
        proc->pid = get_pid();
ffffffffc0204100:	c0c8                	sw	a0,4(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204102:	45a9                	li	a1,10
ffffffffc0204104:	2501                	sext.w	a0,a0
ffffffffc0204106:	108010ef          	jal	ra,ffffffffc020520e <hash32>
ffffffffc020410a:	02051793          	slli	a5,a0,0x20
ffffffffc020410e:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204112:	000a2797          	auipc	a5,0xa2
ffffffffc0204116:	60e78793          	addi	a5,a5,1550 # ffffffffc02a6720 <hash_list>
ffffffffc020411a:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc020411c:	650c                	ld	a1,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL)
ffffffffc020411e:	7094                	ld	a3,32(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204120:	0d848793          	addi	a5,s1,216
    prev->next = next->prev = elm;
ffffffffc0204124:	e19c                	sd	a5,0(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc0204126:	6410                	ld	a2,8(s0)
    prev->next = next->prev = elm;
ffffffffc0204128:	e51c                	sd	a5,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL)
ffffffffc020412a:	7af8                	ld	a4,240(a3)
    list_add(&proc_list, &(proc->list_link));
ffffffffc020412c:	0c848793          	addi	a5,s1,200
    elm->next = next;
ffffffffc0204130:	f0ec                	sd	a1,224(s1)
    elm->prev = prev;
ffffffffc0204132:	ece8                	sd	a0,216(s1)
    prev->next = next->prev = elm;
ffffffffc0204134:	e21c                	sd	a5,0(a2)
ffffffffc0204136:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc0204138:	e8f0                	sd	a2,208(s1)
    elm->prev = prev;
ffffffffc020413a:	e4e0                	sd	s0,200(s1)
    proc->yptr = NULL;
ffffffffc020413c:	0e04bc23          	sd	zero,248(s1)
    if ((proc->optr = proc->parent->cptr) != NULL)
ffffffffc0204140:	10e4b023          	sd	a4,256(s1)
ffffffffc0204144:	c311                	beqz	a4,ffffffffc0204148 <do_fork+0x1b4>
        proc->optr->yptr = proc;
ffffffffc0204146:	ff64                	sd	s1,248(a4)
    nr_process++;
ffffffffc0204148:	00092783          	lw	a5,0(s2)
    proc->parent->cptr = proc;
ffffffffc020414c:	fae4                	sd	s1,240(a3)
    nr_process++;
ffffffffc020414e:	2785                	addiw	a5,a5,1
ffffffffc0204150:	00f92023          	sw	a5,0(s2)
    if (flag)
ffffffffc0204154:	18099363          	bnez	s3,ffffffffc02042da <do_fork+0x346>
    wakeup_proc(proc);
ffffffffc0204158:	8526                	mv	a0,s1
ffffffffc020415a:	6c9000ef          	jal	ra,ffffffffc0205022 <wakeup_proc>
    ret = proc->pid;
ffffffffc020415e:	40c8                	lw	a0,4(s1)
}
ffffffffc0204160:	70e6                	ld	ra,120(sp)
ffffffffc0204162:	7446                	ld	s0,112(sp)
ffffffffc0204164:	74a6                	ld	s1,104(sp)
ffffffffc0204166:	7906                	ld	s2,96(sp)
ffffffffc0204168:	69e6                	ld	s3,88(sp)
ffffffffc020416a:	6a46                	ld	s4,80(sp)
ffffffffc020416c:	6aa6                	ld	s5,72(sp)
ffffffffc020416e:	6b06                	ld	s6,64(sp)
ffffffffc0204170:	7be2                	ld	s7,56(sp)
ffffffffc0204172:	7c42                	ld	s8,48(sp)
ffffffffc0204174:	7ca2                	ld	s9,40(sp)
ffffffffc0204176:	7d02                	ld	s10,32(sp)
ffffffffc0204178:	6de2                	ld	s11,24(sp)
ffffffffc020417a:	6109                	addi	sp,sp,128
ffffffffc020417c:	8082                	ret
        last_pid = 1;
ffffffffc020417e:	4785                	li	a5,1
ffffffffc0204180:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc0204184:	4505                	li	a0,1
ffffffffc0204186:	000a2317          	auipc	t1,0xa2
ffffffffc020418a:	17e30313          	addi	t1,t1,382 # ffffffffc02a6304 <next_safe.0>
    return listelm->next;
ffffffffc020418e:	000a6417          	auipc	s0,0xa6
ffffffffc0204192:	59240413          	addi	s0,s0,1426 # ffffffffc02aa720 <proc_list>
ffffffffc0204196:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc020419a:	6789                	lui	a5,0x2
ffffffffc020419c:	00f32023          	sw	a5,0(t1)
ffffffffc02041a0:	86aa                	mv	a3,a0
ffffffffc02041a2:	4581                	li	a1,0
        while ((le = list_next(le)) != list)
ffffffffc02041a4:	6e89                	lui	t4,0x2
ffffffffc02041a6:	148e0263          	beq	t3,s0,ffffffffc02042ea <do_fork+0x356>
ffffffffc02041aa:	88ae                	mv	a7,a1
ffffffffc02041ac:	87f2                	mv	a5,t3
ffffffffc02041ae:	6609                	lui	a2,0x2
ffffffffc02041b0:	a811                	j	ffffffffc02041c4 <do_fork+0x230>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc02041b2:	00e6d663          	bge	a3,a4,ffffffffc02041be <do_fork+0x22a>
ffffffffc02041b6:	00c75463          	bge	a4,a2,ffffffffc02041be <do_fork+0x22a>
ffffffffc02041ba:	863a                	mv	a2,a4
ffffffffc02041bc:	4885                	li	a7,1
ffffffffc02041be:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc02041c0:	00878d63          	beq	a5,s0,ffffffffc02041da <do_fork+0x246>
            if (proc->pid == last_pid)
ffffffffc02041c4:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7c74>
ffffffffc02041c8:	fed715e3          	bne	a4,a3,ffffffffc02041b2 <do_fork+0x21e>
                if (++last_pid >= next_safe)
ffffffffc02041cc:	2685                	addiw	a3,a3,1
ffffffffc02041ce:	10c6d963          	bge	a3,a2,ffffffffc02042e0 <do_fork+0x34c>
ffffffffc02041d2:	679c                	ld	a5,8(a5)
ffffffffc02041d4:	4585                	li	a1,1
        while ((le = list_next(le)) != list)
ffffffffc02041d6:	fe8797e3          	bne	a5,s0,ffffffffc02041c4 <do_fork+0x230>
ffffffffc02041da:	c581                	beqz	a1,ffffffffc02041e2 <do_fork+0x24e>
ffffffffc02041dc:	00d82023          	sw	a3,0(a6)
ffffffffc02041e0:	8536                	mv	a0,a3
ffffffffc02041e2:	f0088fe3          	beqz	a7,ffffffffc0204100 <do_fork+0x16c>
ffffffffc02041e6:	00c32023          	sw	a2,0(t1)
ffffffffc02041ea:	bf19                	j	ffffffffc0204100 <do_fork+0x16c>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02041ec:	89b6                	mv	s3,a3
ffffffffc02041ee:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02041f2:	00000797          	auipc	a5,0x0
ffffffffc02041f6:	c2878793          	addi	a5,a5,-984 # ffffffffc0203e1a <forkret>
ffffffffc02041fa:	f89c                	sd	a5,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc02041fc:	fc94                	sd	a3,56(s1)
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02041fe:	100027f3          	csrr	a5,sstatus
ffffffffc0204202:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204204:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0204206:	ec0784e3          	beqz	a5,ffffffffc02040ce <do_fork+0x13a>
        intr_disable();
ffffffffc020420a:	faafc0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        return 1;
ffffffffc020420e:	4985                	li	s3,1
ffffffffc0204210:	bd7d                	j	ffffffffc02040ce <do_fork+0x13a>
    if ((mm = mm_create()) == NULL)
ffffffffc0204212:	c8aff0ef          	jal	ra,ffffffffc020369c <mm_create>
ffffffffc0204216:	8caa                	mv	s9,a0
ffffffffc0204218:	c541                	beqz	a0,ffffffffc02042a0 <do_fork+0x30c>
    if ((page = alloc_page()) == NULL)
ffffffffc020421a:	4505                	li	a0,1
ffffffffc020421c:	c5dfd0ef          	jal	ra,ffffffffc0201e78 <alloc_pages>
ffffffffc0204220:	cd2d                	beqz	a0,ffffffffc020429a <do_fork+0x306>
    return page - pages + nbase;
ffffffffc0204222:	000ab683          	ld	a3,0(s5)
ffffffffc0204226:	67a2                	ld	a5,8(sp)
    return KADDR(page2pa(page));
ffffffffc0204228:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc020422c:	40d506b3          	sub	a3,a0,a3
ffffffffc0204230:	8699                	srai	a3,a3,0x6
ffffffffc0204232:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204234:	01b6fdb3          	and	s11,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0204238:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc020423a:	0eedf263          	bgeu	s11,a4,ffffffffc020431e <do_fork+0x38a>
ffffffffc020423e:	000c3a03          	ld	s4,0(s8)
    memcpy(pgdir, boot_pgdir_va, PGSIZE);
ffffffffc0204242:	6605                	lui	a2,0x1
ffffffffc0204244:	000a6597          	auipc	a1,0xa6
ffffffffc0204248:	5245b583          	ld	a1,1316(a1) # ffffffffc02aa768 <boot_pgdir_va>
ffffffffc020424c:	9a36                	add	s4,s4,a3
ffffffffc020424e:	8552                	mv	a0,s4
ffffffffc0204250:	476010ef          	jal	ra,ffffffffc02056c6 <memcpy>
static inline void
lock_mm(struct mm_struct *mm)
{
    ...
    {
        lock(&(mm->mm_lock));
ffffffffc0204254:	038d0d93          	addi	s11,s10,56
    mm->pgdir = pgdir;
ffffffffc0204258:	014cbc23          	sd	s4,24(s9)
...
ffffffffc020425c:	4785                	li	a5,1
ffffffffc020425e:	40fdb7af          	amoor.d	a5,a5,(s11)
}
...
{
    while (!try_lock(lock))
ffffffffc0204262:	8b85                	andi	a5,a5,1
ffffffffc0204264:	4a05                	li	s4,1
ffffffffc0204266:	c799                	beqz	a5,ffffffffc0204274 <do_fork+0x2e0>
    {
        schedule();
ffffffffc0204268:	63b000ef          	jal	ra,ffffffffc02050a2 <schedule>
ffffffffc020426c:	414db7af          	amoor.d	a5,s4,(s11)
    while (!try_lock(lock))
ffffffffc0204270:	8b85                	andi	a5,a5,1
ffffffffc0204272:	fbfd                	bnez	a5,ffffffffc0204268 <do_fork+0x2d4>
        ret = dup_mmap(mm, oldmm);
ffffffffc0204274:	85ea                	mv	a1,s10
ffffffffc0204276:	8566                	mv	a0,s9
ffffffffc0204278:	e66ff0ef          	jal	ra,ffffffffc02038de <dup_mmap>
...
ffffffffc020427c:	57f9                	li	a5,-2
ffffffffc020427e:	60fdb7af          	amoand.d	a5,a5,(s11)
ffffffffc0204282:	8b85                	andi	a5,a5,1
}
...
ffffffffc0204284:	0e078e63          	beqz	a5,ffffffffc0204380 <do_fork+0x3ec>
good_mm:
ffffffffc0204288:	8d66                	mv	s10,s9
    if (ret != 0)
ffffffffc020428a:	dc0505e3          	beqz	a0,ffffffffc0204054 <do_fork+0xc0>
    exit_mmap(mm);
ffffffffc020428e:	8566                	mv	a0,s9
ffffffffc0204290:	ee8ff0ef          	jal	ra,ffffffffc0203978 <exit_mmap>
    put_pgdir(mm);
ffffffffc0204294:	8566                	mv	a0,s9
ffffffffc0204296:	c11ff0ef          	jal	ra,ffffffffc0203ea6 <put_pgdir>
    mm_destroy(mm);
ffffffffc020429a:	8566                	mv	a0,s9
ffffffffc020429c:	d40ff0ef          	jal	ra,ffffffffc02037dc <mm_destroy>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02042a0:	6894                	ld	a3,16(s1)
    return pa2page(PADDR(kva));
ffffffffc02042a2:	c02007b7          	lui	a5,0xc0200
ffffffffc02042a6:	0cf6e163          	bltu	a3,a5,ffffffffc0204368 <do_fork+0x3d4>
ffffffffc02042aa:	000c3783          	ld	a5,0(s8)
    if (PPN(pa) >= npage)
ffffffffc02042ae:	000bb703          	ld	a4,0(s7)
    return pa2page(PADDR(kva));
ffffffffc02042b2:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage)
ffffffffc02042b6:	83b1                	srli	a5,a5,0xc
ffffffffc02042b8:	06e7ff63          	bgeu	a5,a4,ffffffffc0204336 <do_fork+0x3a2>
    return &pages[PPN(pa) - nbase];
ffffffffc02042bc:	000b3703          	ld	a4,0(s6)
ffffffffc02042c0:	000ab503          	ld	a0,0(s5)
ffffffffc02042c4:	4589                	li	a1,2
ffffffffc02042c6:	8f99                	sub	a5,a5,a4
ffffffffc02042c8:	079a                	slli	a5,a5,0x6
ffffffffc02042ca:	953e                	add	a0,a0,a5
ffffffffc02042cc:	bebfd0ef          	jal	ra,ffffffffc0201eb6 <free_pages>
    kfree(proc);
ffffffffc02042d0:	8526                	mv	a0,s1
ffffffffc02042d2:	a79fd0ef          	jal	ra,ffffffffc0201d4a <kfree>
    ret = -E_NO_MEM;
ffffffffc02042d6:	5571                	li	a0,-4
    return ret;
ffffffffc02042d8:	b561                	j	ffffffffc0204160 <do_fork+0x1cc>
        intr_enable();
ffffffffc02042da:	ed4fc0ef          	jal	ra,ffffffffc02009ae <intr_enable>
ffffffffc02042de:	bdad                	j	ffffffffc0204158 <do_fork+0x1c4>
                    if (last_pid >= MAX_PID)
ffffffffc02042e0:	01d6c363          	blt	a3,t4,ffffffffc02042e6 <do_fork+0x352>
                        last_pid = 1;
ffffffffc02042e4:	4685                	li	a3,1
                    goto repeat;
ffffffffc02042e6:	4585                	li	a1,1
ffffffffc02042e8:	bd7d                	j	ffffffffc02041a6 <do_fork+0x212>
ffffffffc02042ea:	c599                	beqz	a1,ffffffffc02042f8 <do_fork+0x364>
ffffffffc02042ec:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02042f0:	8536                	mv	a0,a3
ffffffffc02042f2:	b539                	j	ffffffffc0204100 <do_fork+0x16c>
    int ret = -E_NO_FREE_PROC;
ffffffffc02042f4:	556d                	li	a0,-5
ffffffffc02042f6:	b5ad                	j	ffffffffc0204160 <do_fork+0x1cc>
    return last_pid;
ffffffffc02042f8:	00082503          	lw	a0,0(a6)
ffffffffc02042fc:	b511                	j	ffffffffc0204100 <do_fork+0x16c>
    assert(current->wait_state == 0);
ffffffffc02042fe:	00003697          	auipc	a3,0x3
ffffffffc0204302:	c9a68693          	addi	a3,a3,-870 # ffffffffc0206f98 <default_pmm_manager+0xa88>
ffffffffc0204306:	00002617          	auipc	a2,0x2
ffffffffc020430a:	e5a60613          	addi	a2,a2,-422 # ffffffffc0206160 <commands+0x818>
ffffffffc020430e:	1e900593          	li	a1,489
ffffffffc0204312:	00003517          	auipc	a0,0x3
ffffffffc0204316:	c6e50513          	addi	a0,a0,-914 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc020431a:	974fc0ef          	jal	ra,ffffffffc020048e <__panic>
    return KADDR(page2pa(page));
ffffffffc020431e:	00002617          	auipc	a2,0x2
ffffffffc0204322:	22a60613          	addi	a2,a2,554 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc0204326:	07100593          	li	a1,113
ffffffffc020432a:	00002517          	auipc	a0,0x2
ffffffffc020432e:	24650513          	addi	a0,a0,582 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc0204332:	95cfc0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204336:	00002617          	auipc	a2,0x2
ffffffffc020433a:	2e260613          	addi	a2,a2,738 # ffffffffc0206618 <default_pmm_manager+0x108>
ffffffffc020433e:	06900593          	li	a1,105
ffffffffc0204342:	00002517          	auipc	a0,0x2
ffffffffc0204346:	22e50513          	addi	a0,a0,558 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc020434a:	944fc0ef          	jal	ra,ffffffffc020048e <__panic>
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc020434e:	86be                	mv	a3,a5
ffffffffc0204350:	00002617          	auipc	a2,0x2
ffffffffc0204354:	2a060613          	addi	a2,a2,672 # ffffffffc02065f0 <default_pmm_manager+0xe0>
ffffffffc0204358:	19600593          	li	a1,406
ffffffffc020435c:	00003517          	auipc	a0,0x3
ffffffffc0204360:	c2450513          	addi	a0,a0,-988 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204364:	92afc0ef          	jal	ra,ffffffffc020048e <__panic>
    return pa2page(PADDR(kva));
ffffffffc0204368:	00002617          	auipc	a2,0x2
ffffffffc020436c:	28860613          	addi	a2,a2,648 # ffffffffc02065f0 <default_pmm_manager+0xe0>
ffffffffc0204370:	07700593          	li	a1,119
ffffffffc0204374:	00002517          	auipc	a0,0x2
ffffffffc0204378:	1fc50513          	addi	a0,a0,508 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc020437c:	912fc0ef          	jal	ra,ffffffffc020048e <__panic>
    {
        panic("Unlock failed.\n");
ffffffffc0204380:	00003617          	auipc	a2,0x3
ffffffffc0204384:	c3860613          	addi	a2,a2,-968 # ffffffffc0206fb8 <default_pmm_manager+0xaa8>
ffffffffc0204388:	03f00593          	li	a1,63
ffffffffc020438c:	00003517          	auipc	a0,0x3
ffffffffc0204390:	c3c50513          	addi	a0,a0,-964 # ffffffffc0206fc8 <default_pmm_manager+0xab8>
ffffffffc0204394:	8fafc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0204398 <kernel_thread>:
{
ffffffffc0204398:	7129                	addi	sp,sp,-320
ffffffffc020439a:	fa22                	sd	s0,304(sp)
ffffffffc020439c:	f626                	sd	s1,296(sp)
ffffffffc020439e:	f24a                	sd	s2,288(sp)
ffffffffc02043a0:	84ae                	mv	s1,a1
ffffffffc02043a2:	892a                	mv	s2,a0
ffffffffc02043a4:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02043a6:	4581                	li	a1,0
ffffffffc02043a8:	12000613          	li	a2,288
ffffffffc02043ac:	850a                	mv	a0,sp
{
ffffffffc02043ae:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02043b0:	304010ef          	jal	ra,ffffffffc02056b4 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02043b4:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02043b6:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02043b8:	100027f3          	csrr	a5,sstatus
ffffffffc02043bc:	edd7f793          	andi	a5,a5,-291
ffffffffc02043c0:	1207e793          	ori	a5,a5,288
ffffffffc02043c4:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02043c6:	860a                	mv	a2,sp
ffffffffc02043c8:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02043cc:	00000797          	auipc	a5,0x0
ffffffffc02043d0:	9da78793          	addi	a5,a5,-1574 # ffffffffc0203da6 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02043d4:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02043d6:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02043d8:	bbdff0ef          	jal	ra,ffffffffc0203f94 <do_fork>
}
ffffffffc02043dc:	70f2                	ld	ra,312(sp)
ffffffffc02043de:	7452                	ld	s0,304(sp)
ffffffffc02043e0:	74b2                	ld	s1,296(sp)
ffffffffc02043e2:	7912                	ld	s2,288(sp)
ffffffffc02043e4:	6131                	addi	sp,sp,320
ffffffffc02043e6:	8082                	ret

ffffffffc02043e8 <do_exit>:
{
ffffffffc02043e8:	7179                	addi	sp,sp,-48
ffffffffc02043ea:	f022                	sd	s0,32(sp)
    if (current == idleproc)
ffffffffc02043ec:	000a6417          	auipc	s0,0xa6
ffffffffc02043f0:	3a440413          	addi	s0,s0,932 # ffffffffc02aa790 <current>
ffffffffc02043f4:	601c                	ld	a5,0(s0)
{
ffffffffc02043f6:	f406                	sd	ra,40(sp)
ffffffffc02043f8:	ec26                	sd	s1,24(sp)
ffffffffc02043fa:	e84a                	sd	s2,16(sp)
ffffffffc02043fc:	e44e                	sd	s3,8(sp)
ffffffffc02043fe:	e052                	sd	s4,0(sp)
    if (current == idleproc)
ffffffffc0204400:	000a6717          	auipc	a4,0xa6
ffffffffc0204404:	39873703          	ld	a4,920(a4) # ffffffffc02aa798 <idleproc>
ffffffffc0204408:	0ce78c63          	beq	a5,a4,ffffffffc02044e0 <do_exit+0xf8>
    if (current == initproc)
ffffffffc020440c:	000a6497          	auipc	s1,0xa6
ffffffffc0204410:	39448493          	addi	s1,s1,916 # ffffffffc02aa7a0 <initproc>
ffffffffc0204414:	6098                	ld	a4,0(s1)
ffffffffc0204416:	0ee78b63          	beq	a5,a4,ffffffffc020450c <do_exit+0x124>
    struct mm_struct *mm = current->mm;
ffffffffc020441a:	0287b983          	ld	s3,40(a5)
ffffffffc020441e:	892a                	mv	s2,a0
    if (mm != NULL)
ffffffffc0204420:	02098663          	beqz	s3,ffffffffc020444c <do_exit+0x64>
ffffffffc0204424:	000a6797          	auipc	a5,0xa6
ffffffffc0204428:	33c7b783          	ld	a5,828(a5) # ffffffffc02aa760 <boot_pgdir_pa>
ffffffffc020442c:	577d                	li	a4,-1
ffffffffc020442e:	177e                	slli	a4,a4,0x3f
ffffffffc0204430:	83b1                	srli	a5,a5,0xc
ffffffffc0204432:	8fd9                	or	a5,a5,a4
ffffffffc0204434:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc0204438:	0309a783          	lw	a5,48(s3)
ffffffffc020443c:	fff7871b          	addiw	a4,a5,-1
ffffffffc0204440:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0)
ffffffffc0204444:	cb55                	beqz	a4,ffffffffc02044f8 <do_exit+0x110>
        current->mm = NULL;
ffffffffc0204446:	601c                	ld	a5,0(s0)
ffffffffc0204448:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc020444c:	601c                	ld	a5,0(s0)
ffffffffc020444e:	470d                	li	a4,3
ffffffffc0204450:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc0204452:	0f27a423          	sw	s2,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0204456:	100027f3          	csrr	a5,sstatus
ffffffffc020445a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020445c:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc020445e:	e3f9                	bnez	a5,ffffffffc0204524 <do_exit+0x13c>
        proc = current->parent;
ffffffffc0204460:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD)
ffffffffc0204462:	800007b7          	lui	a5,0x80000
ffffffffc0204466:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc0204468:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD)
ffffffffc020446a:	0ec52703          	lw	a4,236(a0)
ffffffffc020446e:	0af70f63          	beq	a4,a5,ffffffffc020452c <do_exit+0x144>
        while (current->cptr != NULL)
ffffffffc0204472:	6018                	ld	a4,0(s0)
ffffffffc0204474:	7b7c                	ld	a5,240(a4)
ffffffffc0204476:	c3a1                	beqz	a5,ffffffffc02044b6 <do_exit+0xce>
                if (initproc->wait_state == WT_CHILD)
ffffffffc0204478:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE)
ffffffffc020447c:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD)
ffffffffc020447e:	0985                	addi	s3,s3,1
ffffffffc0204480:	a021                	j	ffffffffc0204488 <do_exit+0xa0>
        while (current->cptr != NULL)
ffffffffc0204482:	6018                	ld	a4,0(s0)
ffffffffc0204484:	7b7c                	ld	a5,240(a4)
ffffffffc0204486:	cb85                	beqz	a5,ffffffffc02044b6 <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc0204488:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fd8>
            if ((proc->optr = initproc->cptr) != NULL)
ffffffffc020448c:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc020448e:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL)
ffffffffc0204490:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc0204492:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL)
ffffffffc0204496:	10e7b023          	sd	a4,256(a5)
ffffffffc020449a:	c311                	beqz	a4,ffffffffc020449e <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc020449c:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE)
ffffffffc020449e:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc02044a0:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc02044a2:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE)
ffffffffc02044a4:	fd271fe3          	bne	a4,s2,ffffffffc0204482 <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD)
ffffffffc02044a8:	0ec52783          	lw	a5,236(a0)
ffffffffc02044ac:	fd379be3          	bne	a5,s3,ffffffffc0204482 <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc02044b0:	373000ef          	jal	ra,ffffffffc0205022 <wakeup_proc>
ffffffffc02044b4:	b7f9                	j	ffffffffc0204482 <do_exit+0x9a>
    if (flag)
ffffffffc02044b6:	020a1263          	bnez	s4,ffffffffc02044da <do_exit+0xf2>
    schedule();
ffffffffc02044ba:	3e9000ef          	jal	ra,ffffffffc02050a2 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc02044be:	601c                	ld	a5,0(s0)
ffffffffc02044c0:	00003617          	auipc	a2,0x3
ffffffffc02044c4:	b4060613          	addi	a2,a2,-1216 # ffffffffc0207000 <default_pmm_manager+0xaf0>
ffffffffc02044c8:	25100593          	li	a1,593
ffffffffc02044cc:	43d4                	lw	a3,4(a5)
ffffffffc02044ce:	00003517          	auipc	a0,0x3
ffffffffc02044d2:	ab250513          	addi	a0,a0,-1358 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc02044d6:	fb9fb0ef          	jal	ra,ffffffffc020048e <__panic>
        intr_enable();
ffffffffc02044da:	cd4fc0ef          	jal	ra,ffffffffc02009ae <intr_enable>
ffffffffc02044de:	bff1                	j	ffffffffc02044ba <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc02044e0:	00003617          	auipc	a2,0x3
ffffffffc02044e4:	b0060613          	addi	a2,a2,-1280 # ffffffffc0206fe0 <default_pmm_manager+0xad0>
ffffffffc02044e8:	21d00593          	li	a1,541
ffffffffc02044ec:	00003517          	auipc	a0,0x3
ffffffffc02044f0:	a9450513          	addi	a0,a0,-1388 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc02044f4:	f9bfb0ef          	jal	ra,ffffffffc020048e <__panic>
            exit_mmap(mm);
ffffffffc02044f8:	854e                	mv	a0,s3
ffffffffc02044fa:	c7eff0ef          	jal	ra,ffffffffc0203978 <exit_mmap>
            put_pgdir(mm);
ffffffffc02044fe:	854e                	mv	a0,s3
ffffffffc0204500:	9a7ff0ef          	jal	ra,ffffffffc0203ea6 <put_pgdir>
            mm_destroy(mm);
ffffffffc0204504:	854e                	mv	a0,s3
ffffffffc0204506:	ad6ff0ef          	jal	ra,ffffffffc02037dc <mm_destroy>
ffffffffc020450a:	bf35                	j	ffffffffc0204446 <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc020450c:	00003617          	auipc	a2,0x3
ffffffffc0204510:	ae460613          	addi	a2,a2,-1308 # ffffffffc0206ff0 <default_pmm_manager+0xae0>
ffffffffc0204514:	22100593          	li	a1,545
ffffffffc0204518:	00003517          	auipc	a0,0x3
ffffffffc020451c:	a6850513          	addi	a0,a0,-1432 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204520:	f6ffb0ef          	jal	ra,ffffffffc020048e <__panic>
        intr_disable();
ffffffffc0204524:	c90fc0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        return 1;
ffffffffc0204528:	4a05                	li	s4,1
ffffffffc020452a:	bf1d                	j	ffffffffc0204460 <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc020452c:	2f7000ef          	jal	ra,ffffffffc0205022 <wakeup_proc>
ffffffffc0204530:	b789                	j	ffffffffc0204472 <do_exit+0x8a>

ffffffffc0204532 <do_wait.part.0>:
int do_wait(int pid, int *code_store)
ffffffffc0204532:	715d                	addi	sp,sp,-80
ffffffffc0204534:	f84a                	sd	s2,48(sp)
ffffffffc0204536:	f44e                	sd	s3,40(sp)
        current->wait_state = WT_CHILD;
ffffffffc0204538:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID)
ffffffffc020453c:	6989                	lui	s3,0x2
int do_wait(int pid, int *code_store)
ffffffffc020453e:	fc26                	sd	s1,56(sp)
ffffffffc0204540:	f052                	sd	s4,32(sp)
ffffffffc0204542:	ec56                	sd	s5,24(sp)
ffffffffc0204544:	e85a                	sd	s6,16(sp)
ffffffffc0204546:	e45e                	sd	s7,8(sp)
ffffffffc0204548:	e486                	sd	ra,72(sp)
ffffffffc020454a:	e0a2                	sd	s0,64(sp)
ffffffffc020454c:	84aa                	mv	s1,a0
ffffffffc020454e:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc0204550:	000a6b97          	auipc	s7,0xa6
ffffffffc0204554:	240b8b93          	addi	s7,s7,576 # ffffffffc02aa790 <current>
    if (0 < pid && pid < MAX_PID)
ffffffffc0204558:	00050b1b          	sext.w	s6,a0
ffffffffc020455c:	fff50a9b          	addiw	s5,a0,-1
ffffffffc0204560:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc0204562:	0905                	addi	s2,s2,1
    if (pid != 0)
ffffffffc0204564:	ccbd                	beqz	s1,ffffffffc02045e2 <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID)
ffffffffc0204566:	0359e863          	bltu	s3,s5,ffffffffc0204596 <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc020456a:	45a9                	li	a1,10
ffffffffc020456c:	855a                	mv	a0,s6
ffffffffc020456e:	4a1000ef          	jal	ra,ffffffffc020520e <hash32>
ffffffffc0204572:	02051793          	slli	a5,a0,0x20
ffffffffc0204576:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020457a:	000a2797          	auipc	a5,0xa2
ffffffffc020457e:	1a678793          	addi	a5,a5,422 # ffffffffc02a6720 <hash_list>
ffffffffc0204582:	953e                	add	a0,a0,a5
ffffffffc0204584:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list)
ffffffffc0204586:	a029                	j	ffffffffc0204590 <do_wait.part.0+0x5e>
            if (proc->pid == pid)
ffffffffc0204588:	f2c42783          	lw	a5,-212(s0)
ffffffffc020458c:	02978163          	beq	a5,s1,ffffffffc02045ae <do_wait.part.0+0x7c>
ffffffffc0204590:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list)
ffffffffc0204592:	fe851be3          	bne	a0,s0,ffffffffc0204588 <do_wait.part.0+0x56>
    return -E_BAD_PROC;
ffffffffc0204596:	5579                	li	a0,-2
}
ffffffffc0204598:	60a6                	ld	ra,72(sp)
ffffffffc020459a:	6406                	ld	s0,64(sp)
ffffffffc020459c:	74e2                	ld	s1,56(sp)
ffffffffc020459e:	7942                	ld	s2,48(sp)
ffffffffc02045a0:	79a2                	ld	s3,40(sp)
ffffffffc02045a2:	7a02                	ld	s4,32(sp)
ffffffffc02045a4:	6ae2                	ld	s5,24(sp)
ffffffffc02045a6:	6b42                	ld	s6,16(sp)
ffffffffc02045a8:	6ba2                	ld	s7,8(sp)
ffffffffc02045aa:	6161                	addi	sp,sp,80
ffffffffc02045ac:	8082                	ret
        if (proc != NULL && proc->parent == current)
ffffffffc02045ae:	000bb683          	ld	a3,0(s7)
ffffffffc02045b2:	f4843783          	ld	a5,-184(s0)
ffffffffc02045b6:	fed790e3          	bne	a5,a3,ffffffffc0204596 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE)
ffffffffc02045ba:	f2842703          	lw	a4,-216(s0)
ffffffffc02045be:	478d                	li	a5,3
ffffffffc02045c0:	0ef70b63          	beq	a4,a5,ffffffffc02046b6 <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc02045c4:	4785                	li	a5,1
ffffffffc02045c6:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc02045c8:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc02045cc:	2d7000ef          	jal	ra,ffffffffc02050a2 <schedule>
        if (current->flags & PF_EXITING)
ffffffffc02045d0:	000bb783          	ld	a5,0(s7)
ffffffffc02045d4:	0b07a783          	lw	a5,176(a5)
ffffffffc02045d8:	8b85                	andi	a5,a5,1
ffffffffc02045da:	d7c9                	beqz	a5,ffffffffc0204564 <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc02045dc:	555d                	li	a0,-9
ffffffffc02045de:	e0bff0ef          	jal	ra,ffffffffc02043e8 <do_exit>
        proc = current->cptr;
ffffffffc02045e2:	000bb683          	ld	a3,0(s7)
ffffffffc02045e6:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr)
ffffffffc02045e8:	d45d                	beqz	s0,ffffffffc0204596 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE)
ffffffffc02045ea:	470d                	li	a4,3
ffffffffc02045ec:	a021                	j	ffffffffc02045f4 <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr)
ffffffffc02045ee:	10043403          	ld	s0,256(s0)
ffffffffc02045f2:	d869                	beqz	s0,ffffffffc02045c4 <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE)
ffffffffc02045f4:	401c                	lw	a5,0(s0)
ffffffffc02045f6:	fee79ce3          	bne	a5,a4,ffffffffc02045ee <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc)
ffffffffc02045fa:	000a6797          	auipc	a5,0xa6
ffffffffc02045fe:	19e7b783          	ld	a5,414(a5) # ffffffffc02aa798 <idleproc>
ffffffffc0204602:	0c878963          	beq	a5,s0,ffffffffc02046d4 <do_wait.part.0+0x1a2>
ffffffffc0204606:	000a6797          	auipc	a5,0xa6
ffffffffc020460a:	19a7b783          	ld	a5,410(a5) # ffffffffc02aa7a0 <initproc>
ffffffffc020460e:	0cf40363          	beq	s0,a5,ffffffffc02046d4 <do_wait.part.0+0x1a2>
    if (code_store != NULL)
ffffffffc0204612:	000a0663          	beqz	s4,ffffffffc020461e <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc0204616:	0e842783          	lw	a5,232(s0)
ffffffffc020461a:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8bb0>
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc020461e:	100027f3          	csrr	a5,sstatus
ffffffffc0204622:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204624:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0204626:	e7c1                	bnez	a5,ffffffffc02046ae <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
ffffffffc0204628:	6c70                	ld	a2,216(s0)
ffffffffc020462a:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL)
ffffffffc020462c:	10043703          	ld	a4,256(s0)
        proc->optr->yptr = proc->yptr;
ffffffffc0204630:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc0204632:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0204634:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc0204636:	6470                	ld	a2,200(s0)
ffffffffc0204638:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc020463a:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc020463c:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL)
ffffffffc020463e:	c319                	beqz	a4,ffffffffc0204644 <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc0204640:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL)
ffffffffc0204642:	7c7c                	ld	a5,248(s0)
ffffffffc0204644:	c3b5                	beqz	a5,ffffffffc02046a8 <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc0204646:	10e7b023          	sd	a4,256(a5)
    nr_process--;
ffffffffc020464a:	000a6717          	auipc	a4,0xa6
ffffffffc020464e:	15e70713          	addi	a4,a4,350 # ffffffffc02aa7a8 <nr_process>
ffffffffc0204652:	431c                	lw	a5,0(a4)
ffffffffc0204654:	37fd                	addiw	a5,a5,-1
ffffffffc0204656:	c31c                	sw	a5,0(a4)
    if (flag)
ffffffffc0204658:	e5a9                	bnez	a1,ffffffffc02046a2 <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc020465a:	6814                	ld	a3,16(s0)
ffffffffc020465c:	c02007b7          	lui	a5,0xc0200
ffffffffc0204660:	04f6ee63          	bltu	a3,a5,ffffffffc02046bc <do_wait.part.0+0x18a>
ffffffffc0204664:	000a6797          	auipc	a5,0xa6
ffffffffc0204668:	1247b783          	ld	a5,292(a5) # ffffffffc02aa788 <va_pa_offset>
ffffffffc020466c:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage)
ffffffffc020466e:	82b1                	srli	a3,a3,0xc
ffffffffc0204670:	000a6797          	auipc	a5,0xa6
ffffffffc0204674:	1007b783          	ld	a5,256(a5) # ffffffffc02aa770 <npage>
ffffffffc0204678:	06f6fa63          	bgeu	a3,a5,ffffffffc02046ec <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc020467c:	00003517          	auipc	a0,0x3
ffffffffc0204680:	1bc53503          	ld	a0,444(a0) # ffffffffc0207838 <nbase>
ffffffffc0204684:	8e89                	sub	a3,a3,a0
ffffffffc0204686:	069a                	slli	a3,a3,0x6
ffffffffc0204688:	000a6517          	auipc	a0,0xa6
ffffffffc020468c:	0f053503          	ld	a0,240(a0) # ffffffffc02aa778 <pages>
ffffffffc0204690:	9536                	add	a0,a0,a3
ffffffffc0204692:	4589                	li	a1,2
ffffffffc0204694:	823fd0ef          	jal	ra,ffffffffc0201eb6 <free_pages>
    kfree(proc);
ffffffffc0204698:	8522                	mv	a0,s0
ffffffffc020469a:	eb0fd0ef          	jal	ra,ffffffffc0201d4a <kfree>
    return 0;
ffffffffc020469e:	4501                	li	a0,0
ffffffffc02046a0:	bde5                	j	ffffffffc0204598 <do_wait.part.0+0x66>
        intr_enable();
ffffffffc02046a2:	b0cfc0ef          	jal	ra,ffffffffc02009ae <intr_enable>
ffffffffc02046a6:	bf55                	j	ffffffffc020465a <do_wait.part.0+0x128>
        proc->parent->cptr = proc->optr;
ffffffffc02046a8:	701c                	ld	a5,32(s0)
ffffffffc02046aa:	fbf8                	sd	a4,240(a5)
ffffffffc02046ac:	bf79                	j	ffffffffc020464a <do_wait.part.0+0x118>
        intr_disable();
ffffffffc02046ae:	b06fc0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        return 1;
ffffffffc02046b2:	4585                	li	a1,1
ffffffffc02046b4:	bf95                	j	ffffffffc0204628 <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02046b6:	f2840413          	addi	s0,s0,-216
ffffffffc02046ba:	b781                	j	ffffffffc02045fa <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc02046bc:	00002617          	auipc	a2,0x2
ffffffffc02046c0:	f3460613          	addi	a2,a2,-204 # ffffffffc02065f0 <default_pmm_manager+0xe0>
ffffffffc02046c4:	07700593          	li	a1,119
ffffffffc02046c8:	00002517          	auipc	a0,0x2
ffffffffc02046cc:	ea850513          	addi	a0,a0,-344 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc02046d0:	dbffb0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc02046d4:	00003617          	auipc	a2,0x3
ffffffffc02046d8:	94c60613          	addi	a2,a2,-1716 # ffffffffc0207020 <default_pmm_manager+0xb10>
ffffffffc02046dc:	37a00593          	li	a1,890
ffffffffc02046e0:	00003517          	auipc	a0,0x3
ffffffffc02046e4:	8a050513          	addi	a0,a0,-1888 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc02046e8:	da7fb0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02046ec:	00002617          	auipc	a2,0x2
ffffffffc02046f0:	f2c60613          	addi	a2,a2,-212 # ffffffffc0206618 <default_pmm_manager+0x108>
ffffffffc02046f4:	06900593          	li	a1,105
ffffffffc02046f8:	00002517          	auipc	a0,0x2
ffffffffc02046fc:	e7850513          	addi	a0,a0,-392 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc0204700:	d8ffb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0204704 <init_main>:
}
...
ffffffffc0204708:	feefd0ef          	jal	ra,ffffffffc0201ef6 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc020470c:	d8afd0ef          	jal	ra,ffffffffc0201c96 <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc0204710:	4601                	li	a2,0
ffffffffc0204712:	4581                	li	a1,0
ffffffffc0204714:	fffff517          	auipc	a0,0xfffff
ffffffffc0204718:	71450513          	addi	a0,a0,1812 # ffffffffc0203e28 <user_main>
ffffffffc020471c:	c7dff0ef          	jal	ra,ffffffffc0204398 <kernel_thread>
    if (pid <= 0)
ffffffffc0204720:	00a04563          	bgtz	a0,ffffffffc020472a <init_main+0x26>
ffffffffc0204724:	a071                	j	ffffffffc02047b0 <init_main+0xac>
    ...
    {
        schedule();
ffffffffc0204726:	17d000ef          	jal	ra,ffffffffc02050a2 <schedule>
    if (code_store != NULL)
ffffffffc020472a:	4581                	li	a1,0
ffffffffc020472c:	4501                	li	a0,0
ffffffffc020472e:	e05ff0ef          	jal	ra,ffffffffc0204532 <do_wait.part.0>
    while (do_wait(0, NULL) == 0)
ffffffffc0204732:	d975                	beqz	a0,ffffffffc0204726 <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc0204734:	00003517          	auipc	a0,0x3
ffffffffc0204738:	92c50513          	addi	a0,a0,-1748 # ffffffffc0207060 <default_pmm_manager+0xb50>
ffffffffc020473c:	a59fb0ef          	jal	ra,ffffffffc0200194 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0204740:	000a6797          	auipc	a5,0xa6
ffffffffc0204744:	0607b783          	ld	a5,96(a5) # ffffffffc02aa7a0 <initproc>
ffffffffc0204748:	7bf8                	ld	a4,240(a5)
ffffffffc020474a:	e339                	bnez	a4,ffffffffc0204790 <init_main+0x8c>
ffffffffc020474c:	7ff8                	ld	a4,248(a5)
ffffffffc020474e:	e329                	bnez	a4,ffffffffc0204790 <init_main+0x8c>
ffffffffc0204750:	1007b703          	ld	a4,256(a5)
ffffffffc0204754:	ef15                	bnez	a4,ffffffffc0204790 <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc0204756:	000a6697          	auipc	a3,0xa6
ffffffffc020475a:	0526a683          	lw	a3,82(a3) # ffffffffc02aa7a8 <nr_process>
ffffffffc020475e:	4709                	li	a4,2
ffffffffc0204760:	0ae69463          	bne	a3,a4,ffffffffc0204808 <init_main+0x104>
    return listelm->next;
ffffffffc0204764:	000a6697          	auipc	a3,0xa6
ffffffffc0204768:	fbc68693          	addi	a3,a3,-68 # ffffffffc02aa720 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc020476c:	6698                	ld	a4,8(a3)
ffffffffc020476e:	0c878793          	addi	a5,a5,200
ffffffffc0204772:	06f71b63          	bne	a4,a5,ffffffffc02047e8 <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc0204776:	629c                	ld	a5,0(a3)
ffffffffc0204778:	04f71863          	bne	a4,a5,ffffffffc02047c8 <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc020477c:	00003517          	auipc	a0,0x3
ffffffffc0204780:	9cc50513          	addi	a0,a0,-1588 # ffffffffc0207148 <default_pmm_manager+0xc38>
ffffffffc0204784:	a11fb0ef          	jal	ra,ffffffffc0200194 <cprintf>
    return 0;
}
ffffffffc0204788:	60a2                	ld	ra,8(sp)
ffffffffc020478a:	4501                	li	a0,0
ffffffffc020478c:	0141                	addi	sp,sp,16
ffffffffc020478e:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0204790:	00003697          	auipc	a3,0x3
ffffffffc0204794:	8f868693          	addi	a3,a3,-1800 # ffffffffc0207088 <default_pmm_manager+0xb78>
ffffffffc0204798:	00002617          	auipc	a2,0x2
ffffffffc020479c:	9c860613          	addi	a2,a2,-1592 # ffffffffc0206160 <commands+0x818>
ffffffffc02047a0:	3e800593          	li	a1,1000
ffffffffc02047a4:	00002517          	auipc	a0,0x2
ffffffffc02047a8:	7dc50513          	addi	a0,a0,2012 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc02047ac:	ce3fb0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("create user_main failed.\n");
ffffffffc02047b0:	00003617          	auipc	a2,0x3
ffffffffc02047b4:	89060613          	addi	a2,a2,-1904 # ffffffffc0207040 <default_pmm_manager+0xb30>
ffffffffc02047b8:	3df00593          	li	a1,991
ffffffffc02047bc:	00002517          	auipc	a0,0x2
ffffffffc02047c0:	7c450513          	addi	a0,a0,1988 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc02047c4:	ccbfb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02047c8:	00003697          	auipc	a3,0x3
ffffffffc02047cc:	95068693          	addi	a3,a3,-1712 # ffffffffc0207118 <default_pmm_manager+0xc08>
ffffffffc02047d0:	00002617          	auipc	a2,0x2
ffffffffc02047d4:	99060613          	addi	a2,a2,-1648 # ffffffffc0206160 <commands+0x818>
ffffffffc02047d8:	3eb00593          	li	a1,1003
ffffffffc02047dc:	00002517          	auipc	a0,0x2
ffffffffc02047e0:	7a450513          	addi	a0,a0,1956 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc02047e4:	cabfb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02047e8:	00003697          	auipc	a3,0x3
ffffffffc02047ec:	90068693          	addi	a3,a3,-1792 # ffffffffc02070e8 <default_pmm_manager+0xbd8>
ffffffffc02047f0:	00002617          	auipc	a2,0x2
ffffffffc02047f4:	97060613          	addi	a2,a2,-1680 # ffffffffc0206160 <commands+0x818>
ffffffffc02047f8:	3ea00593          	li	a1,1002
ffffffffc02047fc:	00002517          	auipc	a0,0x2
ffffffffc0204800:	78450513          	addi	a0,a0,1924 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204804:	c8bfb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_process == 2);
ffffffffc0204808:	00003697          	auipc	a3,0x3
ffffffffc020480c:	8d068693          	addi	a3,a3,-1840 # ffffffffc02070d8 <default_pmm_manager+0xbc8>
ffffffffc0204810:	00002617          	auipc	a2,0x2
ffffffffc0204814:	95060613          	addi	a2,a2,-1712 # ffffffffc0206160 <commands+0x818>
ffffffffc0204818:	3e900593          	li	a1,1001
ffffffffc020481c:	00002517          	auipc	a0,0x2
ffffffffc0204820:	76450513          	addi	a0,a0,1892 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204824:	c6bfb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0204828 <do_execve>:
{
ffffffffc0204828:	7171                	addi	sp,sp,-176
ffffffffc020482a:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020482c:	000a6d97          	auipc	s11,0xa6
ffffffffc0204830:	f64d8d93          	addi	s11,s11,-156 # ffffffffc02aa790 <current>
ffffffffc0204834:	000db783          	ld	a5,0(s11)
{
ffffffffc0204838:	e54e                	sd	s3,136(sp)
ffffffffc020483a:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020483c:	0287b983          	ld	s3,40(a5)
{
ffffffffc0204840:	e94a                	sd	s2,144(sp)
ffffffffc0204842:	f4de                	sd	s7,104(sp)
ffffffffc0204844:	892a                	mv	s2,a0
ffffffffc0204846:	8bb2                	mv	s7,a2
ffffffffc0204848:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0))
ffffffffc020484a:	862e                	mv	a2,a1
ffffffffc020484c:	4681                	li	a3,0
ffffffffc020484e:	85aa                	mv	a1,a0
ffffffffc0204850:	854e                	mv	a0,s3
{
ffffffffc0204852:	f506                	sd	ra,168(sp)
ffffffffc0204854:	f122                	sd	s0,160(sp)
ffffffffc0204856:	e152                	sd	s4,128(sp)
ffffffffc0204858:	fcd6                	sd	s5,120(sp)
ffffffffc020485a:	f8da                	sd	s6,112(sp)
ffffffffc020485c:	f0e2                	sd	s8,96(sp)
ffffffffc020485e:	ece6                	sd	s9,88(sp)
ffffffffc0204860:	e8ea                	sd	s10,80(sp)
ffffffffc0204862:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0))
ffffffffc0204864:	caeff0ef          	jal	ra,ffffffffc0203d12 <user_mem_check>
ffffffffc0204868:	40050a63          	beqz	a0,ffffffffc0204c7c <do_execve+0x454>
    memset(local_name, 0, sizeof(local_name));
ffffffffc020486c:	4641                	li	a2,16
ffffffffc020486e:	4581                	li	a1,0
ffffffffc0204870:	1808                	addi	a0,sp,48
ffffffffc0204872:	643000ef          	jal	ra,ffffffffc02056b4 <memset>
    memcpy(local_name, name, len);
ffffffffc0204876:	47bd                	li	a5,15
ffffffffc0204878:	8626                	mv	a2,s1
ffffffffc020487a:	1e97e263          	bltu	a5,s1,ffffffffc0204a5e <do_execve+0x236>
ffffffffc020487e:	85ca                	mv	a1,s2
ffffffffc0204880:	1808                	addi	a0,sp,48
ffffffffc0204882:	645000ef          	jal	ra,ffffffffc02056c6 <memcpy>
    if (mm != NULL)
ffffffffc0204886:	1e098363          	beqz	s3,ffffffffc0204a6c <do_execve+0x244>
        cputs("mm != NULL");
ffffffffc020488a:	00002517          	auipc	a0,0x2
ffffffffc020488e:	4b650513          	addi	a0,a0,1206 # ffffffffc0206d40 <default_pmm_manager+0x830>
ffffffffc0204892:	93bfb0ef          	jal	ra,ffffffffc02001cc <cputs>
ffffffffc0204896:	000a6797          	auipc	a5,0xa6
ffffffffc020489a:	eca7b783          	ld	a5,-310(a5) # ffffffffc02aa760 <boot_pgdir_pa>
ffffffffc020489e:	577d                	li	a4,-1
ffffffffc02048a0:	177e                	slli	a4,a4,0x3f
ffffffffc02048a2:	83b1                	srli	a5,a5,0xc
ffffffffc02048a4:	8fd9                	or	a5,a5,a4
ffffffffc02048a6:	18079073          	csrw	satp,a5
ffffffffc02048aa:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7b80>
ffffffffc02048ae:	fff7871b          	addiw	a4,a5,-1
ffffffffc02048b2:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0)
ffffffffc02048b6:	2c070463          	beqz	a4,ffffffffc0204b7e <do_execve+0x356>
        current->mm = NULL;
ffffffffc02048ba:	000db783          	ld	a5,0(s11)
ffffffffc02048be:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL)
ffffffffc02048c2:	ddbfe0ef          	jal	ra,ffffffffc020369c <mm_create>
ffffffffc02048c6:	84aa                	mv	s1,a0
ffffffffc02048c8:	1c050d63          	beqz	a0,ffffffffc0204aa2 <do_execve+0x27a>
    if ((page = alloc_page()) == NULL)
ffffffffc02048cc:	4505                	li	a0,1
ffffffffc02048ce:	daafd0ef          	jal	ra,ffffffffc0201e78 <alloc_pages>
ffffffffc02048d2:	3a050963          	beqz	a0,ffffffffc0204c84 <do_execve+0x45c>
    return page - pages + nbase;
ffffffffc02048d6:	000a6c97          	auipc	s9,0xa6
ffffffffc02048da:	ea2c8c93          	addi	s9,s9,-350 # ffffffffc02aa778 <pages>
ffffffffc02048de:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc02048e2:	000a6c17          	auipc	s8,0xa6
ffffffffc02048e6:	e8ec0c13          	addi	s8,s8,-370 # ffffffffc02aa770 <npage>
    return page - pages + nbase;
ffffffffc02048ea:	00003717          	auipc	a4,0x3
ffffffffc02048ee:	f4e73703          	ld	a4,-178(a4) # ffffffffc0207838 <nbase>
ffffffffc02048f2:	40d506b3          	sub	a3,a0,a3
ffffffffc02048f6:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc02048f8:	5afd                	li	s5,-1
ffffffffc02048fa:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc02048fe:	96ba                	add	a3,a3,a4
ffffffffc0204900:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc0204902:	00cad713          	srli	a4,s5,0xc
ffffffffc0204906:	ec3a                	sd	a4,24(sp)
ffffffffc0204908:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc020490a:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc020490c:	38f77063          	bgeu	a4,a5,ffffffffc0204c8c <do_execve+0x464>
ffffffffc0204910:	000a6b17          	auipc	s6,0xa6
ffffffffc0204914:	e78b0b13          	addi	s6,s6,-392 # ffffffffc02aa788 <va_pa_offset>
ffffffffc0204918:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir_va, PGSIZE);
ffffffffc020491c:	6605                	lui	a2,0x1
ffffffffc020491e:	000a6597          	auipc	a1,0xa6
ffffffffc0204922:	e4a5b583          	ld	a1,-438(a1) # ffffffffc02aa768 <boot_pgdir_va>
ffffffffc0204926:	9936                	add	s2,s2,a3
ffffffffc0204928:	854a                	mv	a0,s2
ffffffffc020492a:	59d000ef          	jal	ra,ffffffffc02056c6 <memcpy>
    if (elf->e_magic != ELF_MAGIC)
ffffffffc020492e:	7782                	ld	a5,32(sp)
ffffffffc0204930:	4398                	lw	a4,0(a5)
ffffffffc0204932:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc0204936:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC)
ffffffffc020493a:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b9457>
ffffffffc020493e:	14f71863          	bne	a4,a5,ffffffffc0204a8e <do_execve+0x266>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0204942:	7682                	ld	a3,32(sp)
ffffffffc0204944:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0204948:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020494c:	00371793          	slli	a5,a4,0x3
ffffffffc0204950:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0204952:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0204954:	078e                	slli	a5,a5,0x3
ffffffffc0204956:	97ce                	add	a5,a5,s3
ffffffffc0204958:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph++)
ffffffffc020495a:	00f9fc63          	bgeu	s3,a5,ffffffffc0204972 <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD)
ffffffffc020495e:	0009a783          	lw	a5,0(s3)
ffffffffc0204962:	4705                	li	a4,1
ffffffffc0204964:	14e78163          	beq	a5,a4,ffffffffc0204aa6 <do_execve+0x27e>
    for (; ph < ph_end; ph++)
ffffffffc0204968:	77a2                	ld	a5,40(sp)
ffffffffc020496a:	03898993          	addi	s3,s3,56
ffffffffc020496e:	fef9e8e3          	bltu	s3,a5,ffffffffc020495e <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0)
ffffffffc0204972:	4701                	li	a4,0
ffffffffc0204974:	46ad                	li	a3,11
ffffffffc0204976:	00100637          	lui	a2,0x100
ffffffffc020497a:	7ff005b7          	lui	a1,0x7ff00
ffffffffc020497e:	8526                	mv	a0,s1
ffffffffc0204980:	eaffe0ef          	jal	ra,ffffffffc020382e <mm_map>
ffffffffc0204984:	8a2a                	mv	s4,a0
ffffffffc0204986:	1e051263          	bnez	a0,ffffffffc0204b6a <do_execve+0x342>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - PGSIZE, PTE_USER) != NULL);
ffffffffc020498a:	6c88                	ld	a0,24(s1)
ffffffffc020498c:	467d                	li	a2,31
ffffffffc020498e:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc0204992:	c25fe0ef          	jal	ra,ffffffffc02035b6 <pgdir_alloc_page>
ffffffffc0204996:	38050363          	beqz	a0,ffffffffc0204d1c <do_execve+0x4f4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 2 * PGSIZE, PTE_USER) != NULL);
ffffffffc020499a:	6c88                	ld	a0,24(s1)
ffffffffc020499c:	467d                	li	a2,31
ffffffffc020499e:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc02049a2:	c15fe0ef          	jal	ra,ffffffffc02035b6 <pgdir_alloc_page>
ffffffffc02049a6:	34050b63          	beqz	a0,ffffffffc0204cfc <do_execve+0x4d4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 3 * PGSIZE, PTE_USER) != NULL);
ffffffffc02049aa:	6c88                	ld	a0,24(s1)
ffffffffc02049ac:	467d                	li	a2,31
ffffffffc02049ae:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc02049b2:	c05fe0ef          	jal	ra,ffffffffc02035b6 <pgdir_alloc_page>
ffffffffc02049b6:	32050363          	beqz	a0,ffffffffc0204cdc <do_execve+0x4b4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 4 * PGSIZE, PTE_USER) != NULL);
ffffffffc02049ba:	6c88                	ld	a0,24(s1)
ffffffffc02049bc:	467d                	li	a2,31
ffffffffc02049be:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc02049c2:	bf5fe0ef          	jal	ra,ffffffffc02035b6 <pgdir_alloc_page>
ffffffffc02049c6:	2e050b63          	beqz	a0,ffffffffc0204cbc <do_execve+0x494>
    mm->mm_count += 1;
ffffffffc02049ca:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc02049cc:	000db603          	ld	a2,0(s11)
    current->pgdir = PADDR(mm->pgdir);
ffffffffc02049d0:	6c94                	ld	a3,24(s1)
ffffffffc02049d2:	2785                	addiw	a5,a5,1
ffffffffc02049d4:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc02049d6:	f604                	sd	s1,40(a2)
    current->pgdir = PADDR(mm->pgdir);
ffffffffc02049d8:	c02007b7          	lui	a5,0xc0200
ffffffffc02049dc:	2cf6e463          	bltu	a3,a5,ffffffffc0204ca4 <do_execve+0x47c>
ffffffffc02049e0:	000b3783          	ld	a5,0(s6)
ffffffffc02049e4:	577d                	li	a4,-1
ffffffffc02049e6:	177e                	slli	a4,a4,0x3f
ffffffffc02049e8:	8e9d                	sub	a3,a3,a5
ffffffffc02049ea:	00c6d793          	srli	a5,a3,0xc
ffffffffc02049ee:	f654                	sd	a3,168(a2)
ffffffffc02049f0:	8fd9                	or	a5,a5,a4
ffffffffc02049f2:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc02049f6:	7240                	ld	s0,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02049f8:	4581                	li	a1,0
ffffffffc02049fa:	12000613          	li	a2,288
ffffffffc02049fe:	8522                	mv	a0,s0
    uintptr_t sstatus = tf->status;
ffffffffc0204a00:	10043483          	ld	s1,256(s0)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc0204a04:	4b1000ef          	jal	ra,ffffffffc02056b4 <memset>
    tf->epc = elf->e_entry;
ffffffffc0204a08:	7782                	ld	a5,32(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204a0a:	000db903          	ld	s2,0(s11)
    sstatus &= ~SSTATUS_SPP;   // 清 SPP
ffffffffc0204a0e:	eff4f493          	andi	s1,s1,-257
    tf->epc = elf->e_entry;
ffffffffc0204a12:	6f98                	ld	a4,24(a5)
    tf->gpr.sp = USTACKTOP;
ffffffffc0204a14:	4785                	li	a5,1
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204a16:	0b490913          	addi	s2,s2,180 # ffffffff800000b4 <_binary_obj___user_exit_out_size+0xffffffff7fff4f8c>
    tf->gpr.sp = USTACKTOP;
ffffffffc0204a1a:	07fe                	slli	a5,a5,0x1f
    sstatus |= SSTATUS_SPIE;   // 置 SPIE
ffffffffc0204a1c:	0204e493          	ori	s1,s1,32
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204a20:	4641                	li	a2,16
ffffffffc0204a22:	4581                	li	a1,0
    tf->gpr.sp = USTACKTOP;
ffffffffc0204a24:	e81c                	sd	a5,16(s0)
    tf->epc = elf->e_entry;
ffffffffc0204a26:	10e43423          	sd	a4,264(s0)
    tf->status = sstatus;
ffffffffc0204a2a:	10943023          	sd	s1,256(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204a2e:	854a                	mv	a0,s2
ffffffffc0204a30:	485000ef          	jal	ra,ffffffffc02056b4 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204a34:	463d                	li	a2,15
ffffffffc0204a36:	180c                	addi	a1,sp,48
ffffffffc0204a38:	854a                	mv	a0,s2
ffffffffc0204a3a:	48d000ef          	jal	ra,ffffffffc02056c6 <memcpy>
}
ffffffffc0204a3e:	70aa                	ld	ra,168(sp)
ffffffffc0204a40:	740a                	ld	s0,160(sp)
ffffffffc0204a42:	64ea                	ld	s1,152(sp)
ffffffffc0204a44:	694a                	ld	s2,144(sp)
ffffffffc0204a46:	69aa                	ld	s3,136(sp)
ffffffffc0204a48:	7ae6                	ld	s5,120(sp)
ffffffffc0204a4a:	7b46                	ld	s6,112(sp)
ffffffffc0204a4c:	7ba6                	ld	s7,104(sp)
ffffffffc0204a4e:	7c06                	ld	s8,96(sp)
ffffffffc0204a50:	6ce6                	ld	s9,88(sp)
ffffffffc0204a52:	6d46                	ld	s10,80(sp)
ffffffffc0204a54:	6da6                	ld	s11,72(sp)
ffffffffc0204a56:	8552                	mv	a0,s4
ffffffffc0204a58:	6a0a                	ld	s4,128(sp)
ffffffffc0204a5a:	614d                	addi	sp,sp,176
ffffffffc0204a5c:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc0204a5e:	463d                	li	a2,15
ffffffffc0204a60:	85ca                	mv	a1,s2
ffffffffc0204a62:	1808                	addi	a0,sp,48
ffffffffc0204a64:	463000ef          	jal	ra,ffffffffc02056c6 <memcpy>
    if (mm != NULL)
ffffffffc0204a68:	e20991e3          	bnez	s3,ffffffffc020488a <do_execve+0x62>
    if (current->mm != NULL)
ffffffffc0204a6c:	000db783          	ld	a5,0(s11)
ffffffffc0204a70:	779c                	ld	a5,40(a5)
ffffffffc0204a72:	e40788e3          	beqz	a5,ffffffffc02048c2 <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc0204a76:	00002617          	auipc	a2,0x2
ffffffffc0204a7a:	6f260613          	addi	a2,a2,1778 # ffffffffc0207168 <default_pmm_manager+0xc58>
ffffffffc0204a7e:	25d00593          	li	a1,605
ffffffffc0204a82:	00002517          	auipc	a0,0x2
ffffffffc0204a86:	4fe50513          	addi	a0,a0,1278 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204a8a:	a05fb0ef          	jal	ra,ffffffffc020048e <__panic>
    put_pgdir(mm);
ffffffffc0204a8e:	8526                	mv	a0,s1
ffffffffc0204a90:	c16ff0ef          	jal	ra,ffffffffc0203ea6 <put_pgdir>
    mm_destroy(mm);
ffffffffc0204a94:	8526                	mv	a0,s1
ffffffffc0204a96:	d47fe0ef          	jal	ra,ffffffffc02037dc <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc0204a9a:	5a61                	li	s4,-8
    do_exit(ret);
ffffffffc0204a9c:	8552                	mv	a0,s4
ffffffffc0204a9e:	94bff0ef          	jal	ra,ffffffffc02043e8 <do_exit>
    int ret = -E_NO_MEM;
ffffffffc0204aa2:	5a71                	li	s4,-4
ffffffffc0204aa4:	bfe5                	j	ffffffffc0204a9c <do_execve+0x274>
        if (ph->p_filesz > ph->p_memsz)
ffffffffc0204aa6:	0289b603          	ld	a2,40(s3)
ffffffffc0204aaa:	0209b783          	ld	a5,32(s3)
ffffffffc0204aae:	1cf66d63          	bltu	a2,a5,ffffffffc0204c88 <do_execve+0x460>
        if (ph->p_flags & ELF_PF_X)
ffffffffc0204ab2:	0049a783          	lw	a5,4(s3)
ffffffffc0204ab6:	0017f693          	andi	a3,a5,1
ffffffffc0204aba:	c291                	beqz	a3,ffffffffc0204abe <do_execve+0x296>
            vm_flags |= VM_EXEC;
ffffffffc0204abc:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W)
ffffffffc0204abe:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R)
ffffffffc0204ac2:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W)
ffffffffc0204ac4:	e779                	bnez	a4,ffffffffc0204b92 <do_execve+0x36a>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0204ac6:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R)
ffffffffc0204ac8:	c781                	beqz	a5,ffffffffc0204ad0 <do_execve+0x2a8>
            vm_flags |= VM_READ;
ffffffffc0204aca:	0016e693          	ori	a3,a3,1
            perm |= PTE_R;
ffffffffc0204ace:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE)
ffffffffc0204ad0:	0026f793          	andi	a5,a3,2
ffffffffc0204ad4:	e3f1                	bnez	a5,ffffffffc0204b98 <do_execve+0x370>
        if (vm_flags & VM_EXEC)
ffffffffc0204ad6:	0046f793          	andi	a5,a3,4
ffffffffc0204ada:	c399                	beqz	a5,ffffffffc0204ae0 <do_execve+0x2b8>
            perm |= PTE_X;
ffffffffc0204adc:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0)
ffffffffc0204ae0:	0109b583          	ld	a1,16(s3)
ffffffffc0204ae4:	4701                	li	a4,0
ffffffffc0204ae6:	8526                	mv	a0,s1
ffffffffc0204ae8:	d47fe0ef          	jal	ra,ffffffffc020382e <mm_map>
ffffffffc0204aec:	8a2a                	mv	s4,a0
ffffffffc0204aee:	ed35                	bnez	a0,ffffffffc0204b6a <do_execve+0x342>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0204af0:	0109bb83          	ld	s7,16(s3)
ffffffffc0204af4:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc0204af6:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc0204afa:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0204afe:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc0204b02:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc0204b04:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc0204b06:	993e                	add	s2,s2,a5
        while (start < end)
ffffffffc0204b08:	054be963          	bltu	s7,s4,ffffffffc0204b5a <do_execve+0x332>
ffffffffc0204b0c:	aa95                	j	ffffffffc0204c80 <do_execve+0x458>
...
ffffffffc0204b16:	417a8633          	sub	a2,s5,s7
            if (end < la)
ffffffffc0204b1a:	015a7463          	bgeu	s4,s5,ffffffffc0204b22 <do_execve+0x2fa>
                size -= la - end;
ffffffffc0204b1e:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
...
ffffffffc0204b3a:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204b3c:	14b87863          	bgeu	a6,a1,ffffffffc0204c8c <do_execve+0x464>
ffffffffc0204b40:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0204b44:	85ca                	mv	a1,s2
...
ffffffffc0204b4a:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0204b4c:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0204b4e:	379000ef          	jal	ra,ffffffffc02056c6 <memcpy>
            start += size, from += size;
ffffffffc0204b52:	6622                	ld	a2,8(sp)
ffffffffc0204b54:	9932                	add	s2,s2,a2
        while (start < end)
ffffffffc0204b56:	054bf363          	bgeu	s7,s4,ffffffffc0204b9c <do_execve+0x374>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL)
ffffffffc0204b5a:	6c88                	ld	a0,24(s1)
ffffffffc0204b5c:	866a                	mv	a2,s10
ffffffffc0204b5e:	85d6                	mv	a1,s5
ffffffffc0204b60:	a57fe0ef          	jal	ra,ffffffffc02035b6 <pgdir_alloc_page>
ffffffffc0204b64:	842a                	mv	s0,a0
ffffffffc0204b66:	f545                	bnez	a0,ffffffffc0204b0e <do_execve+0x2e6>
        ret = -E_NO_MEM;
ffffffffc0204b68:	5a71                	li	s4,-4
    exit_mmap(mm);
ffffffffc0204b6a:	8526                	mv	a0,s1
ffffffffc0204b6c:	e0dfe0ef          	jal	ra,ffffffffc0203978 <exit_mmap>
    put_pgdir(mm);
ffffffffc0204b70:	8526                	mv	a0,s1
ffffffffc0204b72:	b34ff0ef          	jal	ra,ffffffffc0203ea6 <put_pgdir>
    mm_destroy(mm);
ffffffffc0204b76:	8526                	mv	a0,s1
ffffffffc0204b78:	c65fe0ef          	jal	ra,ffffffffc02037dc <mm_destroy>
    return ret;
ffffffffc0204b7c:	b705                	j	ffffffffc0204a9c <do_execve+0x274>
            exit_mmap(mm);
ffffffffc0204b7e:	854e                	mv	a0,s3
ffffffffc0204b80:	df9fe0ef          	jal	ra,ffffffffc0203978 <exit_mmap>
            put_pgdir(mm);
ffffffffc0204b84:	854e                	mv	a0,s3
ffffffffc0204b86:	b20ff0ef          	jal	ra,ffffffffc0203ea6 <put_pgdir>
            mm_destroy(mm);
ffffffffc0204b8a:	854e                	mv	a0,s3
ffffffffc0204b8c:	c51fe0ef          	jal	ra,ffffffffc02037dc <mm_destroy>
ffffffffc0204b90:	b32d                	j	ffffffffc02048ba <do_execve+0x92>
            vm_flags |= VM_WRITE;
ffffffffc0204b92:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R)
ffffffffc0204b96:	fb95                	bnez	a5,ffffffffc0204aca <do_execve+0x2a2>
            perm |= (PTE_W | PTE_R);
ffffffffc0204b98:	4d5d                	li	s10,23
ffffffffc0204b9a:	bf35                	j	ffffffffc0204ad6 <do_execve+0x2ae>
        end = ph->p_va + ph->p_memsz;
ffffffffc0204b9c:	0109b683          	ld	a3,16(s3)
ffffffffc0204ba0:	0289b903          	ld	s2,40(s3)
ffffffffc0204ba4:	9936                	add	s2,s2,a3
        if (start < la)
ffffffffc0204ba6:	075bfd63          	bgeu	s7,s5,ffffffffc0204c20 <do_execve+0x3f8>
            if (start == end)
ffffffffc0204baa:	db790fe3          	beq	s2,s7,ffffffffc0204968 <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0204bae:	6785                	lui	a5,0x1
ffffffffc0204bb0:	00fb8533          	add	a0,s7,a5
ffffffffc0204bb4:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0204bb8:	41790a33          	sub	s4,s2,s7
            if (end < la)
ffffffffc0204bbc:	0b597d63          	bgeu	s2,s5,ffffffffc0204c76 <do_execve+0x44e>
    return page - pages + nbase;
ffffffffc0204bc0:	000cb683          	ld	a3,0(s9)
ffffffffc0204bc4:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0204bc6:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
ffffffffc0204bca:	40d406b3          	sub	a3,s0,a3
ffffffffc0204bce:	8699                	srai	a3,a3,0x6
ffffffffc0204bd0:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204bd2:	67e2                	ld	a5,24(sp)
ffffffffc0204bd4:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0204bd8:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204bda:	0ac5f963          	bgeu	a1,a2,ffffffffc0204c8c <do_execve+0x464>
ffffffffc0204bde:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0204be2:	8652                	mv	a2,s4
ffffffffc0204be4:	4581                	li	a1,0
ffffffffc0204be6:	96c2                	add	a3,a3,a6
ffffffffc0204be8:	9536                	add	a0,a0,a3
ffffffffc0204bea:	2cb000ef          	jal	ra,ffffffffc02056b4 <memset>
            start += size;
ffffffffc0204bee:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0204bf2:	03597463          	bgeu	s2,s5,ffffffffc0204c1a <do_execve+0x3f2>
ffffffffc0204bf6:	d6e909e3          	beq	s2,a4,ffffffffc0204968 <do_execve+0x140>
ffffffffc0204bfa:	00002697          	auipc	a3,0x2
ffffffffc0204bfe:	59668693          	addi	a3,a3,1430 # ffffffffc0207190 <default_pmm_manager+0xc80>
ffffffffc0204c02:	00001617          	auipc	a2,0x1
ffffffffc0204c06:	55e60613          	addi	a2,a2,1374 # ffffffffc0206160 <commands+0x818>
ffffffffc0204c0a:	2c600593          	li	a1,710
ffffffffc0204c0e:	00002517          	auipc	a0,0x2
ffffffffc0204c12:	37250513          	addi	a0,a0,882 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204c16:	879fb0ef          	jal	ra,ffffffffc020048e <__panic>
ffffffffc0204c1a:	ff5710e3          	bne	a4,s5,ffffffffc0204bfa <do_execve+0x3d2>
ffffffffc0204c1e:	8bd6                	mv	s7,s5
        while (start < end)
ffffffffc0204c20:	d52bf4e3          	bgeu	s7,s2,ffffffffc0204968 <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL)
ffffffffc0204c24:	6c88                	ld	a0,24(s1)
ffffffffc0204c26:	866a                	mv	a2,s10
ffffffffc0204c28:	85d6                	mv	a1,s5
ffffffffc0204c2a:	98dfe0ef          	jal	ra,ffffffffc02035b6 <pgdir_alloc_page>
ffffffffc0204c2e:	842a                	mv	s0,a0
ffffffffc0204c30:	dd05                	beqz	a0,ffffffffc0204b68 <do_execve+0x340>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0204c32:	6785                	lui	a5,0x1
ffffffffc0204c34:	415b8533          	sub	a0,s7,s5
ffffffffc0204c38:	9abe                	add	s5,s5,a5
ffffffffc0204c3a:	417a8633          	sub	a2,s5,s7
            if (end < la)
ffffffffc0204c3e:	01597463          	bgeu	s2,s5,ffffffffc0204c46 <do_execve+0x41e>
                size -= la - end;
ffffffffc0204c42:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0204c46:	000cb683          	ld	a3,0(s9)
ffffffffc0204c4a:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0204c4c:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0204c50:	40d406b3          	sub	a3,s0,a3
ffffffffc0204c54:	8699                	srai	a3,a3,0x6
ffffffffc0204c56:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204c58:	67e2                	ld	a5,24(sp)
ffffffffc0204c5a:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0204c5e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204c60:	02b87663          	bgeu	a6,a1,ffffffffc0204c8c <do_execve+0x464>
ffffffffc0204c64:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0204c68:	4581                	li	a1,0
            start += size;
ffffffffc0204c6a:	9bb2                	add	s7,s7,a2
ffffffffc0204c6c:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0204c6e:	9536                	add	a0,a0,a3
ffffffffc0204c70:	245000ef          	jal	ra,ffffffffc02056b4 <memset>
ffffffffc0204c74:	b775                	j	ffffffffc0204c20 <do_execve+0x3f8>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0204c76:	417a8a33          	sub	s4,s5,s7
ffffffffc0204c7a:	b799                	j	ffffffffc0204bc0 <do_execve+0x398>
        return -E_INVAL;
ffffffffc0204c7c:	5a75                	li	s4,-3
ffffffffc0204c7e:	b3c1                	j	ffffffffc0204a3e <do_execve+0x216>
        while (start < end)
ffffffffc0204c80:	86de                	mv	a3,s7
ffffffffc0204c82:	bf39                	j	ffffffffc0204ba0 <do_execve+0x378>
    int ret = -E_NO_MEM;
ffffffffc0204c84:	5a71                	li	s4,-4
ffffffffc0204c86:	bdc5                	j	ffffffffc0204b76 <do_execve+0x34e>
            ret = -E_INVAL_ELF;
ffffffffc0204c88:	5a61                	li	s4,-8
ffffffffc0204c8a:	b5c5                	j	ffffffffc0204b6a <do_execve+0x342>
ffffffffc0204c8c:	00002617          	auipc	a2,0x2
ffffffffc0204c90:	8bc60613          	addi	a2,a2,-1860 # ffffffffc0206548 <default_pmm_manager+0x38>
ffffffffc0204c94:	07100593          	li	a1,113
ffffffffc0204c98:	00002517          	auipc	a0,0x2
ffffffffc0204c9c:	8d850513          	addi	a0,a0,-1832 # ffffffffc0206570 <default_pmm_manager+0x60>
ffffffffc0204ca0:	feefb0ef          	jal	ra,ffffffffc020048e <__panic>
    current->pgdir = PADDR(mm->pgdir);
ffffffffc0204ca4:	00002617          	auipc	a2,0x2
ffffffffc0204ca8:	94c60613          	addi	a2,a2,-1716 # ffffffffc02065f0 <default_pmm_manager+0xe0>
ffffffffc0204cac:	2e500593          	li	a1,741
ffffffffc0204cb0:	00002517          	auipc	a0,0x2
ffffffffc0204cb4:	2d050513          	addi	a0,a0,720 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204cb8:	fd6fb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 4 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204cbc:	00002697          	auipc	a3,0x2
ffffffffc0204cc0:	5ec68693          	addi	a3,a3,1516 # ffffffffc02072a8 <default_pmm_manager+0xd98>
ffffffffc0204cc4:	00001617          	auipc	a2,0x1
ffffffffc0204cc8:	49c60613          	addi	a2,a2,1180 # ffffffffc0206160 <commands+0x818>
ffffffffc0204ccc:	2e000593          	li	a1,736
ffffffffc0204cd0:	00002517          	auipc	a0,0x2
ffffffffc0204cd4:	2b050513          	addi	a0,a0,688 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204cd8:	fb6fb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 3 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204cdc:	00002697          	auipc	a3,0x2
ffffffffc0204ce0:	58468693          	addi	a3,a3,1412 # ffffffffc0207260 <default_pmm_manager+0xd50>
ffffffffc0204ce4:	00001617          	auipc	a2,0x1
ffffffffc0204ce8:	47c60613          	addi	a2,a2,1148 # ffffffffc0206160 <commands+0x818>
ffffffffc0204cec:	2df00593          	li	a1,735
ffffffffc0204cf0:	00002517          	auipc	a0,0x2
ffffffffc0204cf4:	29050513          	addi	a0,a0,656 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204cf8:	f96fb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 2 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204cfc:	00002697          	auipc	a3,0x2
ffffffffc0204d00:	51c68693          	addi	a3,a3,1308 # ffffffffc0207218 <default_pmm_manager+0xd08>
ffffffffc0204d04:	00001617          	auipc	a2,0x1
ffffffffc0204d08:	45c60613          	addi	a2,a2,1116 # ffffffffc0206160 <commands+0x818>
ffffffffc0204d0c:	2de00593          	li	a1,734
ffffffffc0204d10:	00002517          	auipc	a0,0x2
ffffffffc0204d14:	27050513          	addi	a0,a0,624 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204d18:	f76fb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - PGSIZE, PTE_USER) != NULL);
ffffffffc0204d1c:	00002697          	auipc	a3,0x2
ffffffffc0204d20:	4b468693          	addi	a3,a3,1204 # ffffffffc02071d0 <default_pmm_manager+0xcc0>
ffffffffc0204d24:	00001617          	auipc	a2,0x1
ffffffffc0204d28:	43c60613          	addi	a2,a2,1084 # ffffffffc0206160 <commands+0x818>
ffffffffc0204d2c:	2dd00593          	li	a1,733
ffffffffc0204d30:	00002517          	auipc	a0,0x2
ffffffffc0204d34:	25050513          	addi	a0,a0,592 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204d38:	f56fb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0204d3c <do_yield>:
    current->need_resched = 1;
ffffffffc0204d3c:	000a6797          	auipc	a5,0xa6
ffffffffc0204d40:	a547b783          	ld	a5,-1452(a5) # ffffffffc02aa790 <current>
ffffffffc0204d44:	4705                	li	a4,1
ffffffffc0204d46:	ef98                	sd	a4,24(a5)
}
ffffffffc0204d48:	4501                	li	a0,0
ffffffffc0204d4a:	8082                	ret

ffffffffc0204d4c <do_wait>:
{
ffffffffc0204d4c:	1101                	addi	sp,sp,-32
ffffffffc0204d4e:	e822                	sd	s0,16(sp)
ffffffffc0204d50:	e426                	sd	s1,8(sp)
ffffffffc0204d52:	ec06                	sd	ra,24(sp)
ffffffffc0204d54:	842e                	mv	s0,a1
ffffffffc0204d56:	84aa                	mv	s1,a0
    if (code_store != NULL)
ffffffffc0204d58:	c999                	beqz	a1,ffffffffc0204d6e <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0204d5a:	000a6797          	auipc	a5,0xa6
ffffffffc0204d5e:	a367b783          	ld	a5,-1482(a5) # ffffffffc02aa790 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1))
ffffffffc0204d62:	7788                	ld	a0,40(a5)
ffffffffc0204d64:	4685                	li	a3,1
ffffffffc0204d66:	4611                	li	a2,4
ffffffffc0204d68:	fabfe0ef          	jal	ra,ffffffffc0203d12 <user_mem_check>
ffffffffc0204d6c:	c909                	beqz	a0,ffffffffc0204d7e <do_wait+0x32>
ffffffffc0204d6e:	85a2                	mv	a1,s0
}
ffffffffc0204d70:	6442                	ld	s0,16(sp)
ffffffffc0204d72:	60e2                	ld	ra,24(sp)
ffffffffc0204d74:	8526                	mv	a0,s1
ffffffffc0204d76:	64a2                	ld	s1,8(sp)
ffffffffc0204d78:	6105                	addi	sp,sp,32
ffffffffc0204d7a:	fb8ff06f          	j	ffffffffc0204532 <do_wait.part.0>
ffffffffc0204d7e:	60e2                	ld	ra,24(sp)
ffffffffc0204d80:	6442                	ld	s0,16(sp)
ffffffffc0204d82:	64a2                	ld	s1,8(sp)
ffffffffc0204d84:	5575                	li	a0,-3
ffffffffc0204d86:	6105                	addi	sp,sp,32
ffffffffc0204d88:	8082                	ret

ffffffffc0204d8a <do_kill>:
{
ffffffffc0204d8a:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID)
ffffffffc0204d8c:	6789                	lui	a5,0x2
{
ffffffffc0204d8e:	e406                	sd	ra,8(sp)
ffffffffc0204d90:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID)
ffffffffc0204d92:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204d96:	17f9                	addi	a5,a5,-2
ffffffffc0204d98:	02e7e963          	bltu	a5,a4,ffffffffc0204dca <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204d9c:	842a                	mv	s0,a0
ffffffffc0204d9e:	45a9                	li	a1,10
ffffffffc0204da0:	2501                	sext.w	a0,a0
ffffffffc0204da2:	46c000ef          	jal	ra,ffffffffc020520e <hash32>
ffffffffc0204da6:	02051793          	slli	a5,a0,0x20
ffffffffc0204daa:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204dae:	000a2797          	auipc	a5,0xa2
ffffffffc0204db2:	97278793          	addi	a5,a5,-1678 # ffffffffc02a6720 <hash_list>
ffffffffc0204db6:	953e                	add	a0,a0,a5
ffffffffc0204db8:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list)
ffffffffc0204dba:	a029                	j	ffffffffc0204dc4 <do_kill+0x3a>
            if (proc->pid == pid)
ffffffffc0204dbc:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0204dc0:	00870b63          	beq	a4,s0,ffffffffc0204dd6 <do_kill+0x4c>
ffffffffc0204dc4:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0204dc6:	fef51be3          	bne	a0,a5,ffffffffc0204dbc <do_kill+0x32>
    return -E_INVAL;
ffffffffc0204dca:	5475                	li	s0,-3
}
ffffffffc0204dcc:	60a2                	ld	ra,8(sp)
ffffffffc0204dce:	8522                	mv	a0,s0
ffffffffc0204dd0:	6402                	ld	s0,0(sp)
ffffffffc0204dd2:	0141                	addi	sp,sp,16
ffffffffc0204dd4:	8082                	ret
        if (!(proc->flags & PF_EXITING))
ffffffffc0204dd6:	fd87a703          	lw	a4,-40(a5)
ffffffffc0204dda:	00177693          	andi	a3,a4,1
ffffffffc0204dde:	e295                	bnez	a3,ffffffffc0204e02 <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED)
ffffffffc0204de0:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0204de2:	00176713          	ori	a4,a4,1
ffffffffc0204de6:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0204dea:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED)
ffffffffc0204dec:	fe06d0e3          	bgez	a3,ffffffffc0204dcc <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0204df0:	f2878513          	addi	a0,a5,-216
ffffffffc0204df4:	22e000ef          	jal	ra,ffffffffc0205022 <wakeup_proc>
}
ffffffffc0204df8:	60a2                	ld	ra,8(sp)
ffffffffc0204dfa:	8522                	mv	a0,s0
ffffffffc0204dfc:	6402                	ld	s0,0(sp)
ffffffffc0204dfe:	0141                	addi	sp,sp,16
ffffffffc0204e00:	8082                	ret
        return -E_KILLED;
ffffffffc0204e02:	545d                	li	s0,-9
ffffffffc0204e04:	b7e1                	j	ffffffffc0204dcc <do_kill+0x42>

ffffffffc0204e06 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and
//           - create the second kernel thread init_main
void proc_init(void)
{
ffffffffc0204e06:	1101                	addi	sp,sp,-32
ffffffffc0204e08:	e426                	sd	s1,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0204e0a:	000a6797          	auipc	a5,0xa6
ffffffffc0204e0e:	91678793          	addi	a5,a5,-1770 # ffffffffc02aa720 <proc_list>
ffffffffc0204e12:	ec06                	sd	ra,24(sp)
ffffffffc0204e14:	e822                	sd	s0,16(sp)
ffffffffc0204e16:	e04a                	sd	s2,0(sp)
ffffffffc0204e18:	000a2497          	auipc	s1,0xa2
ffffffffc0204e1c:	90848493          	addi	s1,s1,-1784 # ffffffffc02a6720 <hash_list>
ffffffffc0204e20:	e79c                	sd	a5,8(a5)
ffffffffc0204e22:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i++)
ffffffffc0204e24:	000a6717          	auipc	a4,0xa6
ffffffffc0204e28:	8fc70713          	addi	a4,a4,-1796 # ffffffffc02aa720 <proc_list>
ffffffffc0204e2c:	87a6                	mv	a5,s1
ffffffffc0204e2e:	e79c                	sd	a5,8(a5)
ffffffffc0204e30:	e39c                	sd	a5,0(a5)
ffffffffc0204e32:	07c1                	addi	a5,a5,16
ffffffffc0204e34:	fef71de3          	bne	a4,a5,ffffffffc0204e2e <proc_init+0x28>
    {
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL)
ffffffffc0204e38:	f77fe0ef          	jal	ra,ffffffffc0203dae <alloc_proc>
ffffffffc0204e3c:	000a6917          	auipc	s2,0xa6
ffffffffc0204e40:	95c90913          	addi	s2,s2,-1700 # ffffffffc02aa798 <idleproc>
ffffffffc0204e44:	00a93023          	sd	a0,0(s2)
ffffffffc0204e48:	0e050f63          	beqz	a0,ffffffffc0204f46 <proc_init+0x140>
    {
...
ffffffffc0204e4c:	4789                	li	a5,2
ffffffffc0204e4e:	e11c                	sd	a5,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204e50:	00003797          	auipc	a5,0x3
ffffffffc0204e54:	1b078793          	addi	a5,a5,432 # ffffffffc0208000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204e58:	0b450413          	addi	s0,a0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204e5c:	e91c                	sd	a5,16(a0)
    idleproc->need_resched = 1;
ffffffffc0204e5e:	4785                	li	a5,1
ffffffffc0204e60:	ed1c                	sd	a5,24(a0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204e62:	4641                	li	a2,16
ffffffffc0204e64:	4581                	li	a1,0
ffffffffc0204e66:	8522                	mv	a0,s0
ffffffffc0204e68:	04d000ef          	jal	ra,ffffffffc02056b4 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204e6c:	463d                	li	a2,15
ffffffffc0204e6e:	00002597          	auipc	a1,0x2
ffffffffc0204e72:	49a58593          	addi	a1,a1,1178 # ffffffffc0207308 <default_pmm_manager+0xdf8>
ffffffffc0204e76:	8522                	mv	a0,s0
ffffffffc0204e78:	04f000ef          	jal	ra,ffffffffc02056c6 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process++;
ffffffffc0204e7c:	000a6717          	auipc	a4,0xa6
ffffffffc0204e80:	92c70713          	addi	a4,a4,-1748 # ffffffffc02aa7a8 <nr_process>
ffffffffc0204e84:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0204e86:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0204e8a:	4601                	li	a2,0
    nr_process++;
ffffffffc0204e8c:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0204e8e:	4581                	li	a1,0
ffffffffc0204e90:	00000517          	auipc	a0,0x0
ffffffffc0204e94:	87450513          	addi	a0,a0,-1932 # ffffffffc0204704 <init_main>
    nr_process++;
ffffffffc0204e98:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0204e9a:	000a6797          	auipc	a5,0xa6
ffffffffc0204e9e:	8ed7bb23          	sd	a3,-1802(a5) # ffffffffc02aa790 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0204ea2:	cf6ff0ef          	jal	ra,ffffffffc0204398 <kernel_thread>
ffffffffc0204ea6:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc0204ea8:	08a05363          	blez	a0,ffffffffc0204f2e <proc_init+0x128>
    if (0 < pid && pid < MAX_PID)
ffffffffc0204eac:	6789                	lui	a5,0x2
ffffffffc0204eae:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204eb2:	17f9                	addi	a5,a5,-2
ffffffffc0204eb4:	2501                	sext.w	a0,a0
ffffffffc0204eb6:	02e7e363          	bltu	a5,a4,ffffffffc0204edc <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204eba:	45a9                	li	a1,10
ffffffffc0204ebc:	352000ef          	jal	ra,ffffffffc020520e <hash32>
ffffffffc0204ec0:	02051793          	slli	a5,a0,0x20
ffffffffc0204ec4:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0204ec8:	96a6                	add	a3,a3,s1
ffffffffc0204eca:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc0204ecc:	a029                	j	ffffffffc0204ed6 <proc_init+0xd0>
            if (proc->pid == pid)
ffffffffc0204ece:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7c84>
ffffffffc0204ed2:	04870b63          	beq	a4,s0,ffffffffc0204f28 <proc_init+0x122>
    return listelm->next;
ffffffffc0204ed6:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0204ed8:	fef69be3          	bne	a3,a5,ffffffffc0204ece <proc_init+0xc8>
    return NULL;
ffffffffc0204edc:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204ede:	0b478493          	addi	s1,a5,180
...
ffffffffc0204ee6:	000a6417          	auipc	s0,0xa6
ffffffffc0204eea:	8ba40413          	addi	s0,s0,-1862 # ffffffffc02aa7a0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204eee:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0204ef0:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204ef2:	7c2000ef          	jal	ra,ffffffffc02056b4 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204ef6:	463d                	li	a2,15
ffffffffc0204ef8:	00002597          	auipc	a1,0x2
ffffffffc0204efc:	43858593          	addi	a1,a1,1080 # ffffffffc0207330 <default_pmm_manager+0xe20>
ffffffffc0204f00:	8526                	mv	a0,s1
ffffffffc0204f02:	7c4000ef          	jal	ra,ffffffffc02056c6 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204f06:	00093783          	ld	a5,0(s2)
ffffffffc0204f0a:	cbb5                	beqz	a5,ffffffffc0204f7e <proc_init+0x178>
ffffffffc0204f0c:	43dc                	lw	a5,4(a5)
ffffffffc0204f0e:	eba5                	bnez	a5,ffffffffc0204f7e <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204f10:	601c                	ld	a5,0(s0)
ffffffffc0204f12:	c7b1                	beqz	a5,ffffffffc0204f5e <proc_init+0x158>
ffffffffc0204f14:	43d8                	lw	a4,4(a5)
ffffffffc0204f16:	4785                	li	a5,1
ffffffffc0204f18:	04f71363          	bne	a4,a5,ffffffffc0204f5e <proc_init+0x158>
}
ffffffffc0204f1c:	60e2                	ld	ra,24(sp)
ffffffffc0204f1e:	6442                	ld	s0,16(sp)
ffffffffc0204f20:	64a2                	ld	s1,8(sp)
ffffffffc0204f22:	6902                	ld	s2,0(sp)
ffffffffc0204f24:	6105                	addi	sp,sp,32
ffffffffc0204f26:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0204f28:	f2878793          	addi	a5,a5,-216
ffffffffc0204f2c:	bf4d                	j	ffffffffc0204ede <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc0204f2e:	00002617          	auipc	a2,0x2
ffffffffc0204f32:	3e260613          	addi	a2,a2,994 # ffffffffc0207310 <default_pmm_manager+0xe00>
ffffffffc0204f36:	40e00593          	li	a1,1038
ffffffffc0204f3a:	00002517          	auipc	a0,0x2
ffffffffc0204f3e:	04650513          	addi	a0,a0,70 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204f42:	d4cfb0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0204f46:	00002617          	auipc	a2,0x2
ffffffffc0204f4a:	3aa60613          	addi	a2,a2,938 # ffffffffc02072f0 <default_pmm_manager+0xde0>
ffffffffc0204f4e:	3ff00593          	li	a1,1023
ffffffffc0204f52:	00002517          	auipc	a0,0x2
ffffffffc0204f56:	02e50513          	addi	a0,a0,46 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204f5a:	d34fb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204f5e:	00002697          	auipc	a3,0x2
ffffffffc0204f62:	40268693          	addi	a3,a3,1026 # ffffffffc0207360 <default_pmm_manager+0xe50>
ffffffffc0204f66:	00001617          	auipc	a2,0x1
ffffffffc0204f6a:	1fa60613          	addi	a2,a2,506 # ffffffffc0206160 <commands+0x818>
ffffffffc0204f6e:	41500593          	li	a1,1045
ffffffffc0204f72:	00002517          	auipc	a0,0x2
ffffffffc0204f76:	00e50513          	addi	a0,a0,14 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204f7a:	d14fb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204f7e:	00002697          	auipc	a3,0x2
ffffffffc0204f82:	3ba68693          	addi	a3,a3,954 # ffffffffc0207338 <default_pmm_manager+0xe28>
ffffffffc0204f86:	00001617          	auipc	a2,0x1
ffffffffc0204f8a:	1da60613          	addi	a2,a2,474 # ffffffffc0206160 <commands+0x818>
ffffffffc0204f8e:	41400593          	li	a1,1044
ffffffffc0204f92:	00002517          	auipc	a0,0x2
ffffffffc0204f96:	fee50513          	addi	a0,a0,-18 # ffffffffc0206f80 <default_pmm_manager+0xa70>
ffffffffc0204f9a:	cf4fb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0204f9e <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void cpu_idle(void)
{
ffffffffc0204f9e:	1141                	addi	sp,sp,-16
ffffffffc0204fa0:	e022                	sd	s0,0(sp)
ffffffffc0204fa2:	e406                	sd	ra,8(sp)
ffffffffc0204fa4:	000a5417          	auipc	s0,0xa5
ffffffffc0204fa8:	7ec40413          	addi	s0,s0,2028 # ffffffffc02aa790 <current>
    while (1)
    {
        if (current->need_resched)
ffffffffc0204fac:	6018                	ld	a4,0(s0)
ffffffffc0204fae:	6f1c                	ld	a5,24(a4)
ffffffffc0204fb0:	dffd                	beqz	a5,ffffffffc0204fae <cpu_idle+0x10>
        {
            schedule();
ffffffffc0204fb2:	0f0000ef          	jal	ra,ffffffffc02050a2 <schedule>
ffffffffc0204fb6:	bfdd                	j	ffffffffc0204fac <cpu_idle+0xe>

ffffffffc0204fb8 <switch_to>:
.text
...
ffffffffc0204fb8:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204fbc:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204fc0:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204fc2:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204fc4:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204fc8:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204fcc:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204fd0:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0204fd4:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204fd8:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204fdc:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204fe0:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0204fe4:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204fe8:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204fec:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204ff0:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204ff4:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204ff6:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204ff8:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204ffc:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0205000:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0205004:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0205008:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc020500c:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0205010:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0205014:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0205018:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc020501c:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0205020:	8082                	ret

ffffffffc0205022 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0205022:	4118                	lw	a4,0(a0)
{
ffffffffc0205024:	1101                	addi	sp,sp,-32
ffffffffc0205026:	ec06                	sd	ra,24(sp)
ffffffffc0205028:	e822                	sd	s0,16(sp)
ffffffffc020502a:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc020502c:	478d                	li	a5,3
ffffffffc020502e:	04f70b63          	beq	a4,a5,ffffffffc0205084 <wakeup_proc+0x62>
ffffffffc0205032:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0205034:	100027f3          	csrr	a5,sstatus
ffffffffc0205038:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020503a:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc020503c:	ef9d                	bnez	a5,ffffffffc020507a <wakeup_proc+0x58>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE)
ffffffffc020503e:	4789                	li	a5,2
ffffffffc0205040:	02f70163          	beq	a4,a5,ffffffffc0205062 <wakeup_proc+0x40>
        {
            proc->state = PROC_RUNNABLE;
ffffffffc0205044:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc0205046:	0e042623          	sw	zero,236(s0)
    if (flag)
ffffffffc020504a:	e491                	bnez	s1,ffffffffc0205056 <wakeup_proc+0x34>
        {
...
ffffffffc020504c:	60e2                	ld	ra,24(sp)
ffffffffc020504e:	6442                	ld	s0,16(sp)
ffffffffc0205050:	64a2                	ld	s1,8(sp)
ffffffffc0205052:	6105                	addi	sp,sp,32
ffffffffc0205054:	8082                	ret
ffffffffc0205056:	6442                	ld	s0,16(sp)
ffffffffc0205058:	60e2                	ld	ra,24(sp)
ffffffffc020505a:	64a2                	ld	s1,8(sp)
ffffffffc020505c:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc020505e:	951fb06f          	j	ffffffffc02009ae <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205062:	00002617          	auipc	a2,0x2
ffffffffc0205066:	35e60613          	addi	a2,a2,862 # ffffffffc02073c0 <default_pmm_manager+0xeb0>
ffffffffc020506a:	45d1                	li	a1,20
ffffffffc020506c:	00002517          	auipc	a0,0x2
ffffffffc0205070:	33c50513          	addi	a0,a0,828 # ffffffffc02073a8 <default_pmm_manager+0xe98>
ffffffffc0205074:	c82fb0ef          	jal	ra,ffffffffc02004f6 <__warn>
ffffffffc0205078:	bfc9                	j	ffffffffc020504a <wakeup_proc+0x28>
        intr_disable();
ffffffffc020507a:	93bfb0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        if (proc->state != PROC_RUNNABLE)
ffffffffc020507e:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc0205080:	4485                	li	s1,1
ffffffffc0205082:	bf75                	j	ffffffffc020503e <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205084:	00002697          	auipc	a3,0x2
ffffffffc0205088:	30468693          	addi	a3,a3,772 # ffffffffc0207388 <default_pmm_manager+0xe78>
ffffffffc020508c:	00001617          	auipc	a2,0x1
ffffffffc0205090:	0d460613          	addi	a2,a2,212 # ffffffffc0206160 <commands+0x818>
ffffffffc0205094:	45a5                	li	a1,9
ffffffffc0205096:	00002517          	auipc	a0,0x2
ffffffffc020509a:	31250513          	addi	a0,a0,786 # ffffffffc02073a8 <default_pmm_manager+0xe98>
ffffffffc020509e:	bf0fb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc02050a2 <schedule>:

void schedule(void)
{
ffffffffc02050a2:	1141                	addi	sp,sp,-16
ffffffffc02050a4:	e406                	sd	ra,8(sp)
ffffffffc02050a6:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02050a8:	100027f3          	csrr	a5,sstatus
ffffffffc02050ac:	8b89                	andi	a5,a5,2
ffffffffc02050ae:	4401                	li	s0,0
ffffffffc02050b0:	efbd                	bnez	a5,ffffffffc020512e <schedule+0x8c>
    bool intr_flag;
...
ffffffffc02050b2:	000a5897          	auipc	a7,0xa5
ffffffffc02050b6:	6de8b883          	ld	a7,1758(a7) # ffffffffc02aa790 <current>
ffffffffc02050ba:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02050be:	000a5517          	auipc	a0,0xa5
ffffffffc02050c2:	6da53503          	ld	a0,1754(a0) # ffffffffc02aa798 <idleproc>
ffffffffc02050c6:	04a88e63          	beq	a7,a0,ffffffffc0205122 <schedule+0x80>
ffffffffc02050ca:	0c888693          	addi	a3,a7,200
ffffffffc02050ce:	000a5617          	auipc	a2,0xa5
ffffffffc02050d2:	65260613          	addi	a2,a2,1618 # ffffffffc02aa720 <proc_list>
        le = last;
ffffffffc02050d6:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc02050da:	4809                	li	a6,2
ffffffffc02050dc:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list)
ffffffffc02050de:	00c78863          	beq	a5,a2,ffffffffc02050ee <schedule+0x4c>
                if (next->state == PROC_RUNNABLE)
ffffffffc02050e2:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02050e6:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE)
ffffffffc02050ea:	03070163          	beq	a4,a6,ffffffffc020510c <schedule+0x6a>
                {
                    break;
                }
            }
        } while (le != last);
ffffffffc02050ee:	fef697e3          	bne	a3,a5,ffffffffc02050dc <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE)
ffffffffc02050f2:	ed89                	bnez	a1,ffffffffc020510c <schedule+0x6a>
        {
            next = idleproc;
        }
        next->runs++;
ffffffffc02050f4:	451c                	lw	a5,8(a0)
ffffffffc02050f6:	2785                	addiw	a5,a5,1
ffffffffc02050f8:	c51c                	sw	a5,8(a0)
        if (next != current)
ffffffffc02050fa:	00a88463          	beq	a7,a0,ffffffffc0205102 <schedule+0x60>
        {
            proc_run(next);
ffffffffc02050fe:	e1ffe0ef          	jal	ra,ffffffffc0203f1c <proc_run>
    if (flag)
ffffffffc0205102:	e819                	bnez	s0,ffffffffc0205118 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0205104:	60a2                	ld	ra,8(sp)
ffffffffc0205106:	6402                	ld	s0,0(sp)
ffffffffc0205108:	0141                	addi	sp,sp,16
ffffffffc020510a:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE)
ffffffffc020510c:	4198                	lw	a4,0(a1)
ffffffffc020510e:	4789                	li	a5,2
ffffffffc0205110:	fef712e3          	bne	a4,a5,ffffffffc02050f4 <schedule+0x52>
ffffffffc0205114:	852e                	mv	a0,a1
ffffffffc0205116:	bff9                	j	ffffffffc02050f4 <schedule+0x52>
}
ffffffffc0205118:	6402                	ld	s0,0(sp)
ffffffffc020511a:	60a2                	ld	ra,8(sp)
ffffffffc020511c:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc020511e:	891fb06f          	j	ffffffffc02009ae <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205122:	000a5617          	auipc	a2,0xa5
ffffffffc0205126:	5fe60613          	addi	a2,a2,1534 # ffffffffc02aa720 <proc_list>
ffffffffc020512a:	86b2                	mv	a3,a2
ffffffffc020512c:	b76d                	j	ffffffffc02050d6 <schedule+0x34>
        intr_disable();
ffffffffc020512e:	887fb0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        return 1;
ffffffffc0205132:	4405                	li	s0,1
ffffffffc0205134:	bfbd                	j	ffffffffc02050b2 <schedule+0x10>

ffffffffc0205136 <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc0205136:	000a5797          	auipc	a5,0xa5
ffffffffc020513a:	65a7b783          	ld	a5,1626(a5) # ffffffffc02aa790 <current>
}
ffffffffc020513e:	43c8                	lw	a0,4(a5)
ffffffffc0205140:	8082                	ret

ffffffffc0205142 <sys_pgdir>:
...
ffffffffc0205146 <sys_putc>:
    cputchar(c);
ffffffffc0205146:	4108                	lw	a0,0(a0)
sys_putc(uint64_t arg[]) {
ffffffffc0205148:	1141                	addi	sp,sp,-16
ffffffffc020514a:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc020514c:	87efb0ef          	jal	ra,ffffffffc02001ca <cputchar>
}
ffffffffc0205150:	60a2                	ld	ra,8(sp)
ffffffffc0205152:	4501                	li	a0,0
ffffffffc0205154:	0141                	addi	sp,sp,16
ffffffffc0205156:	8082                	ret

ffffffffc0205158 <sys_kill>:
    return do_kill(pid);
ffffffffc0205158:	4108                	lw	a0,0(a0)
ffffffffc020515a:	c31ff06f          	j	ffffffffc0204d8a <do_kill>

ffffffffc020515e <sys_yield>:
    return do_yield();
ffffffffc020515e:	bdfff06f          	j	ffffffffc0204d3c <do_yield>

ffffffffc0205162 <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc0205162:	6d14                	ld	a3,24(a0)
ffffffffc0205164:	6910                	ld	a2,16(a0)
ffffffffc0205166:	650c                	ld	a1,8(a0)
ffffffffc0205168:	6108                	ld	a0,0(a0)
ffffffffc020516a:	ebeff06f          	j	ffffffffc0204828 <do_execve>

ffffffffc020516e <sys_wait>:
    return do_wait(pid, store);
ffffffffc020516e:	650c                	ld	a1,8(a0)
ffffffffc0205170:	4108                	lw	a0,0(a0)
ffffffffc0205172:	bdbff06f          	j	ffffffffc0204d4c <do_wait>

ffffffffc0205176 <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc0205176:	000a5797          	auipc	a5,0xa5
ffffffffc020517a:	61a7b783          	ld	a5,1562(a5) # ffffffffc02aa790 <current>
ffffffffc020517e:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc0205180:	4501                	li	a0,0
ffffffffc0205182:	6a0c                	ld	a1,16(a2)
ffffffffc0205184:	e11fe06f          	j	ffffffffc0203f94 <do_fork>

ffffffffc0205188 <sys_exit>:
    return do_exit(error_code);
ffffffffc0205188:	4108                	lw	a0,0(a0)
ffffffffc020518a:	a5eff06f          	j	ffffffffc02043e8 <do_exit>

ffffffffc020518e <syscall>:
};
...
void
syscall(void) {
ffffffffc020518e:	715d                	addi	sp,sp,-80
ffffffffc0205190:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc0205192:	000a5497          	auipc	s1,0xa5
ffffffffc0205196:	5fe48493          	addi	s1,s1,1534 # ffffffffc02aa790 <current>
ffffffffc020519a:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc020519c:	e0a2                	sd	s0,64(sp)
ffffffffc020519e:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc02051a0:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc02051a2:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02051a4:	47fd                	li	a5,31
    int num = tf->gpr.a0;
ffffffffc02051a6:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02051aa:	0327ee63          	bltu	a5,s2,ffffffffc02051e6 <syscall+0x58>
        if (syscalls[num] != NULL) {
ffffffffc02051ae:	00391713          	slli	a4,s2,0x3
ffffffffc02051b2:	00002797          	auipc	a5,0x2
ffffffffc02051b6:	27678793          	addi	a5,a5,630 # ffffffffc0207428 <syscalls>
ffffffffc02051ba:	97ba                	add	a5,a5,a4
ffffffffc02051bc:	639c                	ld	a5,0(a5)
ffffffffc02051be:	c785                	beqz	a5,ffffffffc02051e6 <syscall+0x58>
            arg[0] = tf->gpr.a1;
ffffffffc02051c0:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc02051c2:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc02051c4:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc02051c6:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc02051c8:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc02051ca:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc02051cc:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc02051ce:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc02051d0:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc02051d2:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02051d4:	0028                	addi	a0,sp,8
...
ffffffffc02051d8:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02051da:	e828                	sd	a0,80(s0)
}
ffffffffc02051dc:	6406                	ld	s0,64(sp)
ffffffffc02051de:	74e2                	ld	s1,56(sp)
ffffffffc02051e0:	7942                	ld	s2,48(sp)
ffffffffc02051e2:	6161                	addi	sp,sp,80
ffffffffc02051e4:	8082                	ret
    print_trapframe(tf);
ffffffffc02051e6:	8522                	mv	a0,s0
ffffffffc02051e8:	9bdfb0ef          	jal	ra,ffffffffc0200ba4 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc02051ec:	609c                	ld	a5,0(s1)
ffffffffc02051ee:	86ca                	mv	a3,s2
ffffffffc02051f0:	00002617          	auipc	a2,0x2
ffffffffc02051f4:	1f060613          	addi	a2,a2,496 # ffffffffc02073e0 <default_pmm_manager+0xed0>
ffffffffc02051f8:	43d8                	lw	a4,4(a5)
ffffffffc02051fa:	06200593          	li	a1,98
ffffffffc02051fe:	0b478793          	addi	a5,a5,180
ffffffffc0205202:	00002517          	auipc	a0,0x2
ffffffffc0205206:	20e50513          	addi	a0,a0,526 # ffffffffc0207410 <default_pmm_manager+0xf00>
ffffffffc020520a:	a84fb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc020520e <hash32>:
 *
...
ffffffffc020520e:	9e3707b7          	lui	a5,0x9e370
ffffffffc0205212:	2785                	addiw	a5,a5,1
ffffffffc0205214:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0205218:	02000793          	li	a5,32
ffffffffc020521c:	9f8d                	subw	a5,a5,a1
}
ffffffffc020521e:	00f5553b          	srlw	a0,a0,a5
ffffffffc0205222:	8082                	ret

ffffffffc0205224 <printnum>:
 * */
static void
...
ffffffffc0205224:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0205228:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc020522a:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020522e:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0205230:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0205234:	f022                	sd	s0,32(sp)
ffffffffc0205236:	ec26                	sd	s1,24(sp)
ffffffffc0205238:	e84a                	sd	s2,16(sp)
ffffffffc020523a:	f406                	sd	ra,40(sp)
ffffffffc020523c:	e44e                	sd	s3,8(sp)
ffffffffc020523e:	84aa                	mv	s1,a0
ffffffffc0205240:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0205242:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0205246:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0205248:	03067e63          	bgeu	a2,a6,ffffffffc0205284 <printnum+0x60>
ffffffffc020524c:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc020524e:	00805763          	blez	s0,ffffffffc020525c <printnum+0x38>
ffffffffc0205252:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0205254:	85ca                	mv	a1,s2
ffffffffc0205256:	854e                	mv	a0,s3
ffffffffc0205258:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc020525a:	fc65                	bnez	s0,ffffffffc0205252 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020525c:	1a02                	slli	s4,s4,0x20
ffffffffc020525e:	00002797          	auipc	a5,0x2
ffffffffc0205262:	2ca78793          	addi	a5,a5,714 # ffffffffc0207528 <syscalls+0x100>
ffffffffc0205266:	020a5a13          	srli	s4,s4,0x20
ffffffffc020526a:	9a3e                	add	s4,s4,a5
...
ffffffffc020526c:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020526e:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0205272:	70a2                	ld	ra,40(sp)
ffffffffc0205274:	69a2                	ld	s3,8(sp)
ffffffffc0205276:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205278:	85ca                	mv	a1,s2
ffffffffc020527a:	87a6                	mv	a5,s1
}
ffffffffc020527c:	6942                	ld	s2,16(sp)
ffffffffc020527e:	64e2                	ld	s1,24(sp)
ffffffffc0205280:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205282:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0205284:	03065633          	divu	a2,a2,a6
ffffffffc0205288:	8722                	mv	a4,s0
ffffffffc020528a:	f9bff0ef          	jal	ra,ffffffffc0205224 <printnum>
ffffffffc020528e:	b7f9                	j	ffffffffc020525c <printnum+0x38>

ffffffffc0205290 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0205290:	7119                	addi	sp,sp,-128
ffffffffc0205292:	f4a6                	sd	s1,104(sp)
ffffffffc0205294:	f0ca                	sd	s2,96(sp)
ffffffffc0205296:	ecce                	sd	s3,88(sp)
ffffffffc0205298:	e8d2                	sd	s4,80(sp)
ffffffffc020529a:	e4d6                	sd	s5,72(sp)
ffffffffc020529c:	e0da                	sd	s6,64(sp)
ffffffffc020529e:	fc5e                	sd	s7,56(sp)
ffffffffc02052a0:	f06a                	sd	s10,32(sp)
ffffffffc02052a2:	fc86                	sd	ra,120(sp)
ffffffffc02052a4:	f8a2                	sd	s0,112(sp)
ffffffffc02052a6:	f862                	sd	s8,48(sp)
ffffffffc02052a8:	f466                	sd	s9,40(sp)
ffffffffc02052aa:	ec6e                	sd	s11,24(sp)
ffffffffc02052ac:	892a                	mv	s2,a0
ffffffffc02052ae:	84ae                	mv	s1,a1
ffffffffc02052b0:	8d32                	mv	s10,a2
...
ffffffffc02052b4:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02052b8:	5b7d                	li	s6,-1
ffffffffc02052ba:	00002a97          	auipc	s5,0x2
ffffffffc02052be:	29aa8a93          	addi	s5,s5,666 # ffffffffc0207554 <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02052c2:	00002b97          	auipc	s7,0x2
ffffffffc02052c6:	4aeb8b93          	addi	s7,s7,1198 # ffffffffc0207770 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02052ca:	000d4503          	lbu	a0,0(s10)
ffffffffc02052ce:	001d0413          	addi	s0,s10,1
ffffffffc02052d2:	01350a63          	beq	a0,s3,ffffffffc02052e6 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02052d6:	c121                	beqz	a0,ffffffffc0205316 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc02052d8:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02052da:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc02052dc:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02052de:	fff44503          	lbu	a0,-1(s0)
ffffffffc02052e2:	ff351ae3          	bne	a0,s3,ffffffffc02052d6 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02052e6:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc02052ea:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc02052ee:	4c81                	li	s9,0
ffffffffc02052f0:	4881                	li	a7,0
        width = precision = -1;
ffffffffc02052f2:	5c7d                	li	s8,-1
ffffffffc02052f4:	5dfd                	li	s11,-1
ffffffffc02052f6:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc02052fa:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02052fc:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0205300:	0ff5f593          	zext.b	a1,a1
ffffffffc0205304:	00140d13          	addi	s10,s0,1
ffffffffc0205308:	04b56263          	bltu	a0,a1,ffffffffc020534c <vprintfmt+0xbc>
ffffffffc020530c:	058a                	slli	a1,a1,0x2
ffffffffc020530e:	95d6                	add	a1,a1,s5
ffffffffc0205310:	4194                	lw	a3,0(a1)
ffffffffc0205312:	96d6                	add	a3,a3,s5
ffffffffc0205314:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0205316:	70e6                	ld	ra,120(sp)
ffffffffc0205318:	7446                	ld	s0,112(sp)
ffffffffc020531a:	74a6                	ld	s1,104(sp)
ffffffffc020531c:	7906                	ld	s2,96(sp)
ffffffffc020531e:	69e6                	ld	s3,88(sp)
ffffffffc0205320:	6a46                	ld	s4,80(sp)
ffffffffc0205322:	6aa6                	ld	s5,72(sp)
ffffffffc0205324:	6b06                	ld	s6,64(sp)
ffffffffc0205326:	7be2                	ld	s7,56(sp)
ffffffffc0205328:	7c42                	ld	s8,48(sp)
ffffffffc020532a:	7ca2                	ld	s9,40(sp)
ffffffffc020532c:	7d02                	ld	s10,32(sp)
ffffffffc020532e:	6de2                	ld	s11,24(sp)
ffffffffc0205330:	6109                	addi	sp,sp,128
ffffffffc0205332:	8082                	ret
            padc = '0';
ffffffffc0205334:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0205336:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020533a:	846a                	mv	s0,s10
ffffffffc020533c:	00140d13          	addi	s10,s0,1
ffffffffc0205340:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0205344:	0ff5f593          	zext.b	a1,a1
ffffffffc0205348:	fcb572e3          	bgeu	a0,a1,ffffffffc020530c <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc020534c:	85a6                	mv	a1,s1
ffffffffc020534e:	02500513          	li	a0,37
ffffffffc0205352:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0205354:	fff44783          	lbu	a5,-1(s0)
ffffffffc0205358:	8d22                	mv	s10,s0
ffffffffc020535a:	f73788e3          	beq	a5,s3,ffffffffc02052ca <vprintfmt+0x3a>
ffffffffc020535e:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0205362:	1d7d                	addi	s10,s10,-1
ffffffffc0205364:	ff379de3          	bne	a5,s3,ffffffffc020535e <vprintfmt+0xce>
ffffffffc0205368:	b78d                	j	ffffffffc02052ca <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc020536a:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc020536e:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205372:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0205374:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0205378:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020537c:	02d86463          	bltu	a6,a3,ffffffffc02053a4 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0205380:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0205384:	002c169b          	slliw	a3,s8,0x2
ffffffffc0205388:	0186873b          	addw	a4,a3,s8
ffffffffc020538c:	0017171b          	slliw	a4,a4,0x1
ffffffffc0205390:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0205392:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0205396:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0205398:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc020539c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02053a0:	fed870e3          	bgeu	a6,a3,ffffffffc0205380 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc02053a4:	f40ddce3          	bgez	s11,ffffffffc02052fc <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02053a8:	8de2                	mv	s11,s8
ffffffffc02053aa:	5c7d                	li	s8,-1
ffffffffc02053ac:	bf81                	j	ffffffffc02052fc <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02053ae:	fffdc693          	not	a3,s11
ffffffffc02053b2:	96fd                	srai	a3,a3,0x3f
ffffffffc02053b4:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02053b8:	00144603          	lbu	a2,1(s0)
ffffffffc02053bc:	2d81                	sext.w	s11,s11
ffffffffc02053be:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02053c0:	bf35                	j	ffffffffc02052fc <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02053c2:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc02053ce:	bfd9                	j	ffffffffc02053a4 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02053d0:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02053d2:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02053d6:	01174463          	blt	a4,a7,ffffffffc02053de <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02053da:	1a088e63          	beqz	a7,ffffffffc0205596 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02053de:	000a3603          	ld	a2,0(s4)
ffffffffc02053e2:	46c1                	li	a3,16
ffffffffc02053e4:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02053e6:	2781                	sext.w	a5,a5
ffffffffc02053e8:	876e                	mv	a4,s11
ffffffffc02053ea:	85a6                	mv	a1,s1
ffffffffc02053ec:	854a                	mv	a0,s2
ffffffffc02053ee:	e37ff0ef          	jal	ra,ffffffffc0205224 <printnum>
            break;
ffffffffc02053f2:	bde1                	j	ffffffffc02052ca <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02053f4:	000a2503          	lw	a0,0(s4)
ffffffffc02053f8:	85a6                	mv	a1,s1
ffffffffc02053fa:	0a21                	addi	s4,s4,8
ffffffffc02053fc:	9902                	jalr	s2
            break;
ffffffffc02053fe:	b5f1                	j	ffffffffc02052ca <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0205400:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0205402:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0205406:	01174463          	blt	a4,a7,ffffffffc020540e <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020540a:	18088163          	beqz	a7,ffffffffc020558c <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc020540e:	000a3603          	ld	a2,0(s4)
ffffffffc0205412:	46a9                	li	a3,10
ffffffffc0205414:	8a2e                	mv	s4,a1
ffffffffc0205416:	bfc1                	j	ffffffffc02053e6 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205418:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020541c:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020541e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0205420:	bdf1                	j	ffffffffc02052fc <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0205422:	85a6                	mv	a1,s1
ffffffffc0205424:	02500513          	li	a0,37
ffffffffc0205428:	9902                	jalr	s2
            break;
ffffffffc020542a:	b545                	j	ffffffffc02052ca <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020542c:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0205430:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205432:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0205434:	b5e1                	j	ffffffffc02052fc <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0205436:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0205438:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020543c:	01174463          	blt	a4,a7,ffffffffc0205444 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0205440:	14088163          	beqz	a7,ffffffffc0205582 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0205444:	000a3603          	ld	a2,0(s4)
ffffffffc0205448:	46a1                	li	a3,8
ffffffffc020544a:	8a2e                	mv	s4,a1
ffffffffc020544c:	bf69                	j	ffffffffc02053e6 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc020544e:	03000513          	li	a0,48
ffffffffc0205452:	85a6                	mv	a1,s1
ffffffffc0205454:	e03e                	sd	a5,0(sp)
ffffffffc0205456:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0205458:	85a6                	mv	a1,s1
ffffffffc020545a:	07800513          	li	a0,120
ffffffffc020545e:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0205460:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0205462:	6782                	ld	a5,0(sp)
ffffffffc0205464:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0205466:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc020546a:	bfb5                	j	ffffffffc02053e6 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020546c:	000a3403          	ld	s0,0(s4)
ffffffffc0205470:	008a0713          	addi	a4,s4,8
ffffffffc0205474:	e03a                	sd	a4,0(sp)
ffffffffc0205476:	14040263          	beqz	s0,ffffffffc02055ba <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc020547a:	0fb05763          	blez	s11,ffffffffc0205568 <vprintfmt+0x2d8>
ffffffffc020547e:	02d00693          	li	a3,45
ffffffffc0205482:	0cd79163          	bne	a5,a3,ffffffffc0205544 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205486:	00044783          	lbu	a5,0(s0)
ffffffffc020548a:	0007851b          	sext.w	a0,a5
ffffffffc020548e:	cf85                	beqz	a5,ffffffffc02054c6 <vprintfmt+0x236>
ffffffffc0205490:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0205494:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205498:	000c4563          	bltz	s8,ffffffffc02054a2 <vprintfmt+0x212>
ffffffffc020549c:	3c7d                	addiw	s8,s8,-1
ffffffffc020549e:	036c0263          	beq	s8,s6,ffffffffc02054c2 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02054a2:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02054a4:	0e0c8e63          	beqz	s9,ffffffffc02055a0 <vprintfmt+0x310>
ffffffffc02054a8:	3781                	addiw	a5,a5,-32
ffffffffc02054aa:	0ef47b63          	bgeu	s0,a5,ffffffffc02055a0 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02054ae:	03f00513          	li	a0,63
ffffffffc02054b2:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02054b4:	000a4783          	lbu	a5,0(s4)
ffffffffc02054b8:	3dfd                	addiw	s11,s11,-1
ffffffffc02054ba:	0a05                	addi	s4,s4,1
ffffffffc02054bc:	0007851b          	sext.w	a0,a5
ffffffffc02054c0:	ffe1                	bnez	a5,ffffffffc0205498 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02054c2:	01b05963          	blez	s11,ffffffffc02054d4 <vprintfmt+0x244>
ffffffffc02054c6:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02054c8:	85a6                	mv	a1,s1
ffffffffc02054ca:	02000513          	li	a0,32
ffffffffc02054ce:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02054d0:	fe0d9be3          	bnez	s11,ffffffffc02054c6 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02054d4:	6a02                	ld	s4,0(sp)
ffffffffc02054d6:	bbd5                	j	ffffffffc02052ca <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02054d8:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02054da:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02054de:	01174463          	blt	a4,a7,ffffffffc02054e6 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02054e2:	08088d63          	beqz	a7,ffffffffc020557c <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02054e6:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02054ea:	0a044d63          	bltz	s0,ffffffffc02055a4 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02054ee:	8622                	mv	a2,s0
ffffffffc02054f0:	8a66                	mv	s4,s9
ffffffffc02054f2:	46a9                	li	a3,10
ffffffffc02054f4:	bdcd                	j	ffffffffc02053e6 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02054f6:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02054fa:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc02054fc:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02054fe:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0205502:	8fb5                	xor	a5,a5,a3
ffffffffc0205504:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0205508:	02d74163          	blt	a4,a3,ffffffffc020552a <vprintfmt+0x29a>
ffffffffc020550c:	00369793          	slli	a5,a3,0x3
ffffffffc0205510:	97de                	add	a5,a5,s7
ffffffffc0205512:	639c                	ld	a5,0(a5)
ffffffffc0205514:	cb99                	beqz	a5,ffffffffc020552a <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0205516:	86be                	mv	a3,a5
ffffffffc0205518:	00000617          	auipc	a2,0x0
ffffffffc020551c:	1f060613          	addi	a2,a2,496 # ffffffffc0205708 <etext+0x2a>
ffffffffc0205520:	85a6                	mv	a1,s1
ffffffffc0205522:	854a                	mv	a0,s2
ffffffffc0205524:	0ce000ef          	jal	ra,ffffffffc02055f2 <printfmt>
ffffffffc0205528:	b34d                	j	ffffffffc02052ca <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020552a:	00002617          	auipc	a2,0x2
ffffffffc020552e:	01e60613          	addi	a2,a2,30 # ffffffffc0207548 <syscalls+0x120>
ffffffffc0205532:	85a6                	mv	a1,s1
ffffffffc0205534:	854a                	mv	a0,s2
ffffffffc0205536:	0bc000ef          	jal	ra,ffffffffc02055f2 <printfmt>
ffffffffc020553a:	bb41                	j	ffffffffc02052ca <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020553c:	00002417          	auipc	s0,0x2
ffffffffc0205540:	00440413          	addi	s0,s0,4 # ffffffffc0207540 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0205544:	85e2                	mv	a1,s8
ffffffffc0205546:	8522                	mv	a0,s0
ffffffffc0205548:	e43e                	sd	a5,8(sp)
ffffffffc020554a:	0e2000ef          	jal	ra,ffffffffc020562c <strnlen>
ffffffffc020554e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0205552:	01b05b63          	blez	s11,ffffffffc0205568 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0205556:	67a2                	ld	a5,8(sp)
ffffffffc0205558:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020555c:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc020555e:	85a6                	mv	a1,s1
ffffffffc0205560:	8552                	mv	a0,s4
ffffffffc0205562:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0205564:	fe0d9ce3          	bnez	s11,ffffffffc020555c <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205568:	00044783          	lbu	a5,0(s0)
ffffffffc020556c:	00140a13          	addi	s4,s0,1
ffffffffc0205570:	0007851b          	sext.w	a0,a5
ffffffffc0205574:	d3a5                	beqz	a5,ffffffffc02054d4 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0205576:	05e00413          	li	s0,94
ffffffffc020557a:	bf39                	j	ffffffffc0205498 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc020557c:	000a2403          	lw	s0,0(s4)
ffffffffc0205580:	b7ad                	j	ffffffffc02054ea <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0205582:	000a6603          	lwu	a2,0(s4)
ffffffffc0205586:	46a1                	li	a3,8
ffffffffc0205588:	8a2e                	mv	s4,a1
ffffffffc020558a:	bdb1                	j	ffffffffc02053e6 <vprintfmt+0x156>
ffffffffc020558c:	000a6603          	lwu	a2,0(s4)
ffffffffc0205590:	46a9                	li	a3,10
ffffffffc0205592:	8a2e                	mv	s4,a1
ffffffffc0205594:	bd89                	j	ffffffffc02053e6 <vprintfmt+0x156>
ffffffffc0205596:	000a6603          	lwu	a2,0(s4)
ffffffffc020559a:	46c1                	li	a3,16
ffffffffc020559c:	8a2e                	mv	s4,a1
ffffffffc020559e:	b5a1                	j	ffffffffc02053e6 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02055a0:	9902                	jalr	s2
ffffffffc02055a2:	bf09                	j	ffffffffc02054b4 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02055a4:	85a6                	mv	a1,s1
ffffffffc02055a6:	02d00513          	li	a0,45
ffffffffc02055aa:	e03e                	sd	a5,0(sp)
ffffffffc02055ac:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02055ae:	6782                	ld	a5,0(sp)
ffffffffc02055b0:	8a66                	mv	s4,s9
ffffffffc02055b2:	40800633          	neg	a2,s0
ffffffffc02055b6:	46a9                	li	a3,10
ffffffffc02055b8:	b53d                	j	ffffffffc02053e6 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02055ba:	03b05163          	blez	s11,ffffffffc02055dc <vprintfmt+0x34c>
ffffffffc02055be:	02d00693          	li	a3,45
ffffffffc02055c2:	f6d79de3          	bne	a5,a3,ffffffffc020553c <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02055c6:	00002417          	auipc	s0,0x2
ffffffffc02055ca:	f7a40413          	addi	s0,s0,-134 # ffffffffc0207540 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02055ce:	02800793          	li	a5,40
ffffffffc02055d2:	02800513          	li	a0,40
ffffffffc02055d6:	00140a13          	addi	s4,s0,1
ffffffffc02055da:	bd6d                	j	ffffffffc0205494 <vprintfmt+0x204>
ffffffffc02055dc:	00002a17          	auipc	s4,0x2
ffffffffc02055e0:	f65a0a13          	addi	s4,s4,-155 # ffffffffc0207541 <syscalls+0x119>
ffffffffc02055e4:	02800513          	li	a0,40
ffffffffc02055e8:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02055ec:	05e00413          	li	s0,94
ffffffffc02055f0:	b565                	j	ffffffffc0205498 <vprintfmt+0x208>

ffffffffc02055f2 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02055f2:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02055f4:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02055f8:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02055fa:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02055fc:	ec06                	sd	ra,24(sp)
ffffffffc02055fe:	f83a                	sd	a4,48(sp)
ffffffffc0205600:	fc3e                	sd	a5,56(sp)
ffffffffc0205602:	e0c2                	sd	a6,64(sp)
ffffffffc0205604:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0205606:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0205608:	c89ff0ef          	jal	ra,ffffffffc0205290 <vprintfmt>
}
ffffffffc020560c:	60e2                	ld	ra,24(sp)
ffffffffc020560e:	6161                	addi	sp,sp,80
ffffffffc0205610:	8082                	ret

ffffffffc0205612 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0205612:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0205616:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0205618:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc020561a:	cb81                	beqz	a5,ffffffffc020562a <strlen+0x18>
        cnt ++;
ffffffffc020561c:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc020561e:	00a707b3          	add	a5,a4,a0
ffffffffc0205622:	0007c783          	lbu	a5,0(a5)
ffffffffc0205626:	fbfd                	bnez	a5,ffffffffc020561c <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc020562c:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc020562e:	e589                	bnez	a1,ffffffffc0205638 <strnlen+0xc>
ffffffffc0205630:	a811                	j	ffffffffc0205644 <strnlen+0x18>
        cnt ++;
ffffffffc0205632:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0205634:	00f58863          	beq	a1,a5,ffffffffc0205644 <strnlen+0x18>
ffffffffc0205638:	00f50733          	add	a4,a0,a5
ffffffffc020563c:	00074703          	lbu	a4,0(a4)
ffffffffc0205640:	fb6d                	bnez	a4,ffffffffc0205632 <strnlen+0x6>
ffffffffc0205642:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0205644:	852e                	mv	a0,a1
ffffffffc0205646:	8082                	ret

ffffffffc0205648 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0205648:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020564a:	0005c703          	lbu	a4,0(a1)
ffffffffc020564e:	0785                	addi	a5,a5,1
ffffffffc0205650:	0585                	addi	a1,a1,1
ffffffffc0205652:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0205656:	fb75                	bnez	a4,ffffffffc020564a <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020565a:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020565e:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0205662:	cb89                	beqz	a5,ffffffffc0205674 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0205664:	0505                	addi	a0,a0,1
ffffffffc0205666:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0205668:	fee789e3          	beq	a5,a4,ffffffffc020565a <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020566c:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0205670:	9d19                	subw	a0,a0,a4
ffffffffc0205672:	8082                	ret
ffffffffc0205674:	4501                	li	a0,0
ffffffffc0205676:	bfed                	j	ffffffffc0205670 <strcmp+0x16>

ffffffffc0205678 <strncmp>:
...
ffffffffc0205678:	c20d                	beqz	a2,ffffffffc020569a <strncmp+0x22>
ffffffffc020567a:	962e                	add	a2,a2,a1
ffffffffc020567c:	a031                	j	ffffffffc0205688 <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc020567e:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0205680:	00e79a63          	bne	a5,a4,ffffffffc0205694 <strncmp+0x1c>
ffffffffc0205684:	00b60b63          	beq	a2,a1,ffffffffc020569a <strncmp+0x22>
ffffffffc0205688:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc020568c:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc020568e:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0205692:	f7f5                	bnez	a5,ffffffffc020567e <strncmp+0x6>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0205694:	40e7853b          	subw	a0,a5,a4
}
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc020569e:	00054783          	lbu	a5,0(a0)
ffffffffc02056a2:	c799                	beqz	a5,ffffffffc02056b0 <strchr+0x12>
        if (*s == c) {
ffffffffc02056a4:	00f58763          	beq	a1,a5,ffffffffc02056b2 <strchr+0x14>
    while (*s != '\0') {
ffffffffc02056a8:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02056ac:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02056ae:	fbfd                	bnez	a5,ffffffffc02056a4 <strchr+0x6>
    }
    return NULL;
ffffffffc02056b0:	4501                	li	a0,0
}
ffffffffc02056b2:	8082                	ret

ffffffffc02056b4 <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02056b4:	ca01                	beqz	a2,ffffffffc02056c4 <memset+0x10>
ffffffffc02056b6:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02056b8:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02056ba:	0785                	addi	a5,a5,1
ffffffffc02056bc:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02056c0:	fec79de3          	bne	a5,a2,ffffffffc02056ba <memset+0x6>
    }
    return s;
...
ffffffffc02056c6 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02056c6:	ca19                	beqz	a2,ffffffffc02056dc <memcpy+0x16>
ffffffffc02056c8:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02056ca:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02056cc:	0005c703          	lbu	a4,0(a1)
ffffffffc02056d0:	0585                	addi	a1,a1,1
ffffffffc02056d2:	0785                	addi	a5,a5,1
ffffffffc02056d4:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02056d8:	fec59ae3          	bne	a1,a2,ffffffffc02056cc <memcpy+0x6>
    }
    return dst;
